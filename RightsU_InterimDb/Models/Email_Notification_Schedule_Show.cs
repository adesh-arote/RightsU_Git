...
namespace RightsU_InterimDb.Models
{
    ...
    public partial class Email_Notification_Schedule_Show
    {
    	public State EntityState { get; set; }    public decimal Email_Notification_Schedule_Show_Code { get; set; }
    	    public Nullable<decimal> BV_Schedule_Transaction_Show_Code { get; set; }
