...
namespace RightsU_InterimDb.Models
{
    ...
    public partial class Email_Notification_AsRun_Shows
    {
    	public State EntityState { get; set; }    public decimal Email_Notification_AsRun_Shows_Code { get; set; }
    	    ...
    	    public Nullable<int> Deal_Movie_Content_Code { get; set; }
