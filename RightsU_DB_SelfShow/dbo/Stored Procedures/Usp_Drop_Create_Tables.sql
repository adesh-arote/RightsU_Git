...
BEGIN
	BEGIN TRY
		...
		END
		/****** Object:  Table [dbo].[Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Promoter_Group')
		BEGIN
		DROP TABLE [dbo].[Promoter_Group]
		END
		/****** Object:  Table [dbo].[Promoter_Remarks]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Promoter_Remarks')
		BEGIN
		DROP TABLE [dbo].[Promoter_Remarks]
		END
		...
		/****** Object:  Table [dbo].[Syn_Deal_Rights_Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Syn_Deal_Rights_Promoter_Group')
		BEGIN
		DROP TABLE [dbo].[Syn_Deal_Rights_Promoter_Group]
		END
		/****** Object:  Table [dbo].[Syn_Deal_Rights_Promoter_Remarks]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Syn_Deal_Rights_Promoter_Remarks')
		BEGIN
		DROP TABLE [dbo].[Syn_Deal_Rights_Promoter_Remarks]
		END
		/****** Object:  Table [dbo].[Syn_Deal_Rights_Promoter]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Syn_Deal_Rights_Promoter')
		BEGIN
		DROP TABLE [dbo].[Syn_Deal_Rights_Promoter]
		END
		...
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Acq_Deal_Rights_Promoter_Group')
		BEGIN
		DROP TABLE [dbo].[Acq_Deal_Rights_Promoter_Group]
		END
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Remarks]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Acq_Deal_Rights_Promoter_Remarks')
		BEGIN
		DROP TABLE [dbo].[Acq_Deal_Rights_Promoter_Remarks]
		END
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Acq_Deal_Rights_Promoter')
		BEGIN
		DROP TABLE [dbo].[Acq_Deal_Rights_Promoter]
		END
		...
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Acq_Deal_Rights_Promoter] FROM RightsU_Plus_Testing.dbo.[Acq_Deal_Rights_Promoter]
		ALTER TABLE [Acq_Deal_Rights_Promoter]
		ADD CONSTRAINT [PK_Acq_Deal_Rights_Promoter_Code] PRIMARY KEY CLUSTERED 
		(
			[Acq_Deal_Rights_Promoter_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
		...
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Acq_Deal_Rights_Promoter_Group] FROM RightsU_Plus_Testing.dbo.[Acq_Deal_Rights_Promoter_Group]
		ALTER TABLE [Acq_Deal_Rights_Promoter_Group]
		ADD CONSTRAINT [PK_Acq_Deal_Rights_Promoter_Group_Code] PRIMARY KEY CLUSTERED 
		(
			[Acq_Deal_Rights_Promoter_Group_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]

		SET ANSI_PADDING OFF
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Remarks]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Acq_Deal_Rights_Promoter_Remarks] FROM RightsU_Plus_Testing.dbo.[Acq_Deal_Rights_Promoter_Remarks]
		ALTER TABLE [Acq_Deal_Rights_Promoter_Remarks]
		ADD CONSTRAINT [PK_Acq_Deal_Rights_Promoter_Remarks_Code] PRIMARY KEY CLUSTERED 
		(
			[Acq_Deal_Rights_Promoter_Remarks_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
		...
		/****** Object:  Table [dbo].[Syn_Deal_Rights_Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Syn_Deal_Rights_Promoter] FROM RightsU_Plus_Testing.dbo.[Syn_Deal_Rights_Promoter]
		ALTER TABLE [Syn_Deal_Rights_Promoter]
		ADD CONSTRAINT [PK_Syn_Deal_Rights_Promoter_Code] PRIMARY KEY CLUSTERED 
		(
			[Syn_Deal_Rights_Promoter_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
		...
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Group]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Syn_Deal_Rights_Promoter_Group] FROM RightsU_Plus_Testing.dbo.[Syn_Deal_Rights_Promoter_Group]
		ALTER TABLE [Syn_Deal_Rights_Promoter_Group]
		ADD CONSTRAINT [PK_Syn_Deal_Rights_Promoter_Group_Code] PRIMARY KEY CLUSTERED 
		(
			[Syn_Deal_Rights_Promoter_Group_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]

		SET ANSI_PADDING OFF
		/****** Object:  Table [dbo].[Acq_Deal_Rights_Promoter_Remarks]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Syn_Deal_Rights_Promoter_Remarks] FROM RightsU_Plus_Testing.dbo.[Syn_Deal_Rights_Promoter_Remarks]
		ALTER TABLE [Syn_Deal_Rights_Promoter_Remarks]
		ADD CONSTRAINT [PK_Syn_Deal_Rights_Promoter_Remarks_Code] PRIMARY KEY CLUSTERED 
		(
			[Syn_Deal_Rights_Promoter_Remarks_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
		...
		SET ANSI_PADDING ON
		SELECT * INTO [Promoter_Group] FROM RightsU_Plus_Testing.dbo.[Promoter_Group]
		ALTER TABLE [Promoter_Group]
		ADD CONSTRAINT [PK_Promoter_Group] PRIMARY KEY CLUSTERED 
		(
			[Promoter_Group_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
		...
		SET ANSI_PADDING ON
		SELECT * INTO [Promoter_Remarks] FROM RightsU_Plus_Testing.dbo.[Promoter_Remarks]
		ALTER TABLE [Promoter_Remarks]
		ADD CONSTRAINT [PK_Promoter_Remarks] PRIMARY KEY CLUSTERED 
		(
			[Promoter_Remarks_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
		...
		DECLARE @Movie_DealTypeCode INT = 1
		...
		(ad.Record_Code IN (SELECT sdm.Syn_Deal_Code FROM RightsU_Plus_Testing.dbo.Syn_Deal_Movie sdm
			...
			WHERE t.Deal_Type_Code = @Movie_DealTypeCode
		) AND ad.Deal_Type = 'S')) AND ISNULL(GenarationStatus, '') NOT LIKE '%S%'
		...
		Update RightsU_Plus_Testing.dbo.Approved_Deal SET GenarationStatus = ISNULL(GenarationStatus, '') + 'S'
		WHERE Record_Code IN (SELECT adm.Acq_Deal_Code FROM RightsU_Plus_Testing.dbo.Acq_Deal_Movie adm
			INNER JOIN RightsU_Plus_Testing.dbo.Title t ON adm.Title_Code = t.Title_Code
			WHERE t.Deal_Type_Code = @Movie_DealTypeCode
		) AND Deal_Type = 'A' AND GenarationStatus NOT LIKE '%S%'
		...
		WHERE Record_Code IN (SELECT sdm.Syn_Deal_Code FROM RightsU_Plus_Testing.dbo.Syn_Deal_Movie sdm
			INNER JOIN RightsU_Plus_Testing.dbo.Title t ON sdm.Title_Code = t.Title_Code
			WHERE t.Deal_Type_Code = @Movie_DealTypeCode
		) AND Deal_Type = 'S' AND GenarationStatus NOT LIKE '%S%'
	...
	select @ernum, @errmsg, @errser, @errstate, @errproc,@errline
		--EXEC msdb.dbo.sp_send_dbmail 
		--	@profile_name = @DatabaseEmail_Profile,
		--	@recipients =  'anchal@uto.in', 
