CREATE TABLE [dbo].[Acq_Deal_Rights_Subtitling] (
    ...
    CONSTRAINT [FK_Acq_Deal_Rights_Subtitling_Acq_Deal_Rights] FOREIGN KEY ([Acq_Deal_Rights_Code]) REFERENCES [dbo].[Acq_Deal_Rights] ([Acq_Deal_Rights_Code]),
    CONSTRAINT [FK_Acq_Deal_Rights_Subtitling_Language] FOREIGN KEY ([Language_Code]) REFERENCES [dbo].[Language] ([Language_Code]),
    CONSTRAINT [FK_Acq_Deal_Rights_Subtitling_Language_Group] FOREIGN KEY ([Language_Group_Code]) REFERENCES [dbo].[Language_Group] ([Language_Group_Code])
);
...
GO
CREATE NONCLUSTERED INDEX [IX_Acq_Deal_Rights_Subtitling_3]
    ON [dbo].[Acq_Deal_Rights_Subtitling]([Language_Group_Code] ASC);
