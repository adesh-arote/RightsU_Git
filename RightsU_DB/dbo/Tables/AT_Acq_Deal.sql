CREATE TABLE [dbo].[AT_Acq_Deal] (
    [AT_Acq_Deal_Code]              INT             IDENTITY (1, 1) NOT NULL,
    ...
    [Attach_Workflow]               CHAR (1)        CONSTRAINT [DF_AT_Acq_Deal_Attach_Workflow] DEFAULT ('N') NULL,
    [Deal_Workflow_Status]          VARCHAR (50)    CONSTRAINT [DF_AT_Acq_Deal_AT_Acq_Deal_Workflow_Status] DEFAULT ('N') NULL,
    [Parent_Deal_Code]              INT             NULL,
    [Work_Flow_Code]                INT             NULL,
    [Amendment_Date]                DATETIME        NULL,
    [Is_Released]                   CHAR (1)        CONSTRAINT [DF_AT_Acq_Deal_IsReleased] DEFAULT ('N') NULL,
    [Release_On]                    DATETIME        NULL,
    [Release_By]                    INT             NULL,
    [Is_Completed]                  CHAR (1)        CONSTRAINT [DF_AT_Acq_Deal_Is_Completed] DEFAULT ('N') NULL,
    [Is_Active]                     CHAR (1)        CONSTRAINT [DF_AT_Acq_Deal_Is_Active] DEFAULT ('Y') NULL,
    [Content_Type]                  CHAR (2)        NULL,
    [Payment_Terms_Conditions]      NVARCHAR (4000) NULL,
    [Status]                        CHAR (1)        NULL,
    [Is_Auto_Generated]             CHAR (1)        CONSTRAINT [DF_AT_Acq_Deal_Is_Auto_Generated_1] DEFAULT ('N') NULL,
    [Is_Migrated]                   CHAR (1)        CONSTRAINT [DF_AT_Acq_Deal_Is_Migrated] DEFAULT ('N') NULL,
    ...
    CONSTRAINT [FK_AT_Acq_Deal_Business_Unit] FOREIGN KEY ([Business_Unit_Code]) REFERENCES [dbo].[Business_Unit] ([Business_Unit_Code]),
    CONSTRAINT [FK_AT_Acq_Deal_Category] FOREIGN KEY ([Category_Code]) REFERENCES [dbo].[Category] ([Category_Code]),
    CONSTRAINT [FK_AT_Acq_Deal_Channel_Cluster] FOREIGN KEY ([Channel_Cluster_Code]) REFERENCES [dbo].[Channel_Cluster] ([Channel_Cluster_Code]),
    CONSTRAINT [FK_AT_Acq_Deal_Cost_Center] FOREIGN KEY ([Cost_Center_Id]) REFERENCES [dbo].[Cost_Center] ([Cost_Center_Id]),
    CONSTRAINT [FK_AT_Acq_Deal_Currency] FOREIGN KEY ([Currency_Code]) REFERENCES [dbo].[Currency] ([Currency_Code]),
    CONSTRAINT [FK_AT_Acq_Deal_Entity] FOREIGN KEY ([Entity_Code]) REFERENCES [dbo].[Entity] ([Entity_Code]),
    CONSTRAINT [FK_AT_Acq_Deal_Role] FOREIGN KEY ([Role_Code]) REFERENCES [dbo].[Role] ([Role_Code]),
