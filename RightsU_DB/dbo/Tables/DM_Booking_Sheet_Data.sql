CREATE TABLE [dbo].[DM_Booking_Sheet_Data] (
    [DM_Booking_Sheet_Data_Code] INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK__DM_Booin__0AD9BC95C32F7E18] PRIMARY KEY CLUSTERED ([DM_Booking_Sheet_Data_Code] ASC)
);
