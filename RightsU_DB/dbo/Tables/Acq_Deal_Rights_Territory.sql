CREATE TABLE [dbo].[Acq_Deal_Rights_Territory] (
    ...
    CONSTRAINT [FK_Acq_Deal_Rights_Territory_Acq_Deal_Rights] FOREIGN KEY ([Acq_Deal_Rights_Code]) REFERENCES [dbo].[Acq_Deal_Rights] ([Acq_Deal_Rights_Code]),
    CONSTRAINT [FK_Acq_Deal_Rights_Territory_Country] FOREIGN KEY ([Country_Code]) REFERENCES [dbo].[Country] ([Country_Code]),
    CONSTRAINT [FK_Acq_Deal_Rights_Territory_Territory] FOREIGN KEY ([Territory_Code]) REFERENCES [dbo].[Territory] ([Territory_Code])
);
...
GO
CREATE NONCLUSTERED INDEX [IX_Acq_Deal_Rights_Territory_3]
    ON [dbo].[Acq_Deal_Rights_Territory]([Territory_Code] ASC);
