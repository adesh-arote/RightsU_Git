CREATE TABLE [dbo].[BV_HouseId_Data] (
    ...
    CONSTRAINT [FK_BV_HouseId_Data_BMS_Schedule_Process_Data_Temp_TCode] FOREIGN KEY ([BMS_Schedule_Process_Data_Temp_Code]) REFERENCES [dbo].[BMS_Schedule_Process_Data_Temp] ([BMS_Schedule_Process_Data_Temp_Code])
);
