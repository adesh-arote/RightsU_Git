CREATE TABLE [dbo].[Syn_Deal] (
    ...
    [Attach_Workflow]          CHAR (1)        CONSTRAINT [DF_Syn_Deal_Attach_Workflow] DEFAULT ('N') NULL,
    [Deal_Workflow_Status]     VARCHAR (50)    CONSTRAINT [DF_Syn_Deal_Deal_Workflow_Status] DEFAULT ('N') NULL,
    [Work_Flow_Code]           INT             NULL,
    [Is_Completed]             CHAR (1)        CONSTRAINT [DF_Syn_Deal_Is_Completed] DEFAULT ('N') NULL,
    [Category_Code]            INT             NULL,
    [Parent_Syn_Deal_Code]     INT             NULL,
    [Is_Migrated]              CHAR (1)        CONSTRAINT [DF_Syn_Deal_Is_Migrated] DEFAULT ('N') NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Added by Gajanan for workflow and set at the time of insert deal from globalParam.deal_AttachWorkFlow_Yes ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Syn_Deal', @level2type = N'COLUMN', @level2name = N'Attach_Workflow';
