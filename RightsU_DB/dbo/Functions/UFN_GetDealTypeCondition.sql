...
BEGIN
	...
	SELECT @Deal_Type_Code_Movie = @Deal_Type_Code_Movie + ',' + Parameter_Value FROM System_Parameter_New with(nolock) WHERE Parameter_Name IN ('Deal_Type_Movie','Deal_Type_Documentary_Film','Deal_Type_ShortFilm','Deal_Type_Featurette', 'Deal_Type_Drama_and_Play', 'Deal_Type_TeleFilm')
