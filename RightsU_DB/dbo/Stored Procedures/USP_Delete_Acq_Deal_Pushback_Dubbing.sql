...
Begin
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Delete_Acq_Deal_Pushback_Dubbing]', 'Step 1', 0, 'Started Procedure', 0, ''
		If(@Language_Type = 'G')
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Delete_Acq_Deal_Pushback_Dubbing]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
End
