...
BEGIN
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_Get_Mapping_SubTitling_Dubbing_Languages]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_Get_Mapping_SubTitling_Dubbing_Languages]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
