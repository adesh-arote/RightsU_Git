...
-- Last update by : Rahul Kembhavi
-- Last Change : Change for Buyback
-- =============================================  
BEGIN  
	Declare @Loglevel int
	select @Loglevel = Parameter_Value from System_Parameter_New  where Parameter_Name='loglevel'
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_RollBack_Acq_Deal]', 'Step 1', 0, 'Started Procedure', 0, ''
		SET NOCOUNT ON
		...
		BEGIN TRAN  
			...
			SELECT TOP 1 @AT_Acq_Deal_Code = ISNULL(AT_Acq_Deal_Code, 0) FROM AT_Acq_Deal (NOLOCK) WHERE Acq_Deal_Code = @Acq_Deal_Code
			...
			/******************************** UDdate Acq_Deal *****************************************/   
				...
				Acq_Deal.Material_Remarks = AtAD.Material_Remarks
				...
				FROM AT_Acq_Deal_Licensor (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  

				SELECT DISTINCT TCM2.Title_Content_Code, COUNT(DISTINCT TCM2.Acq_Deal_Movie_Code) AS DealMovieCount INTO #TitleContentCodes FROM Acq_Deal_Movie ADM (NOLOCK) 
				INNER JOIN Title_Content_Mapping TCM (NOLOCK) ON TCM.Acq_Deal_Movie_Code = ADM.Acq_Deal_Movie_Code AND ADM.Acq_Deal_Code = @Acq_Deal_Code  
				...
				FROM AT_Acq_Deal_Movie (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code And Acq_Deal_Movie_Code Is Not Null  
				...
				FROM AT_Acq_Deal_Movie (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code And Acq_Deal_Movie_Code Is Null  
				...
				Title_Content_Code IN (
					SELECT TCM.Title_Content_Code FROM Acq_Deal_Movie ADM (NOLOCK)
  		...
  		/* Delete from Acq_Deal_Rights_Promoter_Remarks */   
				...
				ON ADRP.Acq_Deal_Rights_Code = ADR.Acq_Deal_Rights_Code AND ADR.Acq_Deal_Code = @Acq_Deal_Code  
					...
					(SELECT Acq_Deal_Rights_Code FROM Acq_Deal_Rights (NOLOCK) WHERE Acq_Deal_Code = @Acq_Deal_Code)  
				...
				@Inserted_By INT, @Inserted_On DATETIME, @Last_Updated_Time DATETIME, @Last_Action_By INT ,@Promoter_Flag CHAR(1), @Buyback_Syn_Rights_Code NVARCHAR(max)
				...
				Inserted_By, Inserted_On, GETDATE(), @User_Code, Acq_Deal_Rights_Code ,ROFR_Code,Promoter_Flag, Buyback_Syn_Rights_Code  
				FROM AT_Acq_Deal_Rights (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				@Right_Type, @Original_Right_Type, @Is_Tentative, @Term, @Right_Start_Date, @Right_End_Date, @Milestone_Type_Code, @Milestone_No_Of_Unit, 
				@Milestone_Unit_Type, @Is_ROFR, @ROFR_Date, @Restriction_Remarks, @Effective_Start_Date, @Actual_Right_Start_Date, @Actual_Right_End_Date, 
				@Inserted_By, @Inserted_On, @Last_Updated_Time, @Last_Action_By, @Acq_Deal_Rights_Old_Code, @ROFR_Code,@Promoter_Flag, @Buyback_Syn_Rights_Code 
				...
				BEGIN  
					...
					Begin  
						...
						(
							...
							Actual_Right_Start_Date, Actual_Right_End_Date, ROFR_Code, Inserted_By, Inserted_On, Last_Updated_Time, Last_Action_By, Is_Verified,Promoter_Flag, Right_Status, Buyback_Syn_Rights_Code
						)
						VALUES
						(
							@Acq_Deal_Code, @Is_Exclusive, @Is_Title_Language_Right, @Is_Sub_License, @Sub_License_Code, 
							@Is_Theatrical_Right, @Right_Type, @Original_Right_Type, @Is_Tentative, @Term, @Right_Start_Date, @Right_End_Date, 
							@Milestone_Type_Code, @Milestone_No_Of_Unit, @Milestone_Unit_Type, @Is_ROFR, @ROFR_Date, @Restriction_Remarks, @Effective_Start_Date, 
							@Actual_Right_Start_Date, @Actual_Right_End_Date, @ROFR_Code, @Inserted_By, @Inserted_On, @Last_Updated_Time, @Last_Action_By, 'Y',@Promoter_Flag, 'C', @Buyback_Syn_Rights_Code
						)  
					...
					Begin  
						...
						(
							...
							,Promoter_Flag, Buyback_Syn_Rights_Code
						)  
						VALUES
						(
					...
					WHERE Syn_Acq_Mapping_Code in ( 	
						...
						FROM AT_Syn_Acq_Mapping  (NOLOCK)
						WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code 
						AND Deal_Rights_Code IN (SELECT Acq_Deal_Rights_Code FROM AT_Acq_Deal_Rights (NOLOCK) WHERE  AT_Acq_Deal_Code = @AT_Acq_Deal_Code )
					)
					...
					SELECT DISTINCT Syn_Acq_Mapping_Code,  Syn_Deal_Code,  Syn_Deal_Movie_Code,  Syn_Deal_Rights_Code,  @Acq_Deal_Code,  Deal_Movie_Code, Deal_Rights_Code, Right_Start_Date, Right_End_Date 
					FROM AT_Syn_Acq_Mapping  (NOLOCK)
					WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code 
					AND Deal_Rights_Code IN (SELECT Acq_Deal_Rights_Code FROM AT_Acq_Deal_Rights (NOLOCK) WHERE  AT_Acq_Deal_Code = @AT_Acq_Deal_Code )
					...
					From AT_Acq_Deal_Rights_Title AtADRT (NOLOCK) WHERE AtADRT.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					FROM AT_Acq_Deal_Rights_Title_EPS AtADRTE  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Title AtADRT (NOLOCK) ON AtADRTE.AT_Acq_Deal_Rights_Title_Code = AtADRT.AT_Acq_Deal_Rights_Title_Code  
					INNER JOIN Acq_Deal_Rights_Title ADRT (NOLOCK) ON   
					...
					From AT_Acq_Deal_Rights_Platform AtADRP (NOLOCK) WHERE AtADRP.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					From AT_Acq_Deal_Rights_Territory AtADRT (NOLOCK) WHERE AtADRT.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					From AT_Acq_Deal_Rights_Subtitling AtADRS (NOLOCK) WHERE AtADRS.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					From AT_Acq_Deal_Rights_Dubbing AtADRD (NOLOCK) WHERE AtADRD.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					FROM AT_Acq_Deal_Rights_Holdback AtADRH (NOLOCK) WHERE AtADRH.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					FROM AT_Acq_Deal_Rights_Holdback_Dubbing AtADRHD  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Holdback AtADRH (NOLOCK) ON AtADRHD.AT_Acq_Deal_Rights_Holdback_Code = AtADRH.AT_Acq_Deal_Rights_Holdback_Code  
					INNER JOIN Acq_Deal_Rights_Holdback ADRH (NOLOCK) ON  
					...
					FROM AT_Acq_Deal_Rights_Holdback_Platform AtADRHP  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Holdback AtADRH (NOLOCK) ON AtADRHP.AT_Acq_Deal_Rights_Holdback_Code = AtADRH.AT_Acq_Deal_Rights_Holdback_Code  
					INNER JOIN Acq_Deal_Rights_Holdback ADRH (NOLOCK) ON  
					CAST(ISNULL(ADRH.HB_Run_After_Release_No, '') AS VARCHAR) + '~' + ISNULL(ADRH.HB_Run_After_Release_Units, '') + '~' +  
					ISNULL(ADRH.Holdback_Comment, '') + '~' + CAST(ISNULL(ADRH.Holdback_On_Platform_Code, '') AS VARCHAR) + '~' +  
					CAST(ISNULL(ADRH.Holdback_Release_Date, '') AS VARCHAR) + '~' + ISNULL(ADRH.Holdback_Type, '') + '~' + ISNULL(ADRH.Is_Title_Language_Right, '')   
					...
					FROM AT_Acq_Deal_Rights_Holdback_Subtitling AtADRHS  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Holdback AtADRH (NOLOCK) ON AtADRHS.AT_Acq_Deal_Rights_Holdback_Code = AtADRH.AT_Acq_Deal_Rights_Holdback_Code  
					INNER JOIN Acq_Deal_Rights_Holdback ADRH (NOLOCK) ON  
					CAST(ISNULL(ADRH.HB_Run_After_Release_No, '') AS VARCHAR) + '~' + ISNULL(ADRH.HB_Run_After_Release_Units, '') + '~' +  
					ISNULL(ADRH.Holdback_Comment, '') + '~' + CAST(ISNULL(ADRH.Holdback_On_Platform_Code, '') AS VARCHAR) + '~' +  
					CAST(ISNULL(ADRH.Holdback_Release_Date, '') AS VARCHAR) + '~' + ISNULL(ADRH.Holdback_Type, '') + '~' + ISNULL(ADRH.Is_Title_Language_Right, '')   
					...
					FROM AT_Acq_Deal_Rights_Holdback_Territory AtADRHT  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Holdback AtADRH (NOLOCK) ON AtADRHT.AT_Acq_Deal_Rights_Holdback_Code = AtADRH.AT_Acq_Deal_Rights_Holdback_Code  
					INNER JOIN Acq_Deal_Rights_Holdback ADRH (NOLOCK) ON   
					CAST(ISNULL(ADRH.HB_Run_After_Release_No, '') AS VARCHAR) + '~' + ISNULL(ADRH.HB_Run_After_Release_Units, '') + '~' +  
					ISNULL(ADRH.Holdback_Comment, '') + '~' + CAST(ISNULL(ADRH.Holdback_On_Platform_Code, '') AS VARCHAR) + '~' +  
					CAST(ISNULL(ADRH.Holdback_Release_Date, '') AS VARCHAR) + '~' + ISNULL(ADRH.Holdback_Type, '') + '~' + ISNULL(ADRH.Is_Title_Language_Right, '')   
					...
					FROM AT_Acq_Deal_Rights_Blackout AtADRB  (NOLOCK) WHERE AtADRB.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
					...
					FROM AT_Acq_Deal_Rights_Blackout_Dubbing AtADRBD (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Blackout AtADRB (NOLOCK) ON AtADRBD.AT_Acq_Deal_Rights_Blackout_Code = AtADRB.AT_Acq_Deal_Rights_Blackout_Code  
					INNER JOIN Acq_Deal_Rights_Blackout ADRB (NOLOCK) ON   
					...
					FROM AT_Acq_Deal_Rights_Blackout_Platform AtADRBP  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Blackout AtADRB (NOLOCK) ON AtADRBP.AT_Acq_Deal_Rights_Blackout_Code = AtADRB.AT_Acq_Deal_Rights_Blackout_Code  
					INNER JOIN Acq_Deal_Rights_Blackout ADRB (NOLOCK) ON   
					CAST(ISNULL(ADRB.Start_Date, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.End_Date, '') AS VARCHAR) + '~' +  
					CAST(ISNULL(ADRB.Inserted_By, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.Inserted_On, '') AS VARCHAR)  
					=  
					...
					FROM AT_Acq_Deal_Rights_Blackout_Subtitling AtADRBS  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Rights_Blackout AtADRB (NOLOCK) ON AtADRBS.AT_Acq_Deal_Rights_Blackout_Code = AtADRB.AT_Acq_Deal_Rights_Blackout_Code  
					INNER JOIN Acq_Deal_Rights_Blackout ADRB (NOLOCK) ON  
					CAST(ISNULL(ADRB.Start_Date, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.End_Date, '') AS VARCHAR) + '~' +  
					CAST(ISNULL(ADRB.Inserted_By, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.Inserted_On, '') AS VARCHAR)   
					=  
					...
					FROM AT_Acq_Deal_Rights_Blackout_Territory AtADRBT (NOLOCK)  
					INNER JOIN AT_Acq_Deal_Rights_Blackout AtADRB (NOLOCK) ON AtADRBT.AT_Acq_Deal_Rights_Blackout_Code = AtADRB.AT_Acq_Deal_Rights_Blackout_Code  
					INNER JOIN Acq_Deal_Rights_Blackout ADRB (NOLOCK) ON  
					CAST(ISNULL(ADRB.Start_Date, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.End_Date, '') AS VARCHAR) + '~' +  
					CAST(ISNULL(ADRB.Inserted_By, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.Inserted_On, '') AS VARCHAR)   
					=  
	  ...
	  /**************** Insert into Acq_Deal_Rights_Promoter ****************/   
					...
					FROM AT_Acq_Deal_Rights_Promoter AtADRP (NOLOCK) WHERE AtADRP.AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code  
			 ...
			 INSERT INTO Acq_Deal_Rights_Promoter_Group( Acq_Deal_Rights_Promoter_Code, Promoter_Group_Code)
						  ...
						  FROM (
							Select Row_Number() over(order by Acq_Deal_Rights_Promoter_Code Asc) RowId, * From AT_Acq_Deal_Rights_Promoter (NOLOCK)
							Where AT_Acq_Deal_Rights_Code = @AT_Acq_Deal_Rights_Code
						  ) ADRP
						  INNER JOIN AT_Acq_Deal_Rights_Promoter_Group ADRPG (NOLOCK) ON ADRPG.AT_Acq_Deal_Rights_Promoter_Code = ADRP.AT_Acq_Deal_Rights_Promoter_Code
						  INNER JOIN (
							Select Row_Number() over(order by Acq_Deal_Rights_Promoter_Code Asc) RowId, * From Acq_Deal_Rights_Promoter (NOLOCK)
					...
					/******** Insert into Acq_Deal_Rights_Promoter_Remarks ********/   
					 ...
					 INSERT INTO Acq_Deal_Rights_Promoter_Remarks( Acq_Deal_Rights_Promoter_Code, Promoter_Remarks_Code)
						  ...
						  INNER JOIN AT_Acq_Deal_Rights_Promoter_Remarks ADRPR (NOLOCK) ON ADRPR.AT_Acq_Deal_Rights_Promoter_Code = ADRP.AT_Acq_Deal_Rights_Promoter_Code
						  INNER JOIN (
							Select Row_Number() over(order by Acq_Deal_Rights_Promoter_Code Asc) RowId, * From Acq_Deal_Rights_Promoter (NOLOCK)
							Where Acq_Deal_Rights_Code = @Acq_Deal_Rights_Code
						  ) As ADRPNew On ADRP.RowId = ADRPNew.RowId
			   ...
			   END  
				...
				FROM AT_Acq_Deal_Pushback (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				BEGIN  
					...
					FROM AT_Acq_Deal_Pushback_Dubbing ADPD (NOLOCK) WHERE ADPD.AT_Acq_Deal_Pushback_Code = @AT_Acq_Deal_Pushback_Code  
					...
					FROM AT_Acq_Deal_Pushback_Platform ADPP (NOLOCK) WHERE ADPP.AT_Acq_Deal_Pushback_Code = @AT_Acq_Deal_Pushback_Code  
					...
					FROM AT_Acq_Deal_Pushback_Subtitling ADPS (NOLOCK) WHERE ADPS.AT_Acq_Deal_Pushback_Code = @AT_Acq_Deal_Pushback_Code  
					...
					FROM AT_Acq_Deal_Pushback_Territory ADPT (NOLOCK) WHERE ADPT.AT_Acq_Deal_Pushback_Code = @AT_Acq_Deal_Pushback_Code  
					...
					FROM AT_Acq_Deal_Pushback_Title ADPT (NOLOCK) WHERE ADPT.AT_Acq_Deal_Pushback_Code = @AT_Acq_Deal_Pushback_Code  
				...
				/******************************** Delete from Acq_Deal_Supplementary *****************************************/  
			
				/* Delete from Acq_Deal_Supplementary_Detail */  
				DELETE ADAP FROM Acq_Deal_Supplementary ADA INNER JOIN Acq_Deal_Supplementary_Detail ADAP  
				ON ADAP.Acq_Deal_Supplementary_Code = ADA.Acq_Deal_Supplementary_Code AND ADA.Acq_Deal_Code = @Acq_Deal_Code  

				/* Delete from Acq_Deal_Ancillary */  
				DELETE FROM Acq_Deal_Supplementary WHERE Acq_Deal_Code = @Acq_Deal_Code  
  
				--Declare cursor form ancillary  
  
				DECLARE @Acq_Deal_Supplementary_Code INT = 0, @AT_Acq_Deal_Supplementary_Code INT
				DECLARE Supplementary_cursor CURSOR 
				FOR SELECT DISTINCT AT_Acq_Deal_Supplementary_Code, Acq_Deal_Supplementary_Code FROM AT_Acq_Deal_Supplementary (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code      
				OPEN Supplementary_cursor 
				FETCH NEXT FROM Supplementary_cursor INTO @AT_Acq_Deal_Supplementary_Code, @Acq_Deal_Supplementary_Code
				WHILE @@FETCH_STATUS = 0  
				BEGIN  
					/******************************** Insert into AT_Acq_Deal_Supplementary *****************************************/   
				
					SET IDENTITY_INSERT [Acq_Deal_Supplementary] ON            
				
					INSERT INTO Acq_Deal_Supplementary(Acq_Deal_Supplementary_Code, Acq_Deal_Code, Title_code, Episode_From, Episode_To, Remarks)
					SELECT Acq_Deal_Supplementary_Code, @Acq_Deal_Code, Title_code, Episode_From, Episode_To, Remarks 
					FROM AT_Acq_Deal_Supplementary (NOLOCK) WHERE AT_Acq_Deal_Supplementary_Code = @AT_Acq_Deal_Supplementary_Code

					SET IDENTITY_INSERT [Acq_Deal_Supplementary] OFF
				
					/**************** Insert into Acq_Deal_Supplementary_Detail ****************/   
  			
					SET IDENTITY_INSERT [Acq_Deal_Supplementary_Detail] ON
				
					INSERT INTO Acq_Deal_Supplementary_Detail(Acq_Deal_Supplementary_Detail_Code, Acq_Deal_Supplementary_Code, Supplementary_Tab_Code, 
						   Supplementary_Config_Code, Supplementary_Data_Code, User_Value, Row_Num)
					SELECT Acq_Deal_Supplementary_Detail_Code, @Acq_Deal_Supplementary_Code, Supplementary_Tab_Code, 
						   Supplementary_Config_Code, Supplementary_Data_Code, User_Value, Row_Num
					FROM AT_Acq_Deal_Supplementary_Detail (NOLOCK) WHERE AT_Acq_Deal_Supplementary_Code = @AT_Acq_Deal_Supplementary_Code

					SET IDENTITY_INSERT [Acq_Deal_Supplementary_Detail] OFF
  
					FETCH NEXT FROM Supplementary_cursor INTO @AT_Acq_Deal_Supplementary_Code, @Acq_Deal_Supplementary_Code
				END  
				CLOSE Supplementary_cursor  
				DEALLOCATE Supplementary_cursor
				...
				FROM AT_Acq_Deal_Ancillary (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code      
				...
				BEGIN  
					...
					FROM AT_Acq_Deal_Ancillary_Platform AtADAP (NOLOCK) WHERE AtADAP.AT_Acq_Deal_Ancillary_Code = @AT_Acq_Deal_Ancillary_Code  
					...
					FROM AT_Acq_Deal_Ancillary_Platform_Medium AtADAPM  (NOLOCK)
					INNER JOIN AT_Acq_Deal_Ancillary_Platform AtADAP (NOLOCK) ON AtADAPM.AT_Acq_Deal_Ancillary_Platform_Code = AtADAP.AT_Acq_Deal_Ancillary_Platform_Code  
					INNER JOIN Acq_Deal_Ancillary_Platform ADAP (NOLOCK) ON ADAP.Ancillary_Platform_code = AtADAP.Ancillary_Platform_code  
					...
					FROM AT_Acq_Deal_Ancillary_Title AtADAT (NOLOCK) WHERE AtADAT.AT_Acq_Deal_Ancillary_Code = @AT_Acq_Deal_Ancillary_Code  
		   ...
		   END
			...
			BEGIN
				...
				IF(@Is_Edit_WO_Approval='N')
				BEGIN
					SELECT TOP 1 @Version_Code = ISNULL(Acq_Deal_Tab_Version_Code, 0) FROM Acq_Deal_Tab_Version (NOLOCK) WHERE Acq_Deal_Code = @Acq_Deal_Code 
					ORDER BY Acq_Deal_Tab_Version_Code DESC
				END
				ELSE
				BEGIN
					SELECT @Version_Code = ISNULL(Acq_Deal_Tab_Version_Code, 0) FROM (SELECT row_number() OVER (ORDER BY Acq_Deal_Tab_Version_Code DESC) r, * FROM Acq_Deal_Tab_Version (NOLOCK) where Acq_Deal_Code = @Acq_Deal_Code) q
					WHERE r = 2
				END
				...
				FROM AT_Acq_Deal_Run (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  AND Acq_Deal_Tab_Version_Code=@Version_Code
				...
				BEGIN  
					...
					FROM AT_Acq_Deal_Run_Channel AtADRC (NOLOCK) WHERE AtADRC.AT_Acq_Deal_Run_Code = @AT_Acq_Deal_Run_Code  
					...
					FROM AT_Acq_Deal_Run_Repeat_On_Day AtADRRD (NOLOCK) WHERE AtADRRD.AT_Acq_Deal_Run_Code = @AT_Acq_Deal_Run_Code  
					...
					FROM AT_Acq_Deal_Run_Shows AtADRS (NOLOCK)  
					INNER JOIN Acq_Deal_Movie ADM (NOLOCK) ON  
					...
					FROM AT_Acq_Deal_Run_Title AtADRT (NOLOCK)        
					...
					FROM AT_Acq_Deal_Run_Yearwise_Run AtADRYR (NOLOCK) WHERE AtADRYR.AT_Acq_Deal_Run_Code = @AT_Acq_Deal_Run_Code  
					...
					FROM AT_Acq_Deal_Run_Yearwise_Run AtADRYR (NOLOCK) INNER JOIN AT_Acq_Deal_Run_Yearwise_Run_Week AtADRYRW (NOLOCK) ON AtADRYRW.AT_Acq_Deal_Run_Yearwise_Run_Code = AtADRYR.AT_Acq_Deal_Run_Yearwise_Run_Code  
					INNER JOIN Acq_Deal_Run_Yearwise_Run ADRYR (NOLOCK) ON  
			...
			BEGIN
				...
				FROM AT_Acq_Deal_Cost (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code AND Acq_Deal_Tab_Version_Code=@Version_Code
				...
				BEGIN  
					...
					FROM AT_Acq_Deal_Cost_Additional_Exp AtADCAE (NOLOCK) WHERE AtADCAE.AT_Acq_Deal_Cost_Code = @AT_Acq_Deal_Cost_Code  
					...
					FROM AT_Acq_Deal_Cost_Commission AtADCC (NOLOCK) WHERE AtADCC.AT_Acq_Deal_Cost_Code = @AT_Acq_Deal_Cost_Code  
					...
					FROM AT_Acq_Deal_Cost_Title AtADCT (NOLOCK) WHERE AtADCT.AT_Acq_Deal_Cost_Code = @AT_Acq_Deal_Cost_Code  
					...
					FROM AT_Acq_Deal_Cost_Variable_Cost AtADCVC (NOLOCK) WHERE AtADCVC.AT_Acq_Deal_Cost_Code = @AT_Acq_Deal_Cost_Code  
					...
					FROM AT_Acq_Deal_Cost_Costtype AtADCC (NOLOCK) WHERE AtADCC.AT_Acq_Deal_Cost_Code = @AT_Acq_Deal_Cost_Code  
					...
					FROM AT_Acq_Deal_Cost_Costtype_Episode AtADCCE (NOLOCK) INNER JOIN AT_Acq_Deal_Cost_Costtype AtADCC (NOLOCK) ON AtADCCE.AT_Acq_Deal_Cost_Costtype_Code = AtADCC.AT_Acq_Deal_Cost_Costtype_Code  
					AND AtADCC.AT_Acq_Deal_Cost_Code = @AT_Acq_Deal_Cost_Code  
					INNER JOIN Acq_Deal_Cost_Costtype ADCC (NOLOCK) ON ADCC.Acq_Deal_Cost_Code = @Acq_Deal_Cost_Code AND  
		   ...
		   END
			...
			BEGIN
				...
				FROM AT_Acq_Deal_Sport (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				BEGIN  
					...
					FROM AT_Acq_Deal_Sport_Broadcast ADSB (NOLOCK) WHERE ADSB.AT_Acq_Deal_Sport_Code = @AT_Acq_Deal_Sport_Code  
					...
					FROM AT_Acq_Deal_Sport_Platform ADSP (NOLOCK) WHERE ADSP.AT_Acq_Deal_Sport_Code = @AT_Acq_Deal_Sport_Code  
					...
					SELECT   
					@Acq_Deal_Sport_Code,Title_Code,Episode_From,Episode_To  
					FROM AT_Acq_Deal_Sport_Title ADST (NOLOCK) WHERE ADST.AT_Acq_Deal_Sport_Code = @AT_Acq_Deal_Sport_Code  
					...
					SELECT   
					@Acq_Deal_Sport_Code,Language_Type,Language_Code,Language_Group_Code,Flag  
					FROM AT_Acq_Deal_Sport_Language ADST (NOLOCK) WHERE ADST.AT_Acq_Deal_Sport_Code = @AT_Acq_Deal_Sport_Code  
				...
				FROM AT_Acq_Deal_Sport_Ancillary (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				BEGIN  
					...
					FROM AT_Acq_Deal_Sport_Ancillary_Broadcast ADSAB (NOLOCK) WHERE ADSAB.AT_Acq_Deal_Sport_Ancillary_Code = @AT_Acq_Deal_Sport_Ancillary_Code  
					...
					FROM AT_Acq_Deal_Sport_Ancillary_Source ADSAS (NOLOCK) WHERE ADSAS.AT_Acq_Deal_Sport_Ancillary_Code = @AT_Acq_Deal_Sport_Ancillary_Code  
					...
					FROM AT_Acq_Deal_Sport_Ancillary_Title ADSAT (NOLOCK) WHERE ADSAT.AT_Acq_Deal_Sport_Ancillary_Code = @AT_Acq_Deal_Sport_Ancillary_Code  
				...
				FROM AT_Acq_Deal_Sport_Monetisation_Ancillary (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				BEGIN       
					...
					FROM AT_Acq_Deal_Sport_Monetisation_Ancillary_Title ADSMAT (NOLOCK) WHERE ADSMAT.AT_Acq_Deal_Sport_Monetisation_Ancillary_Code = @AT_Acq_Deal_Sport_Monetisation_Ancillary_Code  
					...
					FROM AT_Acq_Deal_Sport_Monetisation_Ancillary_Type ADSMAT (NOLOCK) WHERE ADSMAT.AT_Acq_Deal_Sport_Monetisation_Ancillary_Code = @AT_Acq_Deal_Sport_Monetisation_Ancillary_Code  
				...
				FROM AT_Acq_Deal_Sport_Sales_Ancillary  (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				BEGIN       
					...
					FROM AT_Acq_Deal_Sport_Sales_Ancillary_Title ADSSAT (NOLOCK) WHERE ADSSAT.AT_Acq_Deal_Sport_Sales_Ancillary_Code = @AT_Acq_Deal_Sport_Sales_Ancillary_Code  
					...
					FROM AT_Acq_Deal_Sport_Sales_Ancillary_Sponsor ADSSAS (NOLOCK)
				...
				FROM AT_Acq_Deal_Payment_Terms (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				FROM AT_Acq_Deal_Attachment (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				FROM AT_Acq_Deal_Material (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
				...
				FROM AT_Acq_Deal_Budget (NOLOCK) WHERE AT_Acq_Deal_Code = @AT_Acq_Deal_Code  
		...
		BEGIN CATCH  
			...
			FROM Deal_Process (NOLOCK) Where Deal_Code = @Acq_Deal_Code And Record_Status  = 'W'  AND Module_Code = 30
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_RollBack_Acq_Deal]', 'Step 2', 0, ' Procedure Excuting Completed', 0, ''
END