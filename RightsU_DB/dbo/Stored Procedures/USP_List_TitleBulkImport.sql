CREATE PROCEDURE [dbo].[USP_List_TitleBulkImport]
...
BEGIN
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_List_TitleBulkImport]', 'Step 1', 0, 'Started Procedure', 0, '' 
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_List_TitleBulkImport]', 'Step 2', 0, 'Procedure Excution Completed', 0, '' 
END