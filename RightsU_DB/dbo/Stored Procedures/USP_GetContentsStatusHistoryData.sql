CREATE PROC [dbo].[USP_GetContentsStatusHistoryData]
(
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_GetContentsStatusHistoryData]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		FROM Content_Status_History CSH (NOLOCK)
		INNER JOIN Users U (NOLOCK) ON CSH.User_Code  = u.Users_Code
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_GetContentsStatusHistoryData]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
