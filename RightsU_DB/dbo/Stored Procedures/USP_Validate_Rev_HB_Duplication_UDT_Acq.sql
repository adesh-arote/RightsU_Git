...
Begin
		...
		BEGIN  /* insert in temporary tables*/
			...
			,(Select Count(*) From Acq_Deal_Pushback_Subtitling a Where a.Acq_Deal_Pushback_Code = ADR.Acq_Deal_Pushback_Code) Sub_Cnt
			,(Select Count(*) From Acq_Deal_Pushback_Dubbing a Where a.Acq_Deal_Pushback_Code = ADR.Acq_Deal_Pushback_Code) Dub_Cnt
			...
			inner join Acq_Deal_Pushback_Platform ADRP on ADRP.Acq_Deal_Pushback_Code = ADR.Acq_Deal_Pushback_Code 
			...
			BEGIN
				DELETE FROM #Acq_Deal_Pushback_Platform WHERE Platform_Code IN (SELECT Platform_Code FROM [Platform] WHERE ISNULL(Is_No_Of_Run, '') = 'Y')
			END
			...
			From (
				...
				from #Acq_Deal_Pushback ADR 
				Inner Join Acq_Deal_Pushback_Territory ADRT on ADRT.Acq_Deal_Pushback_Code = ADR.Acq_Deal_Pushback_Code
			...
			BEGIN
				...
				Select Acq_Deal_Pushback_Code, a.Language_Type, a.Language_Group_Code, Language_Code From (
					...
					From #Acq_Deal_Pushback ADR 
					inner join Acq_Deal_Pushback_Subtitling ADRS on ADRS.Acq_Deal_Pushback_Code = ADR.Acq_Deal_Pushback_Code
			...
			BEGIN
				...
				From (
					...
					From #Acq_Deal_Pushback ADR
					inner join Acq_Deal_Pushback_Dubbing ADRD on ADRD.Acq_Deal_Pushback_Code = ADR.Acq_Deal_Pushback_Code
