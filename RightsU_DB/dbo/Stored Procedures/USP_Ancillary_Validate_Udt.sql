	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Ancillary_Validate_Udt]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		BEGIN
			...
			FROM (
				...
				Left Join Acq_Deal_Ancillary_Platform ADAP (NOLOCK) ON ADA.Acq_Deal_Ancillary_Code=ADAP.Acq_Deal_Ancillary_Code
			...
			LEFT JOIN #Adv_Acq_Ancillary_Validate_UDT UDT ON 
