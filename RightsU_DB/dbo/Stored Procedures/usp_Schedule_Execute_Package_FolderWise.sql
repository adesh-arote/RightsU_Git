...
BEGIN    
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[usp_Schedule_Execute_Package_FolderWise]', 'Step 1', 0, 'Started Procedure', 0, ''  
	-- =============================================
	/*
	...
	*/
	-- =============================================
			...
			FOR   
			SELECT Channel_code, Schedule_Source_FilePath_Pkg FROM Channel (NOLOCK) WHERE ISNULL(isUseForAsRun,'N') = 'Y' 
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[usp_Schedule_Execute_Package_FolderWise]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''		      		      
END
