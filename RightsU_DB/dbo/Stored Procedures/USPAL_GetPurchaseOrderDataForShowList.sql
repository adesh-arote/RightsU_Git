CREATE PROCEDURE [dbo].[USPAL_GetPurchaseOrderDataForShowList]  
(  
...
BEGIN  
 ...
 DECLARE @RecommendationCode INT = 0, @BookingSheetCode INT = 0, @Display_For CHAR(1) = 'B'  
