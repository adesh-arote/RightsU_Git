CREATE PROCEDURE [dbo].[USP_Acq_Copy_Right_For_Sub_Deal]
(
	@Acq_Deal_Code INT, 
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Acq_Copy_Right_For_Sub_Deal]', 'Step 1', 0, 'Started Procedure', 0, ''
		SET NOCOUNT ON 	
		SET FMTONLY OFF
		...
		BEGIN TRY
			...
			DELETE FROM #Title WHERE Title_Code IN (
				SELECT DISTINCT ADRT.Title_Code FROM Acq_Deal_Rights ADR (NOLOCK)
			...
			BEGIN
				...
				SELECT TOP 1 @Title_Code = Title_Code, @Master_Deal_Code = Acq_Deal_Code FROM Acq_Deal_Movie (NOLOCK) WHERE Acq_Deal_Movie_Code = @Master_Deal_Movie_Code

				PRINT 'Master_Deal_Code : ' + CAST(@Master_Deal_Code AS VARCHAR)
				PRINT 'Master Title_Code : ' + CAST(@Title_Code AS VARCHAR)

				INSERT INTO #Rights
				SELECT DISTINCT ADR.Acq_Deal_Rights_Code, 'N' FROM Acq_Deal_Rights ADR (NOLOCK)
				INNER JOIN Acq_Deal_Rights_Title ADRT (NOLOCK) ON ADR.Acq_Deal_Rights_Code = ADRT.Acq_Deal_Rights_Code AND ADR.Acq_Deal_Code = @Master_Deal_Code
				...
				BEGIN
					...
					, GETDATE(), @User_Code
					FROM Acq_Deal_Rights (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					SELECT IDENT_CURRENT('Acq_Deal_Rights'), Platform_Code FROM Acq_Deal_Rights_Platform (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					FROM Acq_Deal_Rights_Territory (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					FROM Acq_Deal_Rights_Subtitling (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					SELECT IDENT_CURRENT('Acq_Deal_Rights'), Language_Type, Language_Code, Language_Group_Code 
					FROM Acq_Deal_Rights_Dubbing (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					FROM Acq_Deal_Rights_Blackout (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					BEGIN
						...
						FROM Acq_Deal_Rights_Blackout (NOLOCK) WHERE Acq_Deal_Rights_Blackout_Code = @Right_Blackout_Code
						...
						FROM Acq_Deal_Rights_Blackout_Platform (NOLOCK) WHERE Acq_Deal_Rights_Blackout_Code = @Right_Blackout_Code
						...
						FROM Acq_Deal_Rights_Blackout_Territory (NOLOCK) WHERE Acq_Deal_Rights_Blackout_Code = @Right_Blackout_Code
						...
						SELECT IDENT_CURRENT('Acq_Deal_Rights_Blackout'), Language_Code FROM Acq_Deal_Rights_Blackout_Subtitling  (NOLOCK)
						...
						SELECT IDENT_CURRENT('Acq_Deal_Rights_Blackout'), Language_Code FROM Acq_Deal_Rights_Blackout_Dubbing (NOLOCK)
						WHERE Acq_Deal_Rights_Blackout_Code = @Right_Blackout_Code
					...
					FROM Acq_Deal_Rights_Promoter (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					BEGIN
						...
						FROM Acq_Deal_Rights_Promoter (NOLOCK) WHERE Acq_Deal_Rights_Promoter_Code = @Right_Promoter_Code
						...
						FROM Acq_Deal_Rights_Promoter_Group (NOLOCK) WHERE Acq_Deal_Rights_Promoter_Code = @Right_Promoter_Code
						...
						FROM Acq_Deal_Rights_Promoter_Remarks (NOLOCK) WHERE Acq_Deal_Rights_Promoter_Code = @Right_Promoter_Code
					...
					FROM Acq_Deal_Rights_Holdback (NOLOCK) WHERE Acq_Deal_Rights_Code = @Right_Code
					...
					BEGIN
						...
						, Holdback_On_Platform_Code, Holdback_Release_Date, Holdback_Comment, Is_Title_Language_Right
						FROM Acq_Deal_Rights_Holdback (NOLOCK) WHERE Acq_Deal_Rights_Holdback_Code = @Right_Holdback_Code
						...
						FROM Acq_Deal_Rights_Holdback_Platform (NOLOCK) WHERE Acq_Deal_Rights_Holdback_Code = @Right_Holdback_Code
						...
						FROM Acq_Deal_Rights_Holdback_Territory (NOLOCK) WHERE Acq_Deal_Rights_Holdback_Code = @Right_Holdback_Code
						...
						SELECT IDENT_CURRENT('Acq_Deal_Rights_Holdback'), Language_Code FROM Acq_Deal_Rights_Holdback_Subtitling (NOLOCK) 
						...
						SELECT IDENT_CURRENT('Acq_Deal_Rights_Holdback'), Language_Code FROM Acq_Deal_Rights_Holdback_Dubbing (NOLOCK)
						WHERE Acq_Deal_Rights_Holdback_Code = @Right_Holdback_Code
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Acq_Copy_Right_For_Sub_Deal]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
