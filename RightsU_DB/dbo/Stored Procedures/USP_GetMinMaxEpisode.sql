CREATE PROC [dbo].[USP_GetMinMaxEpisode]
(
	@DealCode INT,
	@DealType CHAR(1)
)
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_GetMinMaxEpisode]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_GetMinMaxEpisode]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END