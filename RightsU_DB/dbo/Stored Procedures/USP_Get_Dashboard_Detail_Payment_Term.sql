...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Dashboard_Detail_Payment_Term]', 'Step 1', 0, 'Started Procedure', 0, '' 
		SET NOCOUNT ON;
		--DECLARE 
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Dashboard_Detail_Payment_Term]', 'Step 2', 0, ' Procedure Excution Completed', 0, '' 
END
