...
BEGIN
	...
	--BEGIN TRANSACTION;
			...
			INSERT INTO AT_Syn_Deal_Rights(
				...
				Inserted_By, Inserted_On, Last_Updated_Time, Last_Action_By,Is_Pushback,ROFR_Code)
			SELECT 
				...
				Right_Type, Original_Right_Type, Is_Tentative, Term, Right_Start_Date, Right_End_Date, Milestone_Type_Code, Milestone_No_Of_Unit, 
				Milestone_Unit_Type, Is_ROFR, ROFR_Date, Restriction_Remarks, Effective_Start_Date, Actual_Right_Start_Date, Actual_Right_End_Date, 
				Inserted_By, Inserted_On, Last_Updated_Time, Last_Action_By, ISNULL(Is_Pushback,'N'), ROFR_Code
		...
		--	Select * from AT_Syn_Deal_Rights ASDR WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			INNER JOIN AT_Syn_Deal_Rights ASDR ON SDRT.Syn_Deal_Rights_Code=ASDR.Syn_Deal_Rights_Code
			...
			INNER JOIN 	AT_Syn_Deal_Rights_Title ASDRT ON SDRTE.Syn_Deal_Rights_Title_Code = ASDRT.Syn_Deal_Rights_Title_Code
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.Syn_Deal_Rights_Code=ASDRT.AT_Syn_Deal_Rights_Code 
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			INNER JOIN AT_Syn_Deal_Rights ASDR ON SDRP.Syn_Deal_Rights_Code=ASDR.Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			Select distinct sdr.Syn_Deal_Rights_Code,sdrt.Territory_Code from Syn_Deal_Rights sdr INNER JOIN 
		    Syn_Deal_Rights_Territory sdrt ON sdr.Syn_Deal_Rights_Code = sdrt.Syn_Deal_Rights_Code
			...
			BEGIN
					...
					(Select Country_Code from Syn_Deal_Rights_Territory
			...
			INNER JOIN AT_Syn_Deal_Rights ASDR ON SDRS.Syn_Deal_Rights_Code=ASDR.Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			INNER JOIN AT_Syn_Deal_Rights ASDR ON SDRD.Syn_Deal_Rights_Code=ASDR.Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			INNER JOIN AT_Syn_Deal_Rights ASDR ON SDRH.Syn_Deal_Rights_Code=ASDR.Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal			
			...
			INNER JOIN AT_Syn_Deal_Rights_Holdback ASDRH ON ASDRH.Syn_Deal_Rights_Holdback_Code=SDRHP.Syn_Deal_Rights_Holdback_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRH.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
			...
			INNER JOIN AT_Syn_Deal_Rights_Holdback ASDRH ON ASDRH.Syn_Deal_Rights_Holdback_Code=SDRHD.Syn_Deal_Rights_Holdback_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRH.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
			...
			INNER JOIN AT_Syn_Deal_Rights_Holdback ASDRH ON ASDRH.Syn_Deal_Rights_Holdback_Code=SDRHS.Syn_Deal_Rights_Holdback_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRH.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal		
			...
			INNER JOIN AT_Syn_Deal_Rights_Holdback ASDRH ON ASDRH.Syn_Deal_Rights_Holdback_Code=SDRHT.Syn_Deal_Rights_Holdback_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRH.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal								
			...
			FROM Syn_Deal_Rights_Blackout SDRB 			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON SDRB.Syn_Deal_Rights_Code=ASDR.Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal							
			...
			FROM Syn_Deal_Rights_Blackout_Platform SDRBP 
			INNER JOIN AT_Syn_Deal_Rights_BlackOut ASDRB ON ASDRB.Syn_Deal_Rights_BlackOut_Code=SDRBP.Syn_Deal_Rights_BlackOut_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRB.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal														
			...
			INNER JOIN AT_Syn_Deal_Rights_BlackOut ASDRB ON ASDRB.Syn_Deal_Rights_BlackOut_Code=SDRBD.Syn_Deal_Rights_BlackOut_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRB.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal																				
			...
			FROM Syn_Deal_Rights_Blackout_Subtitling SDRBS 			
			INNER JOIN AT_Syn_Deal_Rights_BlackOut ASDRB ON ASDRB.Syn_Deal_Rights_BlackOut_Code=SDRBS.Syn_Deal_Rights_BlackOut_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRB.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal			
			...
			FROM Syn_Deal_Rights_Blackout_Territory SDRBT 			
			INNER JOIN AT_Syn_Deal_Rights_BlackOut ASDRB ON ASDRB.Syn_Deal_Rights_BlackOut_Code=SDRBT.Syn_Deal_Rights_BlackOut_Code			
			INNER JOIN AT_Syn_Deal_Rights ASDR ON ASDR.AT_Syn_Deal_Rights_Code=ASDRB.AT_Syn_Deal_Rights_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal			
			...
			FROM Syn_Deal_Ancillary_Title  SDAT
			INNER JOIN AT_Syn_Deal_Ancillary ASDA ON SDAT.Syn_Deal_Ancillary_Code=ASDA.Syn_Deal_Ancillary_Code
			...
			FROM Syn_Deal_Ancillary_Platform SDAP 
			INNER JOIN AT_Syn_Deal_Ancillary ASDA ON SDAP.Syn_Deal_Ancillary_Code=ASDA.Syn_Deal_Ancillary_Code
			WHERE ASDA.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			FROM Syn_Deal_Ancillary_Platform_Medium SDAPM
			INNER JOIN AT_Syn_Deal_Ancillary_Platform ASDAP ON  SDAPM.Syn_Deal_Ancillary_Platform_Code=ASDAP.Syn_Deal_Ancillary_Platform_Code
			INNER JOIN AT_Syn_Deal_Ancillary ASDA ON ASDA.AT_Syn_Deal_Ancillary_Code=ASDAP.AT_Syn_Deal_Ancillary_Code
			WHERE ASDA.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
			...
			FROM Syn_Deal_Run ADR
				INNER JOIN Syn_Deal_Run_Repeat_On_Day ADRRD ON ADRRD.Syn_Deal_Run_Code = ADR.Syn_Deal_Run_Code AND ADR.Syn_Deal_Code = @Syn_Deal_Code
				INNER JOIN AT_Syn_Deal_Run AtADR ON AtADR.AT_Syn_Deal_Code = @CurrIdent_AT_Syn_Deal AND AtADR.Syn_Deal_Run_Code = ADR.Syn_Deal_Run_Code
			...
			FROM Syn_Deal_Run ADR
				INNER JOIN Syn_Deal_Run_Yearwise_Run ADRYR ON ADRYR.Syn_Deal_Run_Code = ADR.Syn_Deal_Run_Code AND ADR.Syn_Deal_Code = @Syn_Deal_Code
				INNER JOIN AT_Syn_Deal_Run AtADR ON AtADR.AT_Syn_Deal_Code = @CurrIdent_AT_Syn_Deal AND AtADR.Syn_Deal_Run_Code = ADR.Syn_Deal_Run_Code
			...
			FROM Syn_Deal_Run_Platform SDAP 
			INNER JOIN AT_Syn_Deal_Run ASDA ON SDAP.Syn_Deal_Run_Code=ASDA.Syn_Deal_Run_Code
			WHERE ASDA.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			FROM Syn_Deal_Revenue_Title SDCT 
			INNER JOIN AT_Syn_Deal_Revenue ASDR ON SDCT.Syn_Deal_Revenue_Code=ASDR.Syn_Deal_Revenue_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			INSERT INTO AT_Syn_Deal_Revenue_Additional_Exp (
				...
				FROM Syn_Deal_Revenue_Additional_Exp SDCAE 
				INNER JOIN AT_Syn_Deal_Revenue ASDR ON SDCAE.Syn_Deal_Revenue_Code=ASDR.Syn_Deal_Revenue_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal
			...
			FROM Syn_Deal_Revenue_Commission SDCC 
			INNER JOIN AT_Syn_Deal_Revenue ASDR ON SDCC.Syn_Deal_Revenue_Code=ASDR.Syn_Deal_Revenue_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
			...
			FROM Syn_Deal_Revenue_Variable_Cost SDCVC 
			INNER JOIN AT_Syn_Deal_Revenue ASDR ON SDCVC.Syn_Deal_Revenue_Code=ASDR.Syn_Deal_Revenue_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
			...
			FROM Syn_Deal_Revenue_Costtype SDCC 
			INNER JOIN AT_Syn_Deal_Revenue ASDR ON SDCC.Syn_Deal_Revenue_Code=ASDR.Syn_Deal_Revenue_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
			...
			FROM Syn_Deal_Revenue_Costtype_Episode  SDCCE			
			INNER JOIN AT_Syn_Deal_Revenue_Costtype ASDRCT ON ASDRCT.Syn_Deal_Revenue_Costtype_Code=SDCCE.Syn_Deal_Revenue_Costtype_Code
			INNER JOIN AT_Syn_Deal_Revenue ASDR ON ASDRCT.AT_Syn_Deal_Revenue_Code=ASDR.AT_Syn_Deal_Revenue_Code
			WHERE ASDR.AT_Syn_Deal_Code=@CurrIdent_AT_Syn_Deal	
