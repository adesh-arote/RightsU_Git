...
Begin
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_GET_DATA_FOR_APPROVED_TITLES_FOR_SYN_PUSHBACK]', 'Step 1', 0, 'Started Procedure', 0, '' 
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_GET_DATA_FOR_APPROVED_TITLES_FOR_SYN_PUSHBACK]', 'Step 2', 0, 'Procedure Excution Completed', 0, '' 
End