...
-- DROP TABLE TestParameterPA
 ...
 UPDATE GDTC SET GDTC.DealType = DT.Deal_Type_Name
 FROM #GetDealTypeCondition GDTC 
 INNER JOIN Deal_Type DT ON GDTC.Deal_Type_Code = DT.Deal_Type_Code
