...
BEGIN
	...
	INNER JOIN Syn_Deal_Rights_Title SDRT ON SDR.Syn_Deal_Rights_Code = SDRT.Syn_Deal_Rights_Code AND SDRT.Title_Code = @Title_Code  
	...
	(
		SELECT T.Title_Language_Code FROM  Title T WHERE T.Title_Code = @Title_Code
	)
