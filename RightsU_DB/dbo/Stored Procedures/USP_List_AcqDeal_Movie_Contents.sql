	...
	set @SqlPageNo = N'
			WITH Y AS (
							...
							(
								...
								from Acq_Deal_Movie_Contents as ADMC
								inner join Acq_Deal_Movie as ADM on ADMC.Acq_Deal_Movie_Code = ADm.Acq_Deal_Movie_Code
								inner join Title as T on ADM.Title_Code = t.Title_Code
