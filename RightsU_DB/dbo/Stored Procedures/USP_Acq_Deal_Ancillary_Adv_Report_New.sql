--exec USP_Acq_Deal_Ancillary_Adv_Report 

--sp_helptext USP_Acq_Deal_Ancillary_Adv_Report


CREATE PROCEDURE [dbo].[USP_Acq_Deal_Ancillary_Adv_Report_New]
(
...
BEGIN
	...
	WHERE AD.Deal_Workflow_Status NOT IN ('AR', 'WA')
		...
		AND (ADR.Actual_Right_End_Date >= GETDATE() OR @IncludeExpired = 'Y')
