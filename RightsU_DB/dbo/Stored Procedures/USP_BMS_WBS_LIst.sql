...
BEGIN	
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_BMS_WBS_LIst]', 'Step 1', 0, 'Started Procedure', 0, ''
		SET NOCOUNT ON;
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_BMS_WBS_LIst]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END