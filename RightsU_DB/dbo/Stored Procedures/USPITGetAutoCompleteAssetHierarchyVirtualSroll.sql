CREATE PROCEDURE [dbo].[USPITGetAutoCompleteAssetHierarchyVirtualSroll]
...
BEGIN
	...
	if(@Loglevel < 2) Exec [USPLogSQLSteps] '[USPITGetAutoCompleteAssetHierarchyVirtualSroll]', 'Step 1', 0, 'Started Procedure', 0, ''
	PRINT @SqlString
		...
		IF OBJECT_ID('tempdb..#tempAutoCompleteResult') IS NOT NULL DROP TABLE #tempAutoCompleteResult
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USPITGetAutoCompleteAssetHierarchyVirtualSroll]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END