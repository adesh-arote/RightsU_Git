...
BEGIN    
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[usp_Schedule_cleanup]', 'Step 1', 0, 'Started Procedure', 0, ''
	-- =============================================
	/*	
	Steps:-
	...
	*/
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[usp_Schedule_cleanup]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END
