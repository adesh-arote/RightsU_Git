...
BEGIN
	...
	BEGIN
		...
		INSERT INTO #Temp_Rights(
			...
			Country_Code, Status_Changed_On, Due_Diligence
			--, expDays
		)
		...
		, ADRC.Country_Code, trc.Status_Changed_On, ADM.Due_Diligence
	...
	, Right_Type, Milestone_Type_Code, Milestone_No_Of_Unit, Milestone_Unit_Type
	, Is_Tentative, Is_Exclusive, Title_Name, Eps_From, Eps_To, Title_Language, Deal_Right_Code, Status_Changed_On, expDays, Due_Diligence
	...
	'EndDate','ApprovedOn','TitleLanguage','Subtitling','Dubbing','Exclusive','Sublicensing','Tentative','RightTerm','ExpireInDays','MasterDeal','Vendor','Term','DueDiligence')  
	...
	BEGIN
		...
		[Master Deal], [Vendor Name], [Term], [Due Diligence]
			FROM (
				SELECT
				sorter = 1,
				...
				UNION ALL
					...
					, @Col_Head13, @Col_Head14, @Col_Head15, @Col_Head16, @Col_Head17, @Col_Head18, @Col_Head19, @Col_Head20, @Col_Head21, @Col_Head22, @col_Head23
				) X   
		ORDER BY Sorter
	END
	ELSE
