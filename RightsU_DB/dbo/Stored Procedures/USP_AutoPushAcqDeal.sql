...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_AutoPushAcqDeal]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		BEGIN TRY
			...
			SELECT @NewMappedBuCode = MD.SecondaryDataCode FROM Syn_Deal SD (NOLOCK)
			INNER JOIN AcqPreReqMappingData MD (NOLOCK) ON MD.PrimaryDataCode = SD.Business_Unit_Code AND MD.MappingFor = 'BUUN'
			...
			BEGIN
				BEGIN /*Create Temp Tables*/
					...
					BEGIN /* Get Mapped MilestoneType*/
						...
						FROM Syn_Deal_Rights (NOLOCK) WHERE Syn_Deal_Code = @SynDealCode
					...
					BEGIN /* Get Mapped Title */
						...
						FROM Syn_Deal_Movie (NOLOCK) WHERE Syn_Deal_Code = @SynDealCode
						...
						BEGIN
							...
							INNER JOIN Title T (NOLOCK) ON T.Title_Code = CT.Title_Code
							...
							BEGIN
								...
								SELECT TOP 1 @NewTitleCode = Title_Code FROM RightsU_Plus_S13.dbo.Title T (NOLOCK)
								...
								BEGIN
									...
									IF NOT EXISTS(SELECT TOP 1 * FROM AcqPreReqMappingData (NOLOCK) WHERE SecondaryDataCode = @NewTitleCode AND MappingFor = 'TITL')
									BEGIN
										...
										BEGIN /* Title Talent */
											...
											INNER JOIN Talent T (NOLOCK) ON T.Talent_Code = TT.Talent_Code
											...
											BEGIN
												...
												BEGIN
													...
													SELECT TOP 1 @NewTalentCode = Talent_Code FROM RightsU_Plus_S13.dbo.Talent (NOLOCK)
												...
												BEGIN
													...
													SELECT TOP 1 @NewRoleCode = Role_Code FROM RightsU_Plus_S13.dbo.[Role]  (NOLOCK)
												...
												IF NOT EXISTS(SELECT TOP 1 Talent_Role_Code FROM RightsU_Plus_S13.dbo.Talent_Role (NOLOCK) WHERE Talent_Code = @NewTalentCode AND Role_Code = @NewRoleCode)
												BEGIN
												...
												IF NOT EXISTS(
													SELECT TOP 1 Title_Talent_Code FROM RightsU_Plus_S13.dbo.Title_Talent (NOLOCK) 
												...
												IF NOT EXISTS(SELECT TOP 1 * FROM AcqPreReqMappingData (NOLOCK) WHERE SecondaryDataCode = @NewTalentCode AND MappingFor = 'TALE')
												BEGIN
												...
												IF NOT EXISTS(SELECT TOP 1 * FROM AcqPreReqMappingData (NOLOCK) WHERE SecondaryDataCode = @NewRoleCode AND MappingFor = 'ROLE')
												BEGIN
										...
										BEGIN /* Title Genres */
											...
											SELECT TG.Title_Geners_Code, TG.Genres_Code, G.Genres_Name FROM Title_Geners TG (NOLOCK)
											INNER JOIN Genres G (NOLOCK) ON G.Genres_Code = TG.Genres_Code AND TG.Title_Code = @TitleCode
											...
											AND NOT EXISTS (
													SELECT TOP 1 Genres_Code FROM RightsU_Plus_S13.dbo.Genres G  (NOLOCK)
											...
											WHERE ISNULL(TG.New_Genres_Code, 0) = 0 AND NOT EXISTS (
												SELECT TOP 1 * FROM AcqPreReqMappingData (NOLOCK) WHERE SecondaryDataCode = G.Genres_Code AND MappingFor = 'GENR'
											)
											...
											SELECT @NewTitleCode, TG_P.New_Genres_Code FROM #Title_Geners TG_P WHERE ISNULL(TG_P.New_Title_Geners_Code, 0) = 0 AND NOT EXISTS (
													SELECT TOP 1 Title_Geners_Code FROM RightsU_Plus_S13.dbo.Title_Geners TG_S (NOLOCK) 
											...
											WHERE NOT EXISTS (
												SELECT TOP 1 * FROM AcqPreReqMappingData  (NOLOCK)
										...
										BEGIN /* Title Country */
											...
											SELECT DISTINCT TC.Country_Code FROM Title_Country TC (NOLOCK) WHERE TC.Title_Code = @TitleCode
											...
											SELECT @NewTitleCode, TC_P.New_Country_Code FROM #Title_Country TC_P WHERE ISNULL(TC_P.New_Country_Code, 0) > 0 AND NOT EXISTS (
													SELECT TOP 1 Title_Country_Code FROM RightsU_Plus_S13.dbo.Title_Country TC_S  (NOLOCK)
										...
										BEGIN /* Map Extended Columns */
											...
											WHERE ISNULL(MEC.IsProcessed, 'N') = 'N' AND NOT EXISTS (
												SELECT TOP 1 * FROM AcqPreReqMappingData (NOLOCK) WHERE SecondaryDataCode = EC.Columns_Code AND MappingFor = 'EXCO'
											)
											...
											FROM #Map_Extended_Columns MEC WHERE ISNULL(IsProcessed, 'N') = 'Y' AND NOT EXISTS (
												SELECT TOP 1 Map_Extended_Columns_Code FROM RightsU_Plus_S13.dbo.Map_Extended_Columns MEC2  (NOLOCK)
											...
											BEGIN
												...
												BEGIN
													...
													SELECT TOP 1 @NewColumnValueCode = Columns_Value_Code FROM RightsU_Plus_S13.dbo.Extended_Columns_Value (NOLOCK)
												...
												BEGIN
													...
													FROM Extended_Columns (NOLOCK) WHERE Columns_Code = @ColumnCode

													INSERT INTO #Map_Extended_Columns_Details(Column_Value_Code)
													SELECT Columns_Value_Code FROM Map_Extended_Columns_Details (NOLOCK) WHERE Map_Extended_Columns_Code = @MapExtendedColumnsCode
													...
													BEGIN
														...
														BEGIN
															...
															FROM #Map_Extended_Columns_Details WHERE ISNULL(New_Column_Value_Code, 0) = 0 AND NOT EXISTS (
																SELECT TOP 1 Talent_Code FROM RightsU_Plus_S13.dbo.Talent (NOLOCK) WHERE Talent_Name =  @TalentName
															)
															...
															BEGIN
																...
																SELECT TOP 1 @NewAdditionalCode = SecondaryDataCode FROM AcqPreReqMappingData (NOLOCK)
																...
																BEGIN
																	...
																	SELECT TOP 1 @NewAdditionalCode = RS.Role_Code FROM [Role] RP (NOLOCK)
																	INNER JOIN RightsU_Plus_S13.dbo.[Role] RS (NOLOCK) ON RP.Role_Code = @AdditionalCode AND
																	RP.Role_Name = RS.Role_Name AND RP.Role_Type = RS.Role_Type

																	IF(ISNULL(@NewAdditionalCode, 0) = 0)
																	BEGIN														
																		PRINT '    Insert new Role (additional condition)'
																		SELECT TOP 1 @NewDealTypeCodeAC = MD.SecondaryDataCode FROM [Role] R  (NOLOCK)
																		INNER JOIN AcqPreReqMappingData MD (NOLOCK) ON MD.MappingFor = 'DLTY' AND MD.PrimaryDataCode = R.Role_Code
					...
					BEGIN /* Get Mapped Platform */
						...
						SELECT DISTINCT SDRP.Platform_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						...
						UNION 
						SELECT DISTINCT SDRH.Holdback_On_Platform_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK)  ON SDRH.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						WHERE SDR.Syn_Deal_Code = @SynDealCode AND SDRH.Holdback_On_Platform_Code IS NOT NULL
						UNION 
						SELECT DISTINCT SDRHP.Platform_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK) ON SDRH.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						INNER JOIN Syn_Deal_Rights_Holdback_Platform SDRHP (NOLOCK) ON SDRHP.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
					...
					BEGIN /* Get Mapped Country */
						...
						SELECT DISTINCT SDRT.Country_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						...
						UNION 
						SELECT DISTINCT SDRHT.Country_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK)  ON SDRH.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						INNER JOIN Syn_Deal_Rights_Holdback_Territory SDRHT (NOLOCK) ON SDRHT.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
					...
					BEGIN /* Get Mapped Territory Code */
						...
						SELECT DISTINCT SDRT.Territory_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Territory SDRT (NOLOCK) ON SDRT.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						WHERE SDR.Syn_Deal_Code = @SynDealCode AND SDRT.Territory_Type = 'G' AND SDRT.Territory_Code IS NOT NULL
						UNION 
						SELECT DISTINCT SDRHT.Territory_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK)  ON SDRH.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						INNER JOIN Syn_Deal_Rights_Holdback_Territory SDRHT (NOLOCK) ON SDRHT.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
					...
					BEGIN /* Get Mapped Language */
						...
						UNION 
						SELECT DISTINCT SDRD.Language_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						...
						UNION 
						SELECT DISTINCT SDRHS.Language_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK)  ON SDRH.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						INNER JOIN Syn_Deal_Rights_Holdback_Subtitling SDRHS (NOLOCK) ON SDRHS.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
						WHERE SDR.Syn_Deal_Code = @SynDealCode AND SDRHS.Language_Code IS NOT NULL
						UNION 
						SELECT DISTINCT SDRHD.Language_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK)  ON SDRH.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code
						INNER JOIN Syn_Deal_Rights_Holdback_Dubbing SDRHD (NOLOCK) ON SDRHD.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
					...
					BEGIN /* Get Mapped Language Group */
						...
						SELECT DISTINCT SDRS.Language_Group_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Subtitling SDRS (NOLOCK) ON SDR.Syn_Deal_Rights_Code = SDRS.Syn_Deal_Rights_Code
						WHERE SDR.Syn_Deal_Code = @SynDealCode AND SDRS.Language_Type = 'G' AND SDRS.Language_Group_Code IS NOT NULL
						UNION 
						SELECT DISTINCT SDRD.Language_Group_Code FROM Syn_Deal_Rights SDR (NOLOCK)
						INNER JOIN Syn_Deal_Rights_Dubbing SDRD (NOLOCK) ON SDRD.Syn_Deal_Rights_Code = SDR.Syn_Deal_Rights_Code 
				...
				BEGIN /* Insert into Acq_Deal */
					...
					FROM Syn_Deal (NOLOCK) WHERE Syn_Deal_Code = @SynDealCode
					...
					BEGIN
						...
						SELECT TOP 1 @DealTagCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'DETA' AND PrimaryDataCode = @DealTagCode_P
					END

					IF(@DealTypeCode_P > 0)
					BEGIN
						PRINT 'Get Mapped Deal Type Code'
						SELECT TOP 1 @DealTypeCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'DLTY' AND PrimaryDataCode = @DealTypeCode_P
					END

					IF(@CurrencyCode_P > 0)
					BEGIN
						PRINT 'Get Mapped Currency Code'
						SELECT TOP 1 @CurrencyCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'CURR' AND PrimaryDataCode = @CurrencyCode_P
					END

					IF(@CategoryCode_P > 0)
					BEGIN
						PRINT 'Get Mapped Category Code'
						SELECT TOP 1 @CategoryCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'CATE' AND PrimaryDataCode = @CategoryCode_P
					END

					IF(@BusinessUnitCode_P > 0)
					BEGIN
						PRINT 'Get Mapped Business Unit Code'
						SELECT TOP 1 @BusinessUnitCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'BUUN' AND PrimaryDataCode = @BusinessUnitCode_P
					END

					IF(@VendorCode_P > 0)
					BEGIN
						PRINT 'Get Mapped Vendor Code'
						SELECT TOP 1 @VendorCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'VEND' AND PrimaryDataCode = @VendorCode_P
					END

					IF(@VendorContactCode_P > 0)
					BEGIN
						PRINT 'Get Mapped Vendor Contact Code'
						SELECT TOP 1 @VendorContactCode_S = SecondaryDataCode FROM AcqPreReqMappingData MD (NOLOCK) WHERE MD.MappingFor = 'VECO' AND PrimaryDataCode = @VendorContactCode_P
					END
				...
				BEGIN 
					...
					BEGIN
						...
						DECLARE rightsCursor CURSOR FOR 
							SELECT Syn_Deal_Rights_Code, ISNULL(Is_Pushback, 'N') AS IsPushback FROM Syn_Deal_Rights (NOLOCK) WHERE Syn_Deal_Code = @SynDealCode
						...
						BEGIN
							...
							BEGIN
								...
								BEGIN
									...
									INNER JOIN #CurrentTitles CT ON SDRT.Title_Code = CT.Title_Code AND SDRT.Episode_From = CT.Episode_From AND SDRT.Episode_To = CT.Episode_To
									INNER JOIN Acq_Deal_Rights_Title ADRT (NOLOCK) ON ADRT.Acq_Deal_Rights_Code = @NewAcqDealRightsCode AND
									...
									SELECT DISTINCT @NewAcqDealRightsCode, CP.NewPlatformCode FROM Syn_Deal_Rights_Platform SDRP  (NOLOCK)
									...
									INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK) ON SDRHP.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
									...
									INNER JOIN Acq_Deal_Rights_Holdback ADRH (NOLOCK) ON ADRH.Acq_Deal_Rights_Code = @NewAcqDealRightsCode AND
									...
									INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK) ON SDRHT.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
										AND SDRH.Syn_Deal_Rights_Code = @SynDealRightsCode
									INNER JOIN #CurrentPlatform CPH ON CPH.Platform_Code = SDRH.Holdback_On_Platform_Code
									...
									INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK) ON SDRHD.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
										AND SDRH.Syn_Deal_Rights_Code = @SynDealRightsCode
									INNER JOIN #CurrentPlatform CPH ON CPH.Platform_Code = SDRH.Holdback_On_Platform_Code
									...
									INNER JOIN Syn_Deal_Rights_Holdback SDRH (NOLOCK) ON SDRHS.Syn_Deal_Rights_Holdback_Code = SDRH.Syn_Deal_Rights_Holdback_Code
										AND SDRH.Syn_Deal_Rights_Code = @SynDealRightsCode
									INNER JOIN #CurrentPlatform CPH  ON CPH.Platform_Code = SDRH.Holdback_On_Platform_Code
									...
									FROM Syn_Deal_Rights_Blackout SDRB (NOLOCK) WHERE SDRB.Syn_Deal_Rights_Code = @SynDealRightsCode
								END
								ELSE
								BEGIN
							...
							BEGIN
								...
								BEGIN
									...
									SELECT DISTINCT @NewAcqDealPushbackCode, CP.NewPlatformCode FROM Syn_Deal_Rights_Platform SDRP  (NOLOCK)
									INNER JOIN #CurrentPlatform CP ON CP.Platform_Code = SDRP.Platform_Code
									Where SDRP.Syn_Deal_Rights_Code = @SynDealRightsCode AND ISNULL(CP.NewPlatformCode, 0) > 0
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_AutoPushAcqDeal]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END