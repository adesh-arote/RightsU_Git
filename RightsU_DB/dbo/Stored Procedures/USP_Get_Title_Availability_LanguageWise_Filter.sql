...
BEGIN 
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Title_Availability_LanguageWise_Filter]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		print @territoryCodes      
		  ...
		  --OR number = '0'            
			...
			FROM Report_Territory t (NOLOCK)               
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Title_Availability_LanguageWise_Filter]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''     
END