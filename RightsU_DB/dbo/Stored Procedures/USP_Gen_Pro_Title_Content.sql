...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Gen_Pro_Title_Content]', 'Step 1', 0, 'Started Procedure', 0, ''   
		SET NOCOUNT ON
		SET FMTONLY OFF
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Gen_Pro_Title_Content]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END