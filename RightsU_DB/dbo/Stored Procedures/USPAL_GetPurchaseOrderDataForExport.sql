CREATE PROCEDURE [dbo].[USPAL_GetPurchaseOrderDataForExport]  
(  
...
BEGIN  
 ...
 SELECT   
  ...
  AND absd.Display_Name IN(@Display_For,'B')   
    ...
    SELECT v.Vendor_Name AS [Client_Name],   
  vc.Contact_Name AS [Vendor_Name], v.Address AS [Vendor_Address], vc.Phone_No AS [Vendor_Phone_No], vc.Email AS [Vendor_Email],   
