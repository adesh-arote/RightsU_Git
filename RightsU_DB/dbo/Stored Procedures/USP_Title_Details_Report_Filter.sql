...
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USP_Title_Details_Report_Filter]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USP_Title_Details_Report_Filter]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END
