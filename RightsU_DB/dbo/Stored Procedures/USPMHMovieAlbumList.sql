CREATE PROCEDURE [dbo].[USPMHMovieAlbumList]
@RequestTypeCode INT
AS
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPMHMovieAlbumList]', 'Step 1', 0, 'Started Procedure', 0, ''
	SET FMTONLY OFF
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPMHMovieAlbumList]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
