...
BEGIN	
	...
	SELECT TOP 1 @acq_Deal_Code =Acq_Deal_Code FROM Acq_Deal_Movie WHERE Title_Code IN
	(
	...
	FROM Acq_Deal AD WHERE  AD.Deal_Workflow_Status NOT IN ('AR', 'WA') AND AD.Acq_Deal_Code = @acq_Deal_Code
	SELECT DISTINCT
	 AD.Agreement_No,
	...
	FROM Acq_Deal AD
	INNER JOIN Acq_Deal_Ancillary ADA ON AD.Acq_Deal_Code =ADA.Acq_Deal_Code
...
/*
SELECT * FROM Acq_Deal_Ancillary_Title
EXEC [dbo].[USP_Acq_Ancillary_Report] '' , '5069','1'
