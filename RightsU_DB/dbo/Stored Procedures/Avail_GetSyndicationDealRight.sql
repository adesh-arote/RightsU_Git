CREATE PROCEDURE [dbo].[Avail_GetSyndicationDealRight]
(    
 --@Syn_Deal_Code  INT,
...
BEGIN  
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[Avail_GetSyndicationDealRight]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	SELECT Platform_Code PlatformCode, Platform_Hiearachy PlatformName FROM [Platform] (NOLOCK)
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[Avail_GetSyndicationDealRight]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END