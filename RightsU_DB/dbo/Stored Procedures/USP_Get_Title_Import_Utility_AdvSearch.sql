CREATE PROCEDURE [dbo].[USP_Get_Title_Import_Utility_AdvSearch]
(
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Title_Import_Utility_AdvSearch]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Title_Import_Utility_AdvSearch]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
