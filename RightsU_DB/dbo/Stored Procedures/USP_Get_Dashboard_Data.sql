CREATE PROCEDURE [dbo].[USP_Get_Dashboard_Data]
(
	@DataFor VARCHAR(MAX) = '',
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Dashboard_Data]', 'Step 1', 0, 'Started Procedure', 0, '' 
		SET FMTONLY OFF
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_Dashboard_Data]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
