--select * From Title_Release
--select * from Title_Release_Platforms
--select * from Title_Release_Region
CREATE PROC USP_Save_TitleRelease
	@Title_Code BIGINT,
...
BEGIN
	BEGIN TRY
		...
		INNER JOIN Title_Release_Region TRR ON TR.Title_Release_Code = TRR.Title_Release_Code
		LEFT JOIN Territory_Details TD ON TD.Territory_Code = TRR.Territory_Code AND TR.Release_Type = 'T'
		LEFT JOIN Country C ON TR.Release_Type = 'W'
		...
		LEFT JOIN Territory_Details TD ON TD.Territory_Code = TRR.Region_Code AND TR.Release_Type = 'T'
		LEFT JOIN Country C ON TR.Release_Type = 'W'
