...
BEGIN
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_Music_Exception_Dashboard]', 'Step 1', 0, 'Started Procedure', 0, '' 
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_Music_Exception_Dashboard]', 'Step 2', 0, 'Procedure Excution Completed', 0, '' 
END