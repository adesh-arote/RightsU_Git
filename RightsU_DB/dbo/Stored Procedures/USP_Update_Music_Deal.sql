...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Update_Music_Deal]', 'Step 1', 0, 'Started Procedure', 0, ''  
		UPDATE [Music_Deal] 
		SET 
			[Version] = @Version, 
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Update_Music_Deal]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''  
END
