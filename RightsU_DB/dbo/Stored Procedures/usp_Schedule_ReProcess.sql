...
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[usp_Schedule_ReProcess]', 'Step 1', 0, 'Started Procedure', 0, ''
	-- =============================================
	/*	
	...
	*/
	...
	SET NOCOUNT ON;
		...
		----------------------------------- END RETRUN RESULT -----------------------------------		
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[usp_Schedule_ReProcess]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END  
