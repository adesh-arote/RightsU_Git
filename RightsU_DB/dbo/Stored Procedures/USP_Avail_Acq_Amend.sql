...
-- =============================================
		...
		FROM 
			...
			left join Avail_Acq AVA on AVA.Title_Code=ADRT.Title_Code
		...
		select Avail_Acq_Details_code from Avail_Acq_Details AAD 
		...
		select Avail_Acq_Language from Avail_Acq_Language AAL 
		...
		Delete from Avail_Acq_Language where Avail_Acq_Language in (
		select Avail_Acq_Language from Avail_Acq_Language AAL
		INNER JOIN Acq_Deal_Rights ADR ON ADR.Acq_Deal_Code=AAL.Acq_Deal_Code
			...
			BEGIN
					...
					BEGIN			
						...
						BEGIN
							...
							(select Language_code from Avail_Acq_Language where Dubbing_Subtitling='D' and Acq_Deal_Code=@pDeal_Code and Avail_Acq_Code=@Avail_Acq_Code)
					...
					FROM Acq_Deal_Rights_Dubbing ADRD
						...
						left join Avail_Acq_Language AAL ON AAL.Avail_Acq_Code=AAD.Avail_Acq_Code AND AAL.Acq_Deal_Code=ADR.Acq_Deal_Code
			...
			BEGIN
					...
					BEGIN			
						...
						BEGIN
							...
							FROM Acq_Deal_Rights_Subtitling ADRD
								inner join Acq_Deal_Rights adr on adr.Acq_Deal_Rights_Code=ADRD.Acq_Deal_Rights_Code
							where adr.Acq_Deal_Code=@pDeal_Code 
							and  adrd.Language_code in (select Language_code from Avail_Acq_Language where Dubbing_Subtitling='S' and Acq_Deal_Code=@pDeal_Code and Avail_Acq_Code=@Avail_Acq_Code)
						END
