CREATE PROCEDURE [dbo].[USP_Acq_Deal_Rights_Validate]
AS
-- =============================================
-- Author:		Akshay Rane
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Acq_Deal_Rights_Validate]', 'Step 1', 0, 'Started Procedure', 0, ''
	   SET NOCOUNT ON
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Acq_Deal_Rights_Validate]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
