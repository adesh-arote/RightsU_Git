...
BEGIN
	...
	SELECT  1, EC.Email_Config_Code, @Module_Code, @Record_Code, 1, To_User_Mail_Id, CC_User_Mail_Id, BCC_User_Mail_Id, [Subject], Email_Body, GETDATE(), GETDATE(),0 ,'P' , 0, 1, 0, 0 
	FROM  #Email_Config_Users_UDT A
