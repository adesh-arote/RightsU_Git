CREATE PROC [dbo].[USP_MusicLabelConsumption_Report]
(
--DECLARE
...
BEGIN
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_MusicLabelConsumption_Report]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		INNER JOIN  Music_Deal MD (NOLOCK) ON MD.Music_Deal_Code = MST.Music_Deal_Code
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_MusicLabelConsumption_Report]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END