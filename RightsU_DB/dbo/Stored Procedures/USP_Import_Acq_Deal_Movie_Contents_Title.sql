...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Import_Acq_Deal_Movie_Contents_Title]', 'Step 1', 0, 'Started Procedure', 0, '' 
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Import_Acq_Deal_Movie_Contents_Title]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
