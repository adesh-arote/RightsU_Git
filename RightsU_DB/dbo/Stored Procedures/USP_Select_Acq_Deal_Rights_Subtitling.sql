...
Begin
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USP_Select_Acq_Deal_Rights_Subtitling]', 'Step 1', 0, 'Started Procedure', 0, ''
		Set FMTONLY OFF
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USP_Select_Acq_Deal_Rights_Subtitling]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
End
