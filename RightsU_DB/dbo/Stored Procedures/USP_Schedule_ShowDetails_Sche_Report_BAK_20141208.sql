...
-- Author:  Adesh Arote
-- Create date: 
-- Description: The SP returns all deal related   
--    Channel_Wise Runs For Schedule_AsRun Report  
--    And All Schedules Details  
-- =============================================  
...
EXEC [usp_Schedule_ShowDetails_Sche_Report] @DMCode = '623'  
