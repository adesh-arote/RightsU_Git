...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Avail_Acq_Cache]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		*/
		...
		from #tmpCache tmp
			 left join Avail_Acq aa (NOLOCK) on aa.Title_Code=tmp.Title_Code
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Avail_Acq_Cache]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END