...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_List_Platform_Group]', 'Step 1', 0, 'Started Procedure', 0, '' 
		...
		dbo.UFN_Get_Platform_Names(PG.Platform_Group_Code) AS Platform_Name FROM Platform_Group PG (NOLOCK)
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_List_Platform_Group]', 'Step 2', 0, 'Procedure Excution Completed', 0, '' 
END