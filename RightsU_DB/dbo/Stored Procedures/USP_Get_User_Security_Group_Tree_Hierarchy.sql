...
Begin   
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_User_Security_Group_Tree_Hierarchy] ', 'Step 1', 0, 'Started Procedure', 0, ''         
			 SET FMTONLY OFF      
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Get_User_Security_Group_Tree_Hierarchy] ', 'Step 2', 0, 'Procedure Excution Completed', 0, '' 
End