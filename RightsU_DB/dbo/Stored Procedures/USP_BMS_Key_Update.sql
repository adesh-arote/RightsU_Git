...
BEGIN
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_BMS_Key_Update]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_BMS_Key_Update]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END
