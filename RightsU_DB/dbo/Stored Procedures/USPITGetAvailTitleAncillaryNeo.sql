CREATE PROCEDURE [dbo].[USPITGetAvailTitleAncillaryNeo]
...
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPITGetAvailTitleAncillaryNeo]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPITGetAvailTitleAncillaryNeo]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END