...
BEGIN 
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[usp_Schedule_SendException_Email]', 'Step 1', 0, 'Started Procedure', 0, ''
	-- =============================================
	/*	
	...
	*/
	...
	BEGIN TRY
		...
		BEGIN
			...
			SELECT @Exception_Cnt = COUNT(*) FROM Email_Notification_Schedule (NOLOCK) WHERE File_Code = @File_Code AND ISNULL(IsMailSent,'N') = 'N' AND ISNULL(IsPrimeException,'N') = 'N'
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						FROM Temp_BV_Schedule_DeletedRecords e (NOLOCK) WHERE e.File_Code = @File_Code AND ISNULL(IsMailSent,'N') = 'N'
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[usp_Schedule_SendException_Email]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END