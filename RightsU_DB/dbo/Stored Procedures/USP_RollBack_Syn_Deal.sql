...
BEGIN
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_RollBack_Syn_Deal]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		BEGIN TRY
			BEGIN TRAN
				...
				SELECT TOP 1 @AT_Syn_Deal_Code = ISNULL(AT_Syn_Deal_Code, 0) FROM AT_Syn_Deal (NOLOCK)  WHERE Syn_Deal_Code = @Syn_Deal_Code
				...
				SET
					...
					Syn_Deal.Material_Remarks = AtSD.Material_Remarks
				...
				FROM AT_Syn_Deal_Movie (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code And Syn_Deal_Movie_Code Is Not Null 
				...
				FROM AT_Syn_Deal_Movie (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code And Syn_Deal_Movie_Code Is Null 
				...
				@Syn_Deal_Rights_Old_Code INT = 0,@ROFR_Code INT,@Promoter_Flag CHAR(1), @CoExclusive_Remarks NVARCHAR(MAX)
				...
				SELECT AT_Syn_Deal_Rights_Code, Is_Exclusive, Is_Title_Language_Right, Is_Sub_License, Sub_License_Code, Is_Theatrical_Right, 
					...
					Inserted_By, Inserted_On, GETDATE(), @User_Code, ISNULL(Is_Pushback,'N'), Syn_Deal_Rights_Code, ROFR_Code, Promoter_Flag, CoExclusive_Remarks
				FROM AT_Syn_Deal_Rights (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				...
				INTO @AT_Syn_Deal_Rights_Code, @Is_Exclusive, @Is_Title_Language_Right, @Is_Sub_License, @Sub_License_Code, 
					...
					@Is_Pushback, @Syn_Deal_Rights_Old_Code, @ROFR_Code,@Promoter_Flag, @CoExclusive_Remarks
				...
				BEGIN
					...
					Begin
						...
						(
							...
							Milestone_No_Of_Unit, Milestone_Unit_Type, Is_ROFR, ROFR_Date, Restriction_Remarks, Effective_Start_Date, 
							Actual_Right_Start_Date, Actual_Right_End_Date, Inserted_By, Inserted_On, Last_Updated_Time, Last_Action_By, 
							Is_Pushback, Right_Status, ROFR_Code, Promoter_Flag, CoExclusive_Remarks
						)
						VALUES
						(
							@Syn_Deal_Code, @Is_Exclusive, @Is_Title_Language_Right, @Is_Sub_License, @Sub_License_Code, 
							...
							@Milestone_No_Of_Unit, @Milestone_Unit_Type, @Is_ROFR, @ROFR_Date, @Restriction_Remarks, @Effective_Start_Date, 
							@Actual_Right_Start_Date, @Actual_Right_End_Date, @Inserted_By, @Inserted_On, @Last_Updated_Time, @Last_Action_By, 
							@Is_Pushback, 'C', @ROFR_Code, @Promoter_Flag, @CoExclusive_Remarks
						)
					...
					Begin
						...
						(
							...
							Milestone_No_Of_Unit, Milestone_Unit_Type, Is_ROFR, ROFR_Date, Restriction_Remarks, Effective_Start_Date, 
							Actual_Right_Start_Date, Actual_Right_End_Date, Inserted_By, Inserted_On, Last_Updated_Time, Last_Action_By, 
							Is_Pushback, Right_Status, Promoter_Flag, CoExclusive_Remarks
						)
						VALUES
						(
							...
							@Milestone_No_Of_Unit, @Milestone_Unit_Type, @Is_ROFR, @ROFR_Date, @Restriction_Remarks, @Effective_Start_Date, 
							@Actual_Right_Start_Date, @Actual_Right_End_Date, @Inserted_By, @Inserted_On, @Last_Updated_Time, @Last_Action_By, 
							@Is_Pushback, 'C' ,@Promoter_Flag, @CoExclusive_Remarks
						)
					...
					From AT_Syn_Deal_Rights_Title AtADRT (NOLOCK)  WHERE AtADRT.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
					...
					FROM AT_Syn_Deal_Rights_Title_EPS AtADRTE (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Title AtADRT (NOLOCK)  ON AtADRTE.AT_Syn_Deal_Rights_Title_Code = AtADRT.AT_Syn_Deal_Rights_Title_Code
						INNER JOIN Syn_Deal_Rights_Title ADRT (NOLOCK)  ON 
					...
					From AT_Syn_Deal_Rights_Platform AtADRP (NOLOCK)  WHERE AtADRP.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
					...
					From AT_Syn_Deal_Rights_Territory AtADRT (NOLOCK) WHERE AtADRT.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
					...
					From AT_Syn_Deal_Rights_Subtitling AtADRS (NOLOCK)  WHERE AtADRS.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
					...
					From AT_Syn_Deal_Rights_Dubbing AtADRD (NOLOCK)  WHERE AtADRD.AT_Syn_Deal_Rights_Code	= @AT_Syn_Deal_Rights_Code
					...
					FROM AT_Syn_Deal_Rights_Holdback AtADRH (NOLOCK)  WHERE AtADRH.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
					...
					FROM AT_Syn_Deal_Rights_Holdback_Dubbing AtADRHD (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Holdback AtADRH (NOLOCK)  ON AtADRHD.AT_Syn_Deal_Rights_Holdback_Code = AtADRH.AT_Syn_Deal_Rights_Holdback_Code
						INNER JOIN Syn_Deal_Rights_Holdback ADRH (NOLOCK)  ON
					...
					FROM AT_Syn_Deal_Rights_Holdback_Platform AtADRHP (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Holdback AtADRH (NOLOCK)  ON AtADRHP.AT_Syn_Deal_Rights_Holdback_Code = AtADRH.AT_Syn_Deal_Rights_Holdback_Code
						INNER JOIN Syn_Deal_Rights_Holdback ADRH (NOLOCK) ON
							CAST(ISNULL(ADRH.HB_Run_After_Release_No, '') AS VARCHAR) + '~' + ISNULL(ADRH.HB_Run_After_Release_Units, '') + '~' +
							ISNULL(ADRH.Holdback_Comment, '') + '~' + CAST(ISNULL(ADRH.Holdback_On_Platform_Code, '') AS VARCHAR) + '~' +
							CAST(ISNULL(ADRH.Holdback_Release_Date, '') AS VARCHAR) + '~' + ISNULL(ADRH.Holdback_Type, '') + '~' + ISNULL(ADRH.Is_Original_Language, '') 
					...
					FROM AT_Syn_Deal_Rights_Holdback_Subtitling AtADRHS (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Holdback AtADRH  (NOLOCK) ON AtADRHS.AT_Syn_Deal_Rights_Holdback_Code = AtADRH.AT_Syn_Deal_Rights_Holdback_Code
						INNER JOIN Syn_Deal_Rights_Holdback ADRH (NOLOCK)  ON
							CAST(ISNULL(ADRH.HB_Run_After_Release_No, '') AS VARCHAR) + '~' + ISNULL(ADRH.HB_Run_After_Release_Units, '') + '~' +
							ISNULL(ADRH.Holdback_Comment, '') + '~' + CAST(ISNULL(ADRH.Holdback_On_Platform_Code, '') AS VARCHAR) + '~' +
							CAST(ISNULL(ADRH.Holdback_Release_Date, '') AS VARCHAR) + '~' + ISNULL(ADRH.Holdback_Type, '') + '~' + ISNULL(ADRH.Is_Original_Language, '') 
					...
					FROM AT_Syn_Deal_Rights_Holdback_Territory AtADRHT (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Holdback AtADRH  (NOLOCK) ON AtADRHT.AT_Syn_Deal_Rights_Holdback_Code = AtADRH.AT_Syn_Deal_Rights_Holdback_Code
						INNER JOIN Syn_Deal_Rights_Holdback ADRH  (NOLOCK) ON 
							CAST(ISNULL(ADRH.HB_Run_After_Release_No, '') AS VARCHAR) + '~' + ISNULL(ADRH.HB_Run_After_Release_Units, '') + '~' +
							ISNULL(ADRH.Holdback_Comment, '') + '~' + CAST(ISNULL(ADRH.Holdback_On_Platform_Code, '') AS VARCHAR) + '~' +
							CAST(ISNULL(ADRH.Holdback_Release_Date, '') AS VARCHAR) + '~' + ISNULL(ADRH.Holdback_Type, '') + '~' + ISNULL(ADRH.Is_Original_Language, '') 
					...
					FROM AT_Syn_Deal_Rights_Blackout AtADRB (NOLOCK)  WHERE AtADRB.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
					...
					FROM AT_Syn_Deal_Rights_Blackout_Dubbing AtADRBD (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Blackout AtADRB (NOLOCK)  ON AtADRBD.AT_Syn_Deal_Rights_Blackout_Code = AtADRB.AT_Syn_Deal_Rights_Blackout_Code
						INNER JOIN Syn_Deal_Rights_Blackout ADRB (NOLOCK)  ON 
					...
					FROM AT_Syn_Deal_Rights_Blackout_Platform AtADRBP (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Blackout AtADRB (NOLOCK)  ON AtADRBP.AT_Syn_Deal_Rights_Blackout_Code = AtADRB.AT_Syn_Deal_Rights_Blackout_Code
						INNER JOIN Syn_Deal_Rights_Blackout ADRB (NOLOCK)  ON 
							CAST(ISNULL(ADRB.Start_Date, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.End_Date, '') AS VARCHAR) + '~' +
							CAST(ISNULL(ADRB.Inserted_By, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.Inserted_On, '') AS VARCHAR)
							=
					...
					FROM AT_Syn_Deal_Rights_Blackout_Subtitling AtADRBS (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Blackout AtADRB (NOLOCK)  ON AtADRBS.AT_Syn_Deal_Rights_Blackout_Code = AtADRB.AT_Syn_Deal_Rights_Blackout_Code
						INNER JOIN Syn_Deal_Rights_Blackout ADRB (NOLOCK)  ON
							CAST(ISNULL(ADRB.Start_Date, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.End_Date, '') AS VARCHAR) + '~' +
							CAST(ISNULL(ADRB.Inserted_By, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.Inserted_On, '') AS VARCHAR) 
							=
					...
					FROM AT_Syn_Deal_Rights_Blackout_Territory AtADRBT (NOLOCK) 
						INNER JOIN AT_Syn_Deal_Rights_Blackout AtADRB (NOLOCK)  ON AtADRBT.AT_Syn_Deal_Rights_Blackout_Code = AtADRB.AT_Syn_Deal_Rights_Blackout_Code
						INNER JOIN Syn_Deal_Rights_Blackout ADRB (NOLOCK)  ON
							CAST(ISNULL(ADRB.Start_Date, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.End_Date, '') AS VARCHAR) + '~' +
							CAST(ISNULL(ADRB.Inserted_By, '') AS VARCHAR) + '~' + CAST(ISNULL(ADRB.Inserted_On, '') AS VARCHAR) 
							=
					...
					FROM AT_Syn_Deal_Rights_Promoter AtSDRP (NOLOCK)  WHERE AtSDRP.AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code  
			 ...
			 INSERT INTO Syn_Deal_Rights_Promoter_Group( Syn_Deal_Rights_Promoter_Code, Promoter_Group_Code)
						  ...
						  FROM (
							Select Row_Number() over(order by Syn_Deal_Rights_Promoter_Code Asc) RowId, * From AT_Syn_Deal_Rights_Promoter (NOLOCK) 
							Where AT_Syn_Deal_Rights_Code = @AT_Syn_Deal_Rights_Code
						  ) SDRP
						  INNER JOIN AT_Syn_Deal_Rights_Promoter_Group SDRPG (NOLOCK)  ON SDRPG.AT_Syn_Deal_Rights_Promoter_Code = SDRP.AT_Syn_Deal_Rights_Promoter_Code
						  INNER JOIN (
					 ...
					 INSERT INTO Syn_Deal_Rights_Promoter_Remarks( Syn_Deal_Rights_Promoter_Code, Promoter_Remarks_Code)
						  ...
						  INNER JOIN AT_Syn_Deal_Rights_Promoter_Remarks SDRPR (NOLOCK)  ON SDRPR.AT_Syn_Deal_Rights_Promoter_Code = SDRP.AT_Syn_Deal_Rights_Promoter_Code
						  INNER JOIN (
							Select Row_Number() over(order by Syn_Deal_Rights_Promoter_Code Asc) RowId, * From Syn_Deal_Rights_Promoter (NOLOCK) 
							Where Syn_Deal_Rights_Code = @Syn_Deal_Rights_Code
						  ) As SDRPNew On SDRP.RowId = SDRPNew.RowId
				...
				/******************************** Delete from Syn_Deal_Supplementary *****************************************/  
			
				/* Delete from Syn_Deal_Supplementary_Detail */  
				DELETE ADAP FROM Syn_Deal_Supplementary ADA INNER JOIN Syn_Deal_Supplementary_Detail ADAP    
				ON ADAP.Syn_Deal_Supplementary_Code = ADA.Syn_Deal_Supplementary_Code AND ADA.Syn_Deal_Code = @Syn_Deal_Code  
  
				/* Delete from Syn_Deal_Ancillary */  
				DELETE FROM Syn_Deal_Supplementary WHERE Syn_Deal_Code = @Syn_Deal_Code  
  
				--Declare cursor form ancillary  
  				DECLARE @Syn_Deal_Supplementary_Code INT = 0, @AT_Syn_Deal_Supplementary_Code INT
				DECLARE Supplementary_cursor CURSOR 
				FOR SELECT DISTINCT AT_Syn_Deal_Supplementary_Code, Syn_Deal_Supplementary_Code FROM AT_Syn_Deal_Supplementary (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				OPEN Supplementary_cursor 
				FETCH NEXT FROM Supplementary_cursor INTO @AT_Syn_Deal_Supplementary_Code, @Syn_Deal_Supplementary_Code
				WHILE @@FETCH_STATUS = 0  
				BEGIN  
					/******************************** Insert into AT_Syn_Deal_Supplementary *****************************************/   
	
					/* Delete from Syn_Deal_Supplementary_Detail */  
					DELETE FROM Syn_Deal_Supplementary_Detail WHERE Syn_Deal_Supplementary_Code IN (
						SELECT Syn_Deal_Supplementary_Code FROM AT_Syn_Deal_Supplementary (NOLOCK)  WHERE AT_Syn_Deal_Supplementary_Code = @AT_Syn_Deal_Supplementary_Code
					)
  
					/* Delete from Syn_Deal_Ancillary */  
					DELETE FROM Syn_Deal_Supplementary WHERE Syn_Deal_Supplementary_Code IN (
						SELECT Syn_Deal_Supplementary_Code FROM AT_Syn_Deal_Supplementary  (NOLOCK) WHERE AT_Syn_Deal_Supplementary_Code = @AT_Syn_Deal_Supplementary_Code
					)
  
					SET IDENTITY_INSERT [Syn_Deal_Supplementary] ON            
				
					INSERT INTO Syn_Deal_Supplementary(Syn_Deal_Supplementary_Code, Syn_Deal_Code, Title_code, Episode_From, Episode_To, Remarks)
					SELECT Syn_Deal_Supplementary_Code, @Syn_Deal_Code, Title_code, Episode_From, Episode_To, Remarks 
					FROM AT_Syn_Deal_Supplementary (NOLOCK)  WHERE AT_Syn_Deal_Supplementary_Code = @AT_Syn_Deal_Supplementary_Code

					SET IDENTITY_INSERT [Syn_Deal_Supplementary] OFF
				
					/**************** Insert into Syn_Deal_Supplementary_Detail ****************/   
  			
					SET IDENTITY_INSERT [Syn_Deal_Supplementary_Detail] ON
				
					INSERT INTO Syn_Deal_Supplementary_Detail(Syn_Deal_Supplementary_Detail_Code, Syn_Deal_Supplementary_Code, Supplementary_Tab_Code, 
						   Supplementary_Config_Code, Supplementary_Data_Code, User_Value, Row_Num)
					SELECT Syn_Deal_Supplementary_Detail_Code, @Syn_Deal_Supplementary_Code, Supplementary_Tab_Code, 
						   Supplementary_Config_Code, Supplementary_Data_Code, User_Value, Row_Num
					FROM AT_Syn_Deal_Supplementary_Detail (NOLOCK)  WHERE AT_Syn_Deal_Supplementary_Code = @AT_Syn_Deal_Supplementary_Code

					SET IDENTITY_INSERT [Syn_Deal_Supplementary_Detail] OFF
				...
				DECLARE @AT_Syn_Deal_Ancillary_Code INT,@Ancillary_Type_code INT, @Duration numeric, @Day numeric, @A_Remarks NVARCHAR(2000), @Group_No INT, @Catch_Up_From CHAR(1)
				DECLARE ancillary_cursor CURSOR
				FOR SELECT AT_Syn_Deal_Ancillary_Code, Ancillary_Type_code, Duration, Day, Remarks, Group_No, Catch_Up_From
					FROM AT_Syn_Deal_Ancillary (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				OPEN ancillary_cursor

				FETCH NEXT FROM ancillary_cursor
				INTO @AT_Syn_Deal_Ancillary_Code,@Ancillary_Type_code, @Duration, @Day, @A_Remarks, @Group_No, @Catch_Up_From
			
				WHILE @@FETCH_STATUS = 0
					BEGIN
						/******************************** Insert into AT_Syn_Deal_Ancillary *****************************************/ 
						INSERT INTO Syn_Deal_Ancillary VALUES(@Syn_Deal_Code, @Ancillary_Type_code, @Duration, @Day, @A_Remarks, @Group_No, @Catch_Up_From)
						...
						FROM AT_Syn_Deal_Ancillary_Platform AtADAP (NOLOCK)  WHERE AtADAP.AT_Syn_Deal_Ancillary_Code = @AT_Syn_Deal_Ancillary_Code
						...
						FROM AT_Syn_Deal_Ancillary_Platform_Medium AtADAPM (NOLOCK) 
							INNER JOIN AT_Syn_Deal_Ancillary_Platform AtADAP (NOLOCK)  ON AtADAPM.AT_Syn_Deal_Ancillary_Platform_Code = AtADAP.AT_Syn_Deal_Ancillary_Platform_Code
							INNER JOIN Syn_Deal_Ancillary_Platform ADAP (NOLOCK)  ON ADAP.Ancillary_Platform_code = AtADAP.Ancillary_Platform_code
						...
						FROM AT_Syn_Deal_Ancillary_Title AtADAT (NOLOCK)  WHERE AtADAT.AT_Syn_Deal_Ancillary_Code = @AT_Syn_Deal_Ancillary_Code
			   ...
			   @SR_Last_action_By INT, @SR_Last_updated_Time DATETIME
				...
				FROM AT_Syn_Deal_Run (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
			   ...
			   @SR_Last_action_By, @SR_Last_updated_Time
					...
					BEGIN
						...
						FROM AT_Syn_Deal_Run_Repeat_On_Day AtADRRD  (NOLOCK) WHERE AtADRRD.AT_Syn_Deal_Run_Code = @AT_Syn_Deal_Run_Code
						...
						FROM AT_Syn_Deal_Run_Platform AtADRT (NOLOCK) WHERE AtADRT.AT_Syn_Deal_Run_Code = @AT_Syn_Deal_Run_Code
						...
						FROM AT_Syn_Deal_Run_Yearwise_Run AtADRYR (NOLOCK)  WHERE AtADRYR.AT_Syn_Deal_Run_Code = @AT_Syn_Deal_Run_Code
				...
				FROM AT_Syn_Deal_Revenue (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				...
				FROM AT_Syn_Deal_Revenue AtSDC (NOLOCK) 
					INNER JOIN AT_Syn_Deal_Revenue_Additional_Exp AtSDCAE (NOLOCK)  ON AtSDCAE.AT_Syn_Deal_Revenue_Code = AtSDC.AT_Syn_Deal_Revenue_Code AND AtSDC.AT_Syn_Deal_Code = @AT_Syn_Deal_Code
					INNER JOIN Syn_Deal_Revenue SDC (NOLOCK)  ON SDC.Syn_Deal_Code = @Syn_Deal_Code AND 
				...
				FROM AT_Syn_Deal_Revenue AtSDC (NOLOCK) 
					INNER JOIN AT_Syn_Deal_Revenue_Commission AtSDCC (NOLOCK)  ON AtSDCC.AT_Syn_Deal_Revenue_Code = AtSDC.AT_Syn_Deal_Revenue_Code AND AtSDC.AT_Syn_Deal_Code = @AT_Syn_Deal_Code
					INNER JOIN Syn_Deal_Revenue SDC (NOLOCK)  ON SDC.Syn_Deal_Code = @Syn_Deal_Code AND 
						CAST(ISNULL(SDC.Currency_Code, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Currency_Exchange_Rate, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Deal_Cost, 0) AS VARCHAR) + '~' + CAST(ISNULL(SDC.Deal_Cost_Per_Episode, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Cost_Center_Id, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Additional_Cost, 0) AS VARCHAR) + '~' +
				...
				FROM AT_Syn_Deal_Revenue AtSDC (NOLOCK) 
					INNER JOIN AT_Syn_Deal_Revenue_Title AtSDCT (NOLOCK)  ON AtSDCT.AT_Syn_Deal_Revenue_Code = AtSDC.AT_Syn_Deal_Revenue_Code AND AtSDC.AT_Syn_Deal_Code = @AT_Syn_Deal_Code
					INNER JOIN Syn_Deal_Revenue SDC (NOLOCK)  ON SDC.Syn_Deal_Code = @Syn_Deal_Code AND 
						CAST(ISNULL(SDC.Currency_Code, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Currency_Exchange_Rate, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Deal_Cost, 0) AS VARCHAR) + '~' + CAST(ISNULL(SDC.Deal_Cost_Per_Episode, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Cost_Center_Id, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Additional_Cost, 0) AS VARCHAR) + '~' +
				...
				FROM AT_Syn_Deal_Revenue AtSDC (NOLOCK) 
					INNER JOIN AT_Syn_Deal_Revenue_Variable_Cost AtSDCVC  (NOLOCK) ON AtSDCVC.AT_Syn_Deal_Revenue_Code = AtSDC.AT_Syn_Deal_Revenue_Code AND AtSDC.AT_Syn_Deal_Code = @AT_Syn_Deal_Code
					INNER JOIN Syn_Deal_Revenue SDC  (NOLOCK) ON SDC.Syn_Deal_Code = @Syn_Deal_Code AND 
						CAST(ISNULL(SDC.Currency_Code, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Currency_Exchange_Rate, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Deal_Cost, 0) AS VARCHAR) + '~' + CAST(ISNULL(SDC.Deal_Cost_Per_Episode, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Cost_Center_Id, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Additional_Cost, 0) AS VARCHAR) + '~' +
				...
				FROM AT_Syn_Deal_Revenue AtSDC (NOLOCK) 
					INNER JOIN AT_Syn_Deal_Revenue_Costtype AtSDCC (NOLOCK)  ON AtSDCC.AT_Syn_Deal_Revenue_Code = AtSDC.AT_Syn_Deal_Revenue_Code AND AtSDC.AT_Syn_Deal_Code = @AT_Syn_Deal_Code
					INNER JOIN Syn_Deal_Revenue SDC  (NOLOCK) ON SDC.Syn_Deal_Code = @Syn_Deal_Code AND 
						CAST(ISNULL(SDC.Currency_Code, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Currency_Exchange_Rate, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Deal_Cost, 0) AS VARCHAR) + '~' + CAST(ISNULL(SDC.Deal_Cost_Per_Episode, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Cost_Center_Id, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Additional_Cost, 0) AS VARCHAR) + '~' +
				...
				FROM AT_Syn_Deal_Revenue AtSDC (NOLOCK) 
					INNER JOIN AT_Syn_Deal_Revenue_Costtype AtSDCC (NOLOCK)  ON AtSDCC.AT_Syn_Deal_Revenue_Code = AtSDC.AT_Syn_Deal_Revenue_Code AND AtSDC.AT_Syn_Deal_Code = @AT_Syn_Deal_Code
					INNER JOIN AT_Syn_Deal_Revenue_Costtype_Episode AtSDCCE (NOLOCK)  ON AtSDCCE.AT_Syn_Deal_Revenue_Costtype_Code = AtSDCC.AT_Syn_Deal_Revenue_Costtype_Code
					INNER JOIN Syn_Deal_Revenue SDC  (NOLOCK) ON SDC.Syn_Deal_Code = @Syn_Deal_Code AND 
						CAST(ISNULL(SDC.Currency_Code, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Currency_Exchange_Rate, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Deal_Cost, 0) AS VARCHAR) + '~' + CAST(ISNULL(SDC.Deal_Cost_Per_Episode, 0) AS VARCHAR) + '~' +
						CAST(ISNULL(SDC.Cost_Center_Id, '') AS VARCHAR) + '~' + CAST(ISNULL(SDC.Additional_Cost, 0) AS VARCHAR) + '~' +
						...
						ISNULL(AtSDC.Variable_Cost_Sharing_Type, '') + '~' + CAST(ISNULL(AtSDC.Royalty_Recoupment_Code, '') AS VARCHAR) + '~' +
						CAST(ISNULL(AtSDC.Inserted_On, '') AS VARCHAR) + '~' + CAST(ISNULL(AtSDC.Inserted_By, '') AS VARCHAR)
					INNER JOIN Syn_Deal_Revenue_Costtype SDCC  (NOLOCK) ON SDCC.Syn_Deal_Revenue_Code = SDC.Syn_Deal_Revenue_Code AND
				...
				SELECT @Syn_Deal_Code, Payment_Terms_Code, Days_After, Percentage, Due_Date, Cost_Type_Code, Inserted_On, Inserted_By, GETDATE(), @User_Code
					FROM AT_Syn_Deal_Payment_Terms (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				...
				SELECT @Syn_Deal_Code, Title_Code,Episode_From,Episode_To, Attachment_Title, Attachment_File_Name, System_File_Name, Document_Type_Code
					FROM AT_Syn_Deal_Attachment  (NOLOCK) WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				...
				SELECT @Syn_Deal_Code, Title_Code,Episode_From,Episode_To, Material_Medium_Code, Material_Type_Code, Quantity, Inserted_On, Inserted_By, Lock_Time, GETDATE(), @User_Code
					FROM AT_Syn_Deal_Material (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code		
					
				/******************************** Delete from Syn_Deal_Digital *****************************************/  
			
				/* Delete from Syn_Deal_Digital_Detail */  
				DELETE ADAP FROM Syn_Deal_Digital ADA INNER JOIN Syn_Deal_Digital_Detail ADAP    
				ON ADAP.Syn_Deal_Digital_Code = ADA.Syn_Deal_Digital_Code AND ADA.Syn_Deal_Code = @Syn_Deal_Code  
  
				/* Delete from Syn_Deal_Digital */  
				DELETE FROM Syn_Deal_Digital WHERE Syn_Deal_Code = @Syn_Deal_Code  
  
				--Declare cursor form Digital  
  				DECLARE @Syn_Deal_Digital_Code INT = 0, @AT_Syn_Deal_Digital_Code INT
				DECLARE Digital_cursor CURSOR 
				FOR SELECT DISTINCT AT_Syn_Deal_Digital_Code, Syn_Deal_Digital_Code FROM AT_Syn_Deal_Digital (NOLOCK)  WHERE AT_Syn_Deal_Code = @AT_Syn_Deal_Code
				OPEN Digital_cursor 
				FETCH NEXT FROM Digital_cursor INTO @AT_Syn_Deal_Digital_Code, @Syn_Deal_Digital_Code
				WHILE @@FETCH_STATUS = 0  
				BEGIN  
					/******************************** Insert into AT_Syn_Deal_Digital *****************************************/   
	
					/* Delete from Syn_Deal_Digital_Detail */  
					DELETE FROM Syn_Deal_Digital_Detail WHERE Syn_Deal_Digital_Code IN (
						SELECT Syn_Deal_Digital_Code FROM AT_Syn_Deal_Digital (NOLOCK)  WHERE AT_Syn_Deal_Digital_Code = @AT_Syn_Deal_Digital_Code
					)
  
					/* Delete from Syn_Deal_Digital */  
					DELETE FROM Syn_Deal_Digital WHERE Syn_Deal_Digital_Code IN (
						SELECT Syn_Deal_Digital_Code FROM AT_Syn_Deal_Digital  (NOLOCK) WHERE AT_Syn_Deal_Digital_Code = @AT_Syn_Deal_Digital_Code
					)
  
					SET IDENTITY_INSERT [Syn_Deal_Digital] ON            
				
					INSERT INTO Syn_Deal_Digital(Syn_Deal_Digital_Code, Syn_Deal_Code, Title_code, Episode_From, Episode_To, Remarks)
					SELECT Syn_Deal_Digital_Code, @Syn_Deal_Code, Title_code, Episode_From, Episode_To, Remarks 
					FROM AT_Syn_Deal_Digital (NOLOCK)  WHERE AT_Syn_Deal_Digital_Code = @AT_Syn_Deal_Digital_Code

					SET IDENTITY_INSERT [Syn_Deal_Digital] OFF
				
					/**************** Insert into Syn_Deal_Digital_Detail ****************/   
  			
					SET IDENTITY_INSERT [Syn_Deal_Digital_Detail] ON
				
					INSERT INTO Syn_Deal_Digital_Detail(Syn_Deal_Digital_Detail_Code, Syn_Deal_Digital_Code, Digital_Tab_Code, 
						   Digital_Config_Code, Digital_Data_Code, User_Value, Row_Num)
					SELECT Syn_Deal_Digital_Detail_Code, @Syn_Deal_Digital_Code, Digital_Tab_Code, 
						   Digital_Config_Code, Digital_Data_Code, User_Value, Row_Num
					FROM AT_Syn_Deal_Digital_Detail (NOLOCK)  WHERE AT_Syn_Deal_Digital_Code = @AT_Syn_Deal_Digital_Code

					SET IDENTITY_INSERT [Syn_Deal_Digital_Detail] OFF
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_RollBack_Syn_Deal]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END