...
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USP_Validate_Show_Episode_UDT]', 'Step 1', 0, 'Started Procedure', 0, ''
		...
		FROM #NAEps b
		INNER JOIN Title t  (NOLOCK) on b.Title_Code = t.Title_Code
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USP_Validate_Show_Episode_UDT]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END