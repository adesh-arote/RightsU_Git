CREATE PROC [dbo].[USP_ChannelWiseMusicUsage_Report]
(
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_ChannelWiseMusicUsage_Report]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_ChannelWiseMusicUsage_Report]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END