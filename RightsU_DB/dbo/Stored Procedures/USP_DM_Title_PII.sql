...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_DM_Title_PII]', 'Step 1', 0, 'Started Procedure', 0, ''
		SET NOCOUNT ON
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_DM_Title_PII]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END