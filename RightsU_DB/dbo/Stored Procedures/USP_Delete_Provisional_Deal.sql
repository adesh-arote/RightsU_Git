CREATE PROC [dbo].[USP_Delete_Provisional_Deal]      
(      
...
BEGIN      
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Delete_Provisional_Deal]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Delete_Provisional_Deal]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''   
END