...
Last Change     : Added Case for Control Type Date and Int to give selected values as Names to show in front end/View
---------------------------*/
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Bind_Extend_Column_Grid]', 'Step 1', 0, 'Started Procedure', 0, ''
		SET NOCOUNT ON;
		select distinct 
				EC.Columns_Name
				,Ec.Columns_Code
