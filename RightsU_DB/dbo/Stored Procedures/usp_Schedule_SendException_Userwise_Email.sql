...
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[usp_Schedule_SendException_Userwise_Email]', 'Step 1', 0, 'Started Procedure', 0, ''
	/*Create User data*/
	BEGIN
								...
								if( 
								  ...
								  BEGIN
										...
										BEGIN
												...
												</tr>' FROM Email_Notification_Schedule e (NOLOCK)
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[usp_Schedule_SendException_Userwise_Email]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END