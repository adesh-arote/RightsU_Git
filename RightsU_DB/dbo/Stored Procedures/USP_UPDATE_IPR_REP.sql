...
BEGIN	
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_UPDATE_IPR_REP]', 'Step 1', 0, 'Started Procedure', 0, ''  
		SET NOCOUNT ON;
			UPDATE IPR_REP SET 
	 ...
	 if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_UPDATE_IPR_REP]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''  
END
