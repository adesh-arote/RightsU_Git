...
Begin
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Delete_Acq_Deal_Pushback_Territory]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Delete_Acq_Deal_Pushback_Territory]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
End
