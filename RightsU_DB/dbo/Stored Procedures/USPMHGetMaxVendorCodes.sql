CREATE PROCEDURE [dbo].[USPMHGetMaxVendorCodes]
...
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPMHGetMaxVendorCodes]', 'Step 1', 0, 'Started Procedure', 0, ''
			...
			INTO #TempVendor FROM MHRequest MR (NOLOCK)
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPMHGetMaxVendorCodes]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END