CREATE PROCEDURE [dbo].[USPMHGetPieChartData] 
@UsersCode INT,
@NoOfMonths INT= 1
AS
BEGIN
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPMHGetPieChartData]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel< 2)Exec [USPLogSQLSteps] '[USPMHGetPieChartData]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END