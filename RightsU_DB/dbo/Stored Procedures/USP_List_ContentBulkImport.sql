CREATE PROCEDURE [dbo].[USP_List_ContentBulkImport]
(
...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_List_ContentBulkImport]', 'Step 1', 0, 'Started Procedure', 0, '' 
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_List_ContentBulkImport]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END