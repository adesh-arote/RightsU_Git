...
BEGIN
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_List_Deal_Title_Content]', 'Step 1', 0, 'Started Procedure', 0, ''
		SET FMTONLY OFF
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_List_Deal_Title_Content]', 'Step 2', 0, 'Procedure Excution Completed', 0, ''
END