CREATE PROC [dbo].[USP_RunUtilizationReport]
(
...
BEGIN
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_RunUtilizationReport]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel<2)Exec [USPLogSQLSteps] '[USP_RunUtilizationReport]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''
END