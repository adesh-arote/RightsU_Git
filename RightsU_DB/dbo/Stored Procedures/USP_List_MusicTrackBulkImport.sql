CREATE PROCEDURE [dbo].[USP_List_MusicTrackBulkImport]
(
...
BEGIN
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_List_MusicTrackBulkImport]', 'Step 1', 0, 'Started Procedure', 0, ''  
	...
	if(@Loglevel  < 2)Exec [USPLogSQLSteps] '[USP_List_MusicTrackBulkImport]', 'Step 2', 0, 'Procedure Excution Completed', 0, '' 
END