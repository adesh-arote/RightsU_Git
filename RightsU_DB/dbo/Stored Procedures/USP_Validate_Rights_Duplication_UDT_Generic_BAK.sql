...
Begin
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Validate_Rights_Duplication_UDT_Generic_BAK]', 'Step 1', 0, 'Started Procedure', 0, ''
	...
	if(@Loglevel < 2)Exec [USPLogSQLSteps] '[USP_Validate_Rights_Duplication_UDT_Generic_BAK]', 'Step 2', 0, 'Procedure Excuting Completed', 0, ''	
END
