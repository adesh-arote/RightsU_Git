...
BEGIN  
 ...
 BEGIN  
  ...
  SELECT TOP 1 @NewAcqDealRightsCode_S = SecondaryDataCode FROM RightsU_Plus_Testing.dbo.AcqPreReqMappingData MD WHERE MD.MappingFor = 'ACQDEALRIGHTS' AND PrimaryDataCode = @SynDealRightsCode  
