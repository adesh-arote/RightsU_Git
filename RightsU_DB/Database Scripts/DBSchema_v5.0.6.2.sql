ALTER PROCEDURE USP_Get_ExcelSrNo(
...
--select * from #tmpSearchCategory
--SELECT * FROM DM_Title_Import_Utility_Data where DM_Master_Import_Code = 19
-- EXEC USP_Title_import_Utility_PIII 76
GO
