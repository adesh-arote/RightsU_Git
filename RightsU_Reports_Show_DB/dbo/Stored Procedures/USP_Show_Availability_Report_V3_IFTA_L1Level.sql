CREATE PROCEDURE [dbo].[USP_Show_Availability_Report_V3_IFTA_L1Level]
(
--DECLARE
...
--+''',@Is_Digital='''+ISNULL(Cast(@Is_Digital AS varchar), '')
   ...
   END		
	...
	BEGIN
		...
		INSERT INTO #Temp_Main_Ctr_L1(Avail_Raw_Code, Title_Code, Platform_Code, Country_Code, Is_Title_Language, Sub_Language_Code, Dub_Language_code, Country_Cd_Str, 
			   COL1, COL2, COL3, Region_Type, Platform_Str, Title_Language_Names, Sub_Language_Names, Dub_Language_Names, Acq_Deal_Rights_Holdback_Code, Holdback_Type, 
			   Holdback_Release_Date, Holdback_On_Platform_Code, Reverse_Holdback, Group_no, Base_Platform_Code, Actual_Platform_Count, Avail_Platform_Count)
		SELECT Avail_Raw_Code, Title_Code, Platform_Code, Country_Code, Is_Title_Language, Sub_Language_Code, Dub_Language_code, Country_Cd_Str, 
			   COL1, COL2, COL3, Region_Type, Platform_Str, Title_Language_Names, Sub_Language_Names, Dub_Language_Names, Acq_Deal_Rights_Holdback_Code, Holdback_Type, 
			   Holdback_Release_Date, Holdback_On_Platform_Code, Reverse_Holdback, Group_no, NULL, 0, 0
		FROM #Temp_Main_Ctr
		...
		INNER JOIN (
			SELECT Avail_Raw_Code, Title_Code, Country_Code, Is_Title_Language, Sub_Language_Code, Dub_Language_code, Country_Cd_Str, 
				   COL1, COL2, COL3, Region_Type, Platform_Str, Title_Language_Names, Sub_Language_Names, Dub_Language_Names, Acq_Deal_Rights_Holdback_Code, Holdback_Type, 
			       Holdback_Release_Date, Holdback_On_Platform_Code, Reverse_Holdback, Group_no, Base_Platform_Code, Actual_Platform_Count, COUNT(*) AvailCnt
			FROM #Temp_Main_Ctr_L1
			GROUP BY Avail_Raw_Code, Title_Code, Country_Code, Is_Title_Language, Sub_Language_Code, Dub_Language_code, Country_Cd_Str, 
				   COL1, COL2, COL3, Region_Type, Platform_Str, Title_Language_Names, Sub_Language_Names, Dub_Language_Names, Acq_Deal_Rights_Holdback_Code, Holdback_Type, 
			       Holdback_Release_Date, Holdback_On_Platform_Code, Reverse_Holdback, Group_no, Base_Platform_Code, Actual_Platform_Count
		...
		ISNULL(ctr.COL1, '') = ISNULL(avail.COL1, '') AND 
		ISNULL(ctr.COL2, '') = ISNULL(avail.COL2, '') AND 
		ISNULL(ctr.COL3, '') = ISNULL(avail.COL3, '') AND 
		...
		DELETE FROM #Temp_Main_Ctr

		INSERT INTO #Temp_Main_Ctr(Avail_Raw_Code, Title_Code, Platform_Code, Country_Code, Is_Title_Language, Sub_Language_Code, Dub_Language_code, Country_Cd_Str, 
			   COL1, COL2, COL3, Region_Type, Platform_Str, Title_Language_Names, Sub_Language_Names, Dub_Language_Names, Acq_Deal_Rights_Holdback_Code, Holdback_Type, 
			   Holdback_Release_Date, Holdback_On_Platform_Code, Reverse_Holdback, Group_no, Available)
		SELECT DISTINCT Avail_Raw_Code, Title_Code, Base_Platform_Code, Country_Code, Is_Title_Language, Sub_Language_Code, Dub_Language_code, Country_Cd_Str, 
			   COL1, COL2, COL3, Region_Type, Platform_Str, Title_Language_Names, Sub_Language_Names, Dub_Language_Names, Acq_Deal_Rights_Holdback_Code, Holdback_Type, 
			   Holdback_Release_Date, Holdback_On_Platform_Code, Reverse_Holdback, Group_no,
			   CASE WHEN Actual_Platform_Count = Avail_Platform_Count THEN 'Yes' Else 'Partial' END AS Available
		FROM #Temp_Main_Ctr_L1
	
		DROP TABLE #Temp_Main_Ctr_L1
		--Select * From #Temp_Main_Ctr
	END
