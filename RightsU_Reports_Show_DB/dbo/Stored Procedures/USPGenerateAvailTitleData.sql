...
BEGIN
	...
	BEGIN -------------- DATA POPULATION
		...
		INNER JOIN Avail_Acq_Show_Details aad ON aa.Avail_Acq_Show_Code = aad.Avail_Acq_Show_Code
	...
	*/
	...
	BEGIN ------- TRANSFER DATA FOR AVAIL DATABASE
		...
		SELECT DISTINCT Acq_Deal_Code, Acq_Deal_Rights_Code, Start_Date, End_Date, Is_Exclusive, atd.Title_Code, Platform_Codes, Country_Codes, 
			   Is_Title_Language, sl.Language_Codes AS Sub_Language_Codes, dl.Language_Codes AS Dub_Language_Codes, ar.Episode_From, ar.Episode_To, 0
...
--EXEC USPGenerateAvailTitleData 6513
