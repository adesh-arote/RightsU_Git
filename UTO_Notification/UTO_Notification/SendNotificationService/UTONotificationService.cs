    ...
    public partial class UTONotificationService : ServiceBase
    {
        ...
        public static USPGetConfig RunUSPGetConfigProcedure()
        {
            ...
            catch (Exception ex)
            {
                ...
                LogError("API : RunUSPGetConfigProcedure => " + Convert.ToString(ex.InnerException));
        ...
        public static List<USPGetPendingNotifications> RunUSPGetPendingNotificationsProcedure()
        {
            ...
            catch (Exception ex)
            {
                ...
                LogError("API : RunUSPGetPendingNotificationsProcedure => " + Convert.ToString(ex.InnerException));
        ...
        public static void RunNotifications(List<USPGetPendingNotifications> notificationList, USPGetConfig config)
        {
            ...
            foreach (USPGetPendingNotifications notification in notificationList)
            {
                ...
                try
                {
                    ...
                    RunUSPUpdateNotificationStatusProcedure(notification.NotificationsCode, isSuccess, 1, DateTime.Now.ToString("dd/MMM/yyyy hh:mm:ss tt"), 0, "");
                ...
                catch (Exception ex)
                {
                    ...
                    RunUSPUpdateNotificationStatusProcedure(notification.NotificationsCode, isSuccess, 2, DateTime.Now.ToString("dd/MMM/yyyy hh:mm:ss tt"), 0, Convert.ToString(ex.InnerException));
                }
        ...
        public static void SendErrorEmail(string Error, string Subject)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogError("API : SendErrorEmail => " + Convert.ToString(ex.InnerException));
            }
        }
        public static void RunUSPUpdateNotificationStatusProcedure(long NECode, bool Issend, int MsgstatusCode, string SendorReadDateTime, int ErrorCode, string ErrorDetails)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogError("API : RunUSPUpdateNotificationStatusProcedure => " + Convert.ToString(ex.InnerException));
            }
        }
        ...
        public static void RunUSPArchiveNotificationsProcedure(int daysInterval)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogError("API : RunUSPArchiveNotificationsProcedure => " + Convert.ToString(ex.InnerException));
            }
        }
