...
namespace UTO_Notification.BLL.Notifications
{
    public class InApp : Notification
    {
        ...
        public override HttpResponses SaveNotification(NotificationInput obj)
        {
            ...
            USPInsertNotification objOutput = objUspService.USPInsertNotification_InApp(obj.EventCategory, obj.NotificationType, obj.TO, obj.CC, obj.BCC, obj.Subject, obj.HTMLMessage, obj.TextMessage, obj.TransType, obj.TransCode, obj.ScheduleDateTime, obj.UserCode, obj.ClientName, obj.ForeignId);
