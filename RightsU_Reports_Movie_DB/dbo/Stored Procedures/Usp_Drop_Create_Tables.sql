...
BEGIN
	BEGIN TRY
		...
		END
		/****** Object:  Table [dbo].[Platform]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Platform_Group')
		BEGIN
		DROP TABLE [dbo].[Platform_Group]
		END
		...
		END
		/****** Object:  Table [dbo].[Category]    Script Date: 4/16/2015 12:21:09 ******/
		IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Category')
		BEGIN
		DROP TABLE [dbo].[Category]
		END

		/****** Object:  Table [dbo].[Deal_Type]    Script Date: 4/16/2015 12:21:09 ******/
		...
		/****** Object:  Table [dbo].[Category]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO Category FROM RightsU_Plus_Testing.dbo.Category
		...
		/****** Object:  Table [dbo].[Platform_Group]    Script Date: 4/16/2015 12:21:09 ******/
		SET ANSI_PADDING ON
		SELECT * INTO [Platform_Group] FROM RightsU_Plus_Testing.dbo.[Platform_Group]
		ALTER TABLE [Platform_Group] 
		ADD CONSTRAINT [PK_Platform_Group_Demo] PRIMARY KEY CLUSTERED 
		(
			[Platform_Group_Code] ASC
		)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
