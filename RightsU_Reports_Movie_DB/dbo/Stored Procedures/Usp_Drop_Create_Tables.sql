...
/****** Object:  Table [dbo].[Title_Objection_Type]    Script Date: 08-10-2021 17:19:22 ******/
IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Title_Objection_Type')  
BEGIN  
	DROP TABLE [dbo].[Title_Objection_Type]
END
/****** Object:  Table [dbo].[Title_Objection_Territory]    Script Date: 08-10-2021 17:19:22 ******/
IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Title_Objection_Territory')  
BEGIN  
	DROP TABLE [dbo].[Title_Objection_Territory]
END
/****** Object:  Table [dbo].[Title_Objection_Status]    Script Date: 08-10-2021 17:19:22 ******/
IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Title_Objection_Status')  
BEGIN  
	DROP TABLE [dbo].[Title_Objection_Status]
END
/****** Object:  Table [dbo].[Title_Objection_Rights_Period]    Script Date: 08-10-2021 17:19:22 ******/
IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Title_Objection_Rights_Period')  
BEGIN  
	DROP TABLE [dbo].[Title_Objection_Rights_Period]
END
/****** Object:  Table [dbo].[Title_Objection_Platform]    Script Date: 08-10-2021 17:19:22 ******/
IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Title_Objection_Platform')  
BEGIN  
	DROP TABLE [dbo].[Title_Objection_Platform]
END
/****** Object:  Table [dbo].[Title_Objection]    Script Date: 08-10-2021 17:19:22 ******/
IF EXISTS (SELECT *  FROM sys.tables  WHERE name='Title_Objection')  
BEGIN  
	DROP TABLE [dbo].[Title_Objection]
END

 SET ANSI_PADDING ON  
  SELECT * INTO [Title_Objection] FROM RightsU_Plus_Testing.dbo.[Title_Objection]  
  ALTER TABLE [dbo].[Title_Objection]  
  ADD CONSTRAINT [PK_Title_Objection] PRIMARY KEY CLUSTERED   
  (  
...
------------
  SET ANSI_PADDING ON  
  SELECT * INTO [Title_Objection_Platform] FROM RightsU_Plus_Testing.dbo.[Title_Objection_Platform]  
  ALTER TABLE [dbo].[Title_Objection_Platform]  
  ADD CONSTRAINT [PK_Title_Objection_Platform] PRIMARY KEY CLUSTERED   
  (  
  ...
  ------------
  SET ANSI_PADDING ON  
  SELECT * INTO [Title_Objection_Rights_Period] FROM RightsU_Plus_Testing.dbo.[Title_Objection_Rights_Period]  
  ALTER TABLE [dbo].[Title_Objection_Rights_Period]  
  ADD CONSTRAINT [PK_Title_Objection_Rights_Period] PRIMARY KEY CLUSTERED   
  (  
  ...
  SET ANSI_PADDING OFF  
   ...
   ------------
  SET ANSI_PADDING ON  
  SELECT * INTO [Title_Objection_Territory] FROM RightsU_Plus_Testing.dbo.[Title_Objection_Territory]  
  ALTER TABLE [dbo].[Title_Objection_Territory]  
  ADD CONSTRAINT [PK_Title_Objection_Territory] PRIMARY KEY CLUSTERED   
  (  
  ...
  ------------
  SET ANSI_PADDING ON  
  SELECT * INTO [Title_Objection_Status] FROM RightsU_Plus_Testing.dbo.[Title_Objection_Status]  
  ALTER TABLE [dbo].[Title_Objection_Status]  
  ADD CONSTRAINT [PK_Title_Objection_Status] PRIMARY KEY CLUSTERED   
  (  
  ...
  SET ANSI_PADDING OFF  
    ...
    ------------
  SET ANSI_PADDING ON  
  SELECT * INTO [Title_Objection_Type] FROM RightsU_Plus_Testing.dbo.[Title_Objection_Type]  
  ALTER TABLE [dbo].[Title_Objection_Type]  
  ADD CONSTRAINT [PK_Title_Objection_Type] PRIMARY KEY CLUSTERED   
  (  
  ...
  Select distinct Approved_Deal_Code,Record_Code, Deal_Type,Deal_Status, GETDATE(), Is_Amend, ISNULL(Deal_Rights_Code, 0)   
  ...
  WHERE (ad.Record_Code IN (SELECT adm.Acq_Deal_Code FROM RightsU_Plus_Testing.dbo.Acq_Deal_Movie adm  
   ...
   WHERE CAST(t.Deal_Type_Code AS VARCHAR) IN(SELECT DISTINCT number FROM fn_Split_withdelemiter(@Movie_DealTypeCode , ',')) --t.Deal_Type_Code = @Movie_DealTypeCode  
  ) AND ad.Deal_Type = 'A')  
  OR  
