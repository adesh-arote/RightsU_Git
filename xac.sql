		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					INSERT INTO #tempRights(Syn_Deal_Rights_Code, Syn_Deal_Code, Title_Code, Right_Start_Date, Right_End_Date, [Sub-Licensing], Exclusive, Term, Episode_From ,Episode_To,Milestone,Milestone_Type_Code)
					SELECT Syn_Deal_Rights_Code, Syn_Deal_Code, Title_Code, Right_Start_Date, Right_End_Date, [Sub-Licensing], Exclusive, Term ,Episode_From ,Episode_To,M.Milestone_Type_Name,M.MileStone_type_code
					FROM @tblRights_New TRN
...
sp_helptext fn_Split_withdelemiter
