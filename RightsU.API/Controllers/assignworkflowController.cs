...
namespace RightsU.API.Controllers
{
    ...
    public class assignworkflowController : ApiController
    {
        ...
        /// </summary>
        /// <remarks>Retrieves all available Assign WorkFlow</remarks>
        ...
        /// <param name="searchValue">The value of the search across the Assign WorkFlow</param>
        ...
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(AssignWorkFlowReturn))]
        ...
        [HttpGet]
        [Route("api/assignworkflow")]
        public async Task<HttpResponseMessage> GetAssignWorkFlowList(Order order, Int32 page, Int32 size, SortColumn sort, string searchValue = "", string dateGt = "", string dateLt = "")
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objAssignWorkFlowServices.GetAssignWorkFlowList(order.ToString(), sort.ToString(), size, page, searchValue, dateGt, dateLt);
        ...
        /// <summary>
        ///  Assign WorkFlow by id
        /// </summary>
        /// <remarks>Retrieves  Assign WorkFlow by Id</remarks>
        /// <param name="id">get specific  Assign WorkFlow data using id.</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(AssignWorkFlowReturn))]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        ...
        [SwaggerResponse(HttpStatusCode.InternalServerError, "Internal Server Error")]
        [HttpGet]
        [Route("api/assignworkflow/{id}")]
        public async Task<HttpResponseMessage> GetAssignWorkFlowById(int? id)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objAssignWorkFlowServices.GetAssignWorkFlowById(id);
