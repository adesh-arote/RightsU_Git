...
namespace RightsU.API.Controllers
{
    ...
    public class paymenttermsController : ApiController
    {
        ...
        /// Payment Terms by id
        /// </summary>
        /// <remarks>Retrieves Payment Terms by Id</remarks>
        /// <param name="id">get specific payment terms data using id.</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(Payment_Terms))]
        ...
        public async Task<HttpResponseMessage> GetById(int? id)
        {
            ...
            GenericReturn objReturn = objPaymentTermsServices.GetById(id);
