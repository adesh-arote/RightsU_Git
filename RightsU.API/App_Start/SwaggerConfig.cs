                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.IncludeXmlComments(string.Format(@"{0}\bin\RightsU.API.Swagger.XML", System.AppDomain.CurrentDomain.BaseDirectory));
                        c.IncludeXmlComments(string.Format(@"{0}\bin\RightsU.API.Entities.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        c.SupportedSubmitMethods("POST","GET","PUT","DELETE");
