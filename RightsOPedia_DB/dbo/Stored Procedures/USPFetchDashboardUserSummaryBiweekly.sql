...
CREATE PROCEDURE [dbo].[USPFetchDashboardUserSummaryBiweekly] 
(
...
BEGIN
	...
	SELECT	Login_Name LoginName, 
		...
		WHERE ReportType = 'B'
		AND UnitNumber = @CurrentUnitNumber
		GROUP BY UserId,Login_Name,First_Name,Last_Name, Security_Group_Name, ReportType, Year, Month
		ORDER BY UserId ASC;
