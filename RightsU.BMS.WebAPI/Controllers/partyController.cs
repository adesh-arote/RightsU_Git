...
namespace RightsU.BMS.WebAPI.Controllers
{
    ...
    {
        private readonly PartyService objPartyServices = new PartyService();
        ...
        /// Party List 
        /// </summary>
        /// <remarks>Retrieves all available Parties</remarks>
        ...
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(PartyReturn))]
        ...
        [HttpGet]
        [Route("api/party")]
        public async Task<HttpResponseMessage> GetPartyList(Order order, Int32 page, Int32 size, SortColumn sort, string searchValue = "", string dateGt = "", string dateLt = "")
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objPartyServices.GetPartyList(order.ToString(), sort.ToString(), size, page, searchValue, dateGt, dateLt);
        ...
        /// Party by id
        /// </summary>
        /// <remarks>Retrieves Party by Id</remarks>
        /// <param name="id">get specific party data using id.</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(Party))]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        [SwaggerResponse(HttpStatusCode.Forbidden, "Access Forbidden")]
        [SwaggerResponse(HttpStatusCode.ExpectationFailed, "Expectation Failed / Token Missing")]
        ...
        [HttpGet]
        [Route("api/party/{id}")]
        public async Task<HttpResponseMessage> GetPartyById(int? id)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;
        ...
        /// Save Party Details
        /// </summary>
        /// <remarks>Create / Save New Party</remarks>
        /// <param name="Input">Input data object for Create/Save New Party</param>
        /// <returns></returns>
        ...
        [HttpPost]
        [Route("api/party")]
        public async Task<HttpResponseMessage> Post(Party Input)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objPartyServices.Post(Input);
        ...
        /// </summary>
        /// <remarks>Update / Modify Party details by id</remarks>
        /// <param name="Input">Input data object for Modify existing Party</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success")]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        ...
        [HttpPut]
        [Route("api/party")]
        public async Task<HttpResponseMessage> Put(Party Input)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objPartyServices.Put(Input);
        ...
        /// </summary>
        /// <remarks>Modify Active/Deactive Status of Existing Party</remarks>
        /// <param name="Input">Input data object for Modify existing Party Active/Deactive Status</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success")]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        ...
        [SwaggerResponse(HttpStatusCode.InternalServerError, "Internal Server Error")]
        [HttpPut]
        [Route("api/party/ChangeActiveStatus")]
        public async Task<HttpResponseMessage> ChangeActiveStatus(Party Input)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objPartyServices.ChangeActiveStatus(Input);
