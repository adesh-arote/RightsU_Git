...
namespace RightsU.BMS.WebAPI.Controllers
{
    ...
    public class currencyController : ApiController
    {
        ...
        private readonly CurrencyService objCurrencyServices = new CurrencyService();
        /// <summary>
        /// Currency List 
        /// </summary>
        /// <remarks>Retrieves all available Currency</remarks>
        ...
        /// <param name="searchValue">The value of the search across the Currency</param>
        ...
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(Currency))]
        ...
        public async Task<HttpResponseMessage> GetCurrencyList(Order order, Int32 page, Int32 size, SortColumn sort, string searchValue = "", string dateGt = "", string dateLt = "")
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;

            GenericReturn objReturn = objCurrencyServices.GetCurrencyList(order.ToString(), sort.ToString(), size, page, searchValue, dateGt, dateLt);
        ...
        /// Currency by id
        /// </summary>
        /// <remarks>Retrieves Currency by Id</remarks>
        /// <param name="id">get specific Currency data using id.</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success", Type = typeof(Currency))]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        ...
        public async Task<HttpResponseMessage> GetCurrencyById(int? id)
        {
            ...
            GenericReturn objReturn = objCurrencyServices.GetCurrencyById(id.Value);
        ...
        /// </summary>
        /// <remarks>Create / Save New Currency</remarks>
        /// <param name="Input">Input data object for Create/Save New Currency</param>
        /// <returns></returns>
        ...
        [HttpPost]
        [Route("api/currency")]
        public async Task<HttpResponseMessage> PostCurrency(Currency Input)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;
            ...
            GenericReturn objReturn = objCurrencyServices.PostCurrency(Input);
        ...
        /// </summary>
        /// <remarks>Update / Modify Currency details by id</remarks>
        /// <param name="Input">Input data object for Modify existing Currency</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success")]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        ...
        [HttpPut]
        [Route("api/currency")]
        public async Task<HttpResponseMessage> PutCurrency(Currency Input)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;
            ...
            objReturn = objCurrencyServices.PutCurrency(Input);
        ...
        /// </summary>
        /// <remarks>Modify Active/Deactive Status of Existing Currency</remarks>
        /// <param name="Input">Input data object for Modify existing Currency Active/Deactive Status</param>
        /// <returns></returns>
        [SwaggerResponse(HttpStatusCode.OK, "Status ok / Success")]
        [SwaggerResponse(HttpStatusCode.BadRequest, "Validation Error / Bad Request")]
        [SwaggerResponse(HttpStatusCode.Unauthorized, "Unauthorized / Token Expried / Invalid Token")]
        ...
        [SwaggerResponse(HttpStatusCode.InternalServerError, "Internal Server Error")]
        [HttpPut]
        [Route("api/currency/ChangeActiveStatus")]
        public async Task<HttpResponseMessage> ChangeActiveStatus(Currency Input)
        {
            var response = new HttpResponseMessage();
            DateTime startTime;
            startTime = DateTime.Now;
            ...
            GenericReturn objReturn = new GenericReturn();
            objReturn = objCurrencyServices.ChangeActiveStatus(Input);
