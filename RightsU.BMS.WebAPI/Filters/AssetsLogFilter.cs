        ...
        public override async Task OnActionExecutedAsync(HttpActionExecutedContext actionExecutedContext, CancellationToken cancellationToken)
        {
            ...
            if (actionExecutedContext.Response != null)
            {
                try
                {
                    ...
                    {
                        if (HttpContext.Current.Request.Headers["ApiName"] == "GetTitleList")
                        {
                            logObj.RequestContent = JsonConvert.SerializeObject(actionExecutedContext.ActionContext.ActionArguments);
                            logObj.IsSuccess = Convert.ToString(((RightsU.BMS.Entities.FrameworkClasses.GetReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).IsSuccess);
                            logObj.TimeTaken = Convert.ToString(((RightsU.BMS.Entities.FrameworkClasses.GetReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).TimeTaken);
                        }
                        else if (HttpContext.Current.Request.Headers["ApiName"] == "GetTitleById")
                        {
                            logObj.RequestContent = JsonConvert.SerializeObject(actionExecutedContext.ActionContext.ActionArguments);
                            logObj.IsSuccess = Convert.ToString(((RightsU.BMS.Entities.FrameworkClasses.GetTitleReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).IsSuccess);
                            logObj.TimeTaken = Convert.ToString(((RightsU.BMS.Entities.FrameworkClasses.GetTitleReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).TimeTaken);
                        }
                    ...
                    if (logData.LGCode > 0)
                    {
                        ...
                        if (logObj.Method == "GET")
                        {
                            if (HttpContext.Current.Request.Headers["ApiName"] == "GetTitleList")
                            {
                                actionExecutedContext.Response.Headers.Add("message", ((RightsU.BMS.Entities.FrameworkClasses.GetReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).Message);
                                actionExecutedContext.Response.Headers.Add("issuccess", ((RightsU.BMS.Entities.FrameworkClasses.GetReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).IsSuccess.ToString());
                            }
                            else if (HttpContext.Current.Request.Headers["ApiName"] == "GetTitleById")
                            {
                                actionExecutedContext.Response.Headers.Add("message", ((RightsU.BMS.Entities.FrameworkClasses.GetTitleReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).Message);
                                actionExecutedContext.Response.Headers.Add("issuccess", ((RightsU.BMS.Entities.FrameworkClasses.GetTitleReturn)((System.Net.Http.ObjectContent)actionExecutedContext.Response.Content).Value).IsSuccess.ToString());
                            }
                        }
                        else
                        {
