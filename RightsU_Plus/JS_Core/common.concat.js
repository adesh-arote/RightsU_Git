/*!
 * Using Bootstrap v4.1.0 (http://getbootstrap.com)
...
/*! jQuery UI - v3.0.0 - 2014-08-19
* http://jqueryui.com
* Includes: core.js, datepicker.js
* Copyright 2014 jQuery Foundation and other contributors; Licensed MIT */

(function (e) { "function" == typeof define && define.amd ? define(["jquery"], e) : e(jQuery) })(function (e) {
    function t(t, s) { var n, a, o, r = t.nodeName.toLowerCase(); return "area" === r ? (n = t.parentNode, a = n.name, t.href && a && "map" === n.nodeName.toLowerCase() ? (o = e("img[usemap='#" + a + "']")[0], !!o && i(o)) : !1) : (/input|select|textarea|button|object/.test(r) ? !t.disabled : "a" === r ? t.href || s : s) && i(t) } function i(t) { return e.expr.filters.visible(t) && !e(t).parents().addBack().filter(function () { return "hidden" === e.css(this, "visibility") }).length } function s(e) { for (var t, i; e.length && e[0] !== document;) { if (t = e.css("position"), ("absolute" === t || "relative" === t || "fixed" === t) && (i = parseInt(e.css("zIndex"), 10), !isNaN(i) && 0 !== i)) return i; e = e.parent() } return 0 } function n() { this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = { closeText: "Done", prevText: "Prev", nextText: "Next", currentText: "Today", monthNames: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthNamesShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], dayNames: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], dayNamesMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], weekHeader: "Wk", dateFormat: "dd/mm/yy", firstDay: 0, isRTL: !1, showMonthAfterYear: !1, yearSuffix: "" }, this._defaults = { showOn: "focus", showAnim: "fadeIn", showOptions: {}, defaultDate: null, appendText: "", buttonText: "...", buttonImage: "", buttonImageOnly: !1, hideIfNoPrevNext: !1, navigationAsDateFormat: !1, gotoCurrent: !1, changeMonth: true, changeYear: true, yearRange: "c-10:c+10", showOtherMonths: !1, selectOtherMonths: !1, showWeek: !1, calculateWeek: this.iso8601Week, shortYearCutoff: "+10", minDate: null, maxDate: null, duration: "fast", beforeShowDay: null, beforeShow: null, onSelect: null, onChangeMonthYear: null, onClose: null, numberOfMonths: 1, showCurrentAtPos: 0, stepMonths: 1, stepBigMonths: 12, altField: "", altFormat: "", constrainInput: !0, showButtonPanel: !1, autoSize: !1, disabled: !1 }, e.extend(this._defaults, this.regional[""]), this.regional.en = e.extend(!0, {}, this.regional[""]), this.regional["en-US"] = e.extend(!0, {}, this.regional.en), this.dpDiv = a(e("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) } function a(t) { var i = "button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a"; return t.delegate(i, "mouseout", function () { e(this).removeClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && e(this).removeClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && e(this).removeClass("ui-datepicker-next-hover") }).delegate(i, "mouseover", o) } function o() { e.datepicker._isDisabledDatepicker(h.inline ? h.dpDiv.parent()[0] : h.input[0]) || (e(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), e(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && e(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && e(this).addClass("ui-datepicker-next-hover")) } function r(t, i) { e.extend(t, i); for (var s in i) null == i[s] && (t[s] = i[s]); return t } e.ui = e.ui || {}, e.extend(e.ui, { version: "3.0.0", keyCode: { BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38 } }), e.fn.extend({ scrollParent: function (t) { var i = this.css("position"), s = "absolute" === i, n = t ? /(auto|scroll|hidden)/ : /(auto|scroll)/, a = this.parents().filter(function () { var t = e(this); return s && "static" === t.css("position") ? !1 : n.test(t.css("overflow") + t.css("overflow-y") + t.css("overflow-x")) }).eq(0); return "fixed" !== i && a.length ? a : e(this[0].ownerDocument || document) }, uniqueId: function () { var e = 0; return function () { return this.each(function () { this.id || (this.id = "ui-id-" + ++e) }) } }(), removeUniqueId: function () { return this.each(function () { /^ui-id-\d+$/.test(this.id) && e(this).removeAttr("id") }) } }), e.extend(e.expr[":"], { data: e.expr.createPseudo ? e.expr.createPseudo(function (t) { return function (i) { return !!e.data(i, t) } }) : function (t, i, s) { return !!e.data(t, s[3]) }, focusable: function (i) { return t(i, !isNaN(e.attr(i, "tabindex"))) }, tabbable: function (i) { var s = e.attr(i, "tabindex"), n = isNaN(s); return (n || s >= 0) && t(i, !n) } }), e("<a>").outerWidth(1).jquery || e.each(["Width", "Height"], function (t, i) { function s(t, i, s, a) { return e.each(n, function () { i -= parseFloat(e.css(t, "padding" + this)) || 0, s && (i -= parseFloat(e.css(t, "border" + this + "Width")) || 0), a && (i -= parseFloat(e.css(t, "margin" + this)) || 0) }), i } var n = "Width" === i ? ["Left", "Right"] : ["Top", "Bottom"], a = i.toLowerCase(), o = { innerWidth: e.fn.innerWidth, innerHeight: e.fn.innerHeight, outerWidth: e.fn.outerWidth, outerHeight: e.fn.outerHeight }; e.fn["inner" + i] = function (t) { return void 0 === t ? o["inner" + i].call(this) : this.each(function () { e(this).css(a, s(this, t) + "px") }) }, e.fn["outer" + i] = function (t, n) { return "number" != typeof t ? o["outer" + i].call(this, t) : this.each(function () { e(this).css(a, s(this, t, !0, n) + "px") }) } }), e.fn.addBack || (e.fn.addBack = function (e) { return this.add(null == e ? this.prevObject : this.prevObject.filter(e)) }), e("<a>").data("a-b", "a").removeData("a-b").data("a-b") && (e.fn.removeData = function (t) { return function (i) { return arguments.length ? t.call(this, e.camelCase(i)) : t.call(this) } }(e.fn.removeData)), e.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()), e.fn.extend({ focus: function (t) { return function (i, s) { return "number" == typeof i ? this.each(function () { var t = this; setTimeout(function () { e(t).focus(), s && s.call(t) }, i) }) : t.apply(this, arguments) } }(e.fn.focus), disableSelection: function () { var e = "onselectstart" in document.createElement("div") ? "selectstart" : "mousedown"; return function () { return this.bind(e + ".ui-disableSelection", function (e) { e.preventDefault() }) } }(), enableSelection: function () { return this.unbind(".ui-disableSelection") }, zIndex: function (t) { if (void 0 !== t) return this.css("zIndex", t); if (this.length) for (var i, s, n = e(this[0]) ; n.length && n[0] !== document;) { if (i = n.css("position"), ("absolute" === i || "relative" === i || "fixed" === i) && (s = parseInt(n.css("zIndex"), 10), !isNaN(s) && 0 !== s)) return s; n = n.parent() } return 0 } }), e.ui.plugin = { add: function (t, i, s) { var n, a = e.ui[t].prototype; for (n in s) a.plugins[n] = a.plugins[n] || [], a.plugins[n].push([i, s[n]]) }, call: function (e, t, i, s) { var n, a = e.plugins[t]; if (a && (s || e.element[0].parentNode && 11 !== e.element[0].parentNode.nodeType)) for (n = 0; a.length > n; n++) e.options[a[n][0]] && a[n][1].apply(e.element, i) } }, e.extend(e.ui, { datepicker: { version: "3.0.0" } }); var h; e.extend(n.prototype, {
    ...
    }), e.fn.datepicker = function (t) { if (!this.length) return this; e.datepicker.initialized || (e(document).mousedown(e.datepicker._checkExternalClick), e.datepicker.initialized = !0), 0 === e("#" + e.datepicker._mainDivId).length && e("body").append(e.datepicker.dpDiv); var i = Array.prototype.slice.call(arguments, 1); return "string" != typeof t || "isDisabled" !== t && "getDate" !== t && "widget" !== t ? "option" === t && 2 === arguments.length && "string" == typeof arguments[1] ? e.datepicker["_" + t + "Datepicker"].apply(e.datepicker, [this[0]].concat(i)) : this.each(function () { "string" == typeof t ? e.datepicker["_" + t + "Datepicker"].apply(e.datepicker, [this].concat(i)) : e.datepicker._attachDatepicker(this, t) }) : e.datepicker["_" + t + "Datepicker"].apply(e.datepicker, [this[0]].concat(i)) }, e.datepicker = new n, e.datepicker.initialized = !1, e.datepicker.uuid = (new Date).getTime(), e.datepicker.version = "3.0.0", e.datepicker
});
...
var panelHideCss = '-220px';
var panelShowCss = '74px';

var panelHideCssRight = '-220px'
var panelShowCssRight = '74px'
...
jQuery(document).ready(function () {
    ...
    try {
        ...
        if (LayoutDirection_G == 'RTL') {
            $('.container.main_col').on("click", function () { $('.leftPanel').css('right', panelHideCss); });
        }
        else
        $('.container.main_col').on("click", function () { $('.leftPanel').css('left', panelHideCss); });

        //$(window).on("scroll touchmove", function () {
        //    $('.header-nav').toggleClass('tiny', $(document).scrollTop() > 0);
        //    $('.leftPanel').toggleClass('tiny', $(document).scrollTop() > 0);
        //});
    }
    catch (e) {
        hideLoading();
...
function initializeleftPanel() {
    ...
    if ($(window).width() < 960 || $(window).height() < 640) {
        //panelHideCss = '-90px';
        panelShowCss = '60px';
       // panelShowCssRight = '60px';
        //$('.leftPanel').width(150);
    }
    if (LayoutDirection_G == 'RTL') {
        $('.leftPanel').css('right', '-220px');
    } else {
...
function togglePanelVisibility(panelID) {
    debugger;
    if (LayoutDirection_G == 'RTL') {
        $(".leftPanel:not(#" + panelID + ")").css("right", panelHideCssRight);
        $('.RightPanel').css('left', RightPanelHideCss);
        $('#sideNavi').show();
        var panel = document.getElementById(panelID);

        if (panel.style.right == panelShowCssRight) {
            //alert(panelHideCssRight);
            panel.style.right = panelHideCssRight;
            panelVisible = false;
        }
        else {
            panel.style.right = panelShowCssRight;
            panelVisible = true;
        }
    }
    else {
...
function initializeDatepicker() {   // jqueryui.com/datepicker
...
function initializeDateRange(startDate, endDate) {
...
function initializeChosen() {
    try {
        $('.chosen-select').on('chosen:ready', function (event, data) {
            $(data.chosen.container[0]).find('div.selectAllNone input.btnSelectAll').click(function () {
                showLoading();
                var selectBoxID = $(this).closest('.chosen-container').prev().prop('id');
                $('#' + selectBoxID + ' option').prop('selected', true);
                $('#' + selectBoxID).trigger('chosen:updated');
                hideLoading();
            });
            $(data.chosen.container[0]).find('div.selectAllNone input.btnSelectNone').click(function () {
                showLoading();
                var selectBoxID = $(this).closest('.chosen-container').prev().prop('id');
                $('#' + selectBoxID + ' option').prop('selected', false);
                $('#' + selectBoxID).trigger('chosen:updated');
                hideLoading();
            });
        }).chosen({
...
function HideAlertMessage() {
    debugger
    if ($('#divInfoMsgShowAlert').length > 0) {
        $('#divInfoMsgShowAlert').remove();
        $('#divInfoMsgShowAlert-overlay').remove();
    }
}
function showAlert(type, msg, ctrlID) {
    debugger;
    var strHtml = "", alertClass;
    var strLabel = "<label>" + msg + "</label>";
    ...
    if (typeof ctrlID != "undefined") {
        var strOK = "<a class='btn btn-primary btnOk' href='#' onclick='dismissAlert();handleOk();'>{LABEL_OK}</a>";
        var strCancel = "<a class='btn btn-primary' href='#' onclick='dismissAlert();handleCancel();'>{LABEL_CANCEL}</a>";
        var strOverlay = '<div class="modal-backdrop alert-overlay fade in"></div>';

        if (ctrlID.toUpperCase() == "OK" || ctrlID.toUpperCase() == "OKCANCEL") {
            strOK = strOK.replace("{LABEL_OK}", MsgOk);//MsgOk = Ok
            strCancel = strCancel.replace("{LABEL_CANCEL}", MsgCancel);//MsgCancel = Cancel
        }
        else if (ctrlID.toUpperCase() == "YN" || ctrlID.toUpperCase() == "YESNO")
        {
            strOK = strOK.replace("{LABEL_OK}", "Yes");
            strCancel = strCancel.replace("{LABEL_CANCEL}", "No");
        }

        if (ctrlID.toUpperCase() == "OK") {
            strHtml = "<div class='alert alert-" + alertClass + " fade in'>"
					+ strLabel + strOK + "</div>";
        ...
        else if (ctrlID.toUpperCase() == "OKCANCEL" || ctrlID.toUpperCase() == "YN" || ctrlID.toUpperCase() == "YESNO") {
            strHtml = "<div class='alert alert-" + alertClass + " fade in'>"
					+ strLabel + strCancel + strOK + "</div>";
            ...
            strHtml = "<div id='divInfoMsgShowAlert' class='alert alert-" + alertClass + " fade in'><a href='#' class='close' data-dismiss='alert' onclick='dismissAlert();'>&times;</a>"
            + strLabel + "</div> ";
            $(".main_col").append(strHtml);
    ...
    if (LayoutDirection_G == 'RTL') {
        $('#divInfoMsgShowAlert').css('text-align', 'right');
        $('.close').css('float', 'left');
    }
    else {
        $('#divInfoMsgShowAlert').css('text-align', 'left');
        $('.close').css('float', 'right');
    }
    clearInterval(myVarSetInterval);
    myVarSetInterval = setInterval(function () { HideAlertMessage(); clearInterval(myVarSetInterval); }, 5000);
}
...
function setNumericForPagingSize() {
    $("input.pagingSize").numeric({ allowMinus: false, allowThouSep: false, allowDecSep: false, max: 100, min: 1 });
}
...
function getBaseURL() {
    ...
    if (baseURL.indexOf('http://localhost') != -1) {
        ...
        var baseLocalUrl = window.location.origin;
        return baseLocalUrl + "/";
    }
    else {
...
function ReleaseRecordLock(code, url) {
    if (code != undefined && url != undefined)
        RefreshRecordReleaseTime(code, url)

    RecordLockInterval = window.clearInterval(RecordLockInterval);
}
function RefreshRecordReleaseTime(code, url) {
    $.ajax({
        type: "POST",
        url: url,
        traditional: true,
...
function Call_RefreshRecordReleaseTime(code, url) {
    RefreshRecordReleaseTime(code, url);
    RecordLockInterval = setInterval("RefreshRecordReleaseTime(" + code + ",'" + url + "')", 15000);
}
...
// Popup Month and Year dropdown in Firefox, IE11. --dp
