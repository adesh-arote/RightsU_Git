...
{
    public partial class UC_Platform_Tree : System.Web.UI.UserControl
    {
        #region ------------Properties------------
        private string _Connection_Str;
        public string Connection_Str
        {
            get { return this._Connection_Str; }
            set { this._Connection_Str = value; }
        }
        ...
        {
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "SetHiddenField", "SetHiddenField('" + TREEVIEWID + "');", true);
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertKey", "callOnPageLoad();", true);
        }
