...
{
    public partial class Title_Avail_Language : ParentPage
    {
       ...
       //     ScriptManager.RegisterStartupScript(this, this.GetType(), "toolbarCss", "Assign_Css();", true);
        ...
        {
            //return  DatabaseBroker.ProcessSelectDirectly("select parameter_value from system_parameter_new where parameter_value='EntityName'").ToString();
            //if (objloginuser.objEntity.EntityName.ToString().ToUpper() == "RIGHTSU_VMPL")
            //if (GlobalParams.entity_Type.ToString().ToUpper() == System.Configuration.ConfigurationSettings.AppSettings["RightsU_VMPL"].ToUpper())
            //if (Convert.ToString(System.Web.HttpContext.Current.Session["Entity_Type"]).ToUpper() == Convert.ToString(System.Configuration.ConfigurationSettings.AppSettings["RightsU_VMPL"]).ToUpper())
            //{
            //    return ConfigurationSettings.AppSettings["reportingserverfolder_hv"].ToString();
            //}
            //else
            //{
            //    return ConfigurationSettings.AppSettings["reportingserverfolder"].ToString();
            //}
