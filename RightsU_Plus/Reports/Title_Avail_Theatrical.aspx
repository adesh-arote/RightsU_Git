<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" UnobtrusiveValidationMode="None" CodeBehind="Title_Avail_Theatrical.aspx.cs" Inherits="RightsU_WebApp.Reports.Title_Avail_Theatrical" MasterPageFile="~/Home.Master" %>
    ...
    function CallOnLoad() {
        ...
        if ($('#<%=hdnRegionType.ClientID %>').val() == 'T') {
            ...
            if ($('#<%=ddlTerritory.ClientID %>').val() != null) {
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("~/Web_Service")%>' + '/LoadCountryRegion',// "../WebServices/getExchangeRateWebService.asmx/LoadCountry",
                    data: JSON.stringify({
        ...
        function LoadCountryBasedOnTerritory() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("~/Web_Service")%>' + '/LoadCountryRegion',
                data: JSON.stringify({
                    code: $('#<%=ddlTerritory.ClientID %>').val()
                }),
                contentType: "application/json; charset=utf-8",
                                                    ...
                                                    <table>
                                                        <tr style="height: 25px;">
                                                            <td class="pagingborder" style="text-align: center;">
                                                                <b>
                                                                    <span onclick="RegionTabSelect('T')" id="tabTerr">Country</span>
                                                                    <span id="tabCountry" onclick="RegionTabSelect('C')">Circuit&nbsp;<span id="spCountryCount"></span></span>
