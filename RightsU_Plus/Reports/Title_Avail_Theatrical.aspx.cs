...
{
    public partial class Title_Avail_Theatrical : ParentPage
    {
        ...
        protected void BindModeleName()
        {
            ...
            objTitle.IntCode = 127;
            objTitle.Fetch();
            //lblModuleName.Text = objTitle.moduleName;
            lblModuleName.Text = "Theatrical Availability";
        }
        ...
        protected void ShowResults(string isSaveQry, int intCode = 0)
        {
            ...
            strInsertVal = "'" + sbMovie.ToString() + "', '" + sbTerritory.ToString() + "','" + rblPeriodType.SelectedValue + "','" + GlobalUtil.MakedateFormat(StartDate) + "','" + GlobalUtil.MakedateFormat(EndDate) + "','"
                                      + objLoginedUser.Users_Code + "', GETDATE(), '"
                                      + chkRestRemarks.Checked.ToString() + "','" + chkOtherRemarks.Checked.ToString() + "','"
                                      + ddlExclusive.SelectedValue + "','" + sbSublicensing.ToString() + "','" + strRegion_EM + "','"
                                      + hdnMustHaveRegionCode.Value + "','" + hdnExclusionRegionCode.Value + "','"
                                      + BU_Code.ToString() + "','TH','Y','" + Digital + "'";
            ...
            if (isSaveQry == "R")
            {
                ...
                List<USP_Get_Title_Avail_Language_Data_Result> list = new List<USP_Get_Title_Avail_Language_Data_Result>();
                    //objUSP.USP_Get_Title_Avail_Language_Data("F", objLoginedUser.Users_Code, strFilter, PageNo, "", "N", 0, objRecordCount, "PR", "", "").ToList();
                if (list.Count > 0)
                {
                    ...
                    if (list[0].Country_Code.Contains("T"))
            ...
            if (hdnIsCriteriaChange.Value == "Y")
            {
                ...
                parm[1] = new ReportParameter("Country_Code", sbTerritory.ToString());
                parm[2] = new ReportParameter("Title_Language_Code", sbTitleLanguage.ToString());
                parm[3] = new ReportParameter("Date_Type", rblPeriodType.SelectedValue);
                ...
                parm[6] = new ReportParameter("RestrictionRemarks", strRestRemarks);
                parm[7] = new ReportParameter("OthersRemarks", chkOtherRemarks.Checked.ToString());
                ...
                parm[12] = new ReportParameter("Region_Exclusion", hdnExclusionRegionCode.Value);
                parm[13] = new ReportParameter("BU_Code", BU_Code.ToString());
                parm[14] = new ReportParameter("Is_Digital", Digital1);
                parm[15] = new ReportParameter("Include_Metadata", Metadata);
                ...
                if (ReportViewer1.ServerReport.ReportPath == "")
                {
                    ...
                    //ReportViewer1.ServerReport.ReportPath = objRS.GetReport("Title_Availability_Languagewise_3");
                    ReportViewer1.ServerReport.ReportPath = objRS.GetReport("Theatrical_Availability");
                }
        ...
        public void BindTerritoryList()
        {
            ...
            Country_Service territoryServiceInstance = new Country_Service(ObjLoginEntity.ConnectionStringName);
            ddlTerritory.DataSource = territoryServiceInstance.SearchFor(c => c.Is_Domestic_Territory == "Y").Select(c => new ListItem { Text = c.Country_Name, Value = "T" + c.Country_Code }).ToList();
            ...
            //Country_Service countryServiceInstance = new Country_Service();
            ...
            var countryList = countryServiceInstance.SearchFor(c => c.Is_Theatrical_Territory == "Y").Select(c => new ListItem { Text = c.Country_Name, Value = c.Country_Code.ToString() }).OrderBy(l => l.Text).ToList();
        ...
        private void BindGridView(bool showNorecAlert = true)
        {
            ...
            strFilter = "AND ((Visibility='PR' AND User_Code = " + objLoginedUser.Users_Code +
                    ...
                    + "))) or Visibility='PU') AND ISNULL(ReportName, '') <> '' AND Report_Status <> 'X' AND BU_CODE =" + ddlBusinessUnit.SelectedValue + " AND Report_Type = 'TH'";
        ...
        protected void btnSaveQuery_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    ObjectParameter objRecordCount = new ObjectParameter("RecordCount", 10);
                   // objUSP.USP_Get_Title_Avail_Language_Data("C", objLoginedUser.Users_Code, hdnstrCriteria.Value, 0, "", "", 0, objRecordCount, "", txtReportName.Text, "");
