    ...
    public partial class Show_Availability_Report : ParentPage
    {
        ...
        protected void ShowResults(string isSaveQry, int intCode = 0)
        {
            ...
            if (hdnIsCriteriaChange.Value == "Y")
            {
                ...
                parm[26] = new ReportParameter("Subtitling_Group_Code", "");
                parm[27] = new ReportParameter("Subtitling_ExactMatch", "");
                parm[28] = new ReportParameter("Subtitling_MustHave", "");
                parm[29] = new ReportParameter("Subtitling_Exclusion", "");
                parm[30] = new ReportParameter("Dubbing_Group_Code", "");
                parm[31] = new ReportParameter("Dubbing_ExactMatch", "");
                parm[32] = new ReportParameter("Dubbing_MustHave", "");
                parm[33] = new ReportParameter("Dubbing_Exclusion", "");
                parm[34] = new ReportParameter("Territory_Code", "");
