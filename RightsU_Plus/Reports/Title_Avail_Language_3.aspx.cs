    ...
    public partial class Title_Avail_Language_3 : ParentPage
    {
        ...
        protected void ShowResults(string isSaveQry, int intCode = 0)
        {
            ...
            if (hdnIsCriteriaChange.Value == "Y")
            {
                ...
                parm[28] = new ReportParameter("Subtitling_Group_Code", "");
                parm[29] = new ReportParameter("Subtitling_ExactMatch", "");
                parm[30] = new ReportParameter("Subtitling_MustHave", "");
                parm[31] = new ReportParameter("Subtitling_Exclusion", "");
                parm[32] = new ReportParameter("Dubbing_Group_Code", "");
                parm[33] = new ReportParameter("Dubbing_ExactMatch", "");
                parm[34] = new ReportParameter("Dubbing_MustHave", "");
                parm[35] = new ReportParameter("Dubbing_Exclusion", "");
                parm[36] = new ReportParameter("Territory_Code", "");
