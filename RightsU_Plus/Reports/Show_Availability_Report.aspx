<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Show_Availability_Report.aspx.cs"
    Inherits="RightsU_Plus.Reports.Show_Availability_Report" MasterPageFile="~/Home.Master" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CphdBody" runat="Server">
    ...
    function Validate() {
        ...
        if ($('#<%=txtETo.ClientID %>').val() != '' && $('#<%=txtEFrom.ClientID %>').val() != '' && $('#<%=txtETo.ClientID %>').val() != '0' && $('#<%=txtEFrom.ClientID %>').val() != '0') {
            $('#<%=txtETo.ClientID %>').removeClass('required');
            var vf = parseInt($('#<%=txtEFrom.ClientID %>').val());
            var vt = parseInt($('#<%=txtETo.ClientID %>').val());
            if (vt < vf) {
                AlertModalPopup($('#<%=txtETo.ClientID %>'), 'Episode To should be Greater than Episode From');
                return false;
            }
        }
    ...
    function PlatformTabSelect(selectedTab) {
        ...
        function LoadCountryBasedOnTerritory() {
            //debugger;
            $.ajax({
                type: "POST",
        ...
        var strtxtReportName = $('#<%=txtReportName.ClientID %>');
            ...
            if ($('#<%=hdnIsSaveQuery.ClientID %>').val() == "Y") {
                ...
                if ($('#<%=hdnDupQueryName.ClientID %>').val() == "Y") {
                    ...
                    $("#<%=txtEFrom.ClientID%>").val($("#<%=hdnEpisodeFrom.ClientID%>").val());
                    $("#<%=txtETo.ClientID%>").val($("#<%=hdnEpisodeTo.ClientID%>").val());
    ...
    <div class="top_area">
        <h2 class="pull-left">
            <asp:Label ID="lblModuleName" runat="server"></asp:Label></h2>
                                ...
                                <div class="navigation_tabs">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs nav-tab pull-left">
                                            ...
                                            <li class="" runat="server" id="liImgCriteria">
                                                            ...
                                                            <td style="text-align: center; width: 33%;">
                                                                <asp:UpdatePanel runat="server" ID="upTitle" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:HiddenField runat="server" ID="hdnTitleCode_SQ" />
                                                                        <asp:HiddenField runat="server" ID="hdnTL_SQ" />
                                                                        <asp:HiddenField runat="server" ID="hdnSL_SQ" />
                                                                        <asp:HiddenField runat="server" ID="hdnSubTit_SQ" />
                                                                        <asp:HiddenField runat="server" ID="hdnDubb_SQ" />
                                                                        <asp:HiddenField runat="server" ID="hdnIsSaveQuery" />
                                                                        <asp:HiddenField runat="server" ID="hdnStartDate" />
                                                                        <asp:HiddenField runat="server" ID="hdnEndDate" />
                                                                        <asp:HiddenField runat="server" ID="hdnDupQueryName" />
                                                                        <asp:HiddenField runat="server" ID="hdnstrCriteria" />
                                                                        <asp:HiddenField runat="server" ID="hdnEpisodeFrom" />
                                                                        <asp:HiddenField runat="server" ID="hdnEpisodeTo" />
                                                                        ...
                                                                        <br />
                                                                        Episode From
                                                                        <asp:TextBox ID="txtEFrom" runat="server" CssClass="text" Width="39px" onkeypress="return isNumber(event);" MaxLength="4"></asp:TextBox>
                                                                        To
                                                                           <asp:TextBox ID="txtETo" runat="server" CssClass="text" Width="39px" onkeypress="return isNumber(event);" MaxLength="4"></asp:TextBox>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                        ...
                                                        <table width="100%" cellpadding="3" cellspacing="0" align="left" border="0" class="paging">
                                                            <tr>
                                                                ...
                                                                <td class='white' width="15%">
                                                                    <asp:TextBox ID='txtReportName' runat="server" CssClass="text"
                                                                ...
                                                                <td class="normal" align="right">
                                                                    ...
                                                                    <asp:Button Text="Save Query" runat="server" ID="btnSaveQuery" CssClass="btn btn-primary"
                                                                        OnClientClick="return validateReportType();" OnClick="btnSaveQuery_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                    ...
                    <ContentTemplate>
                        <div class='popup' id="TitlePopup" style="display: none;">
                            <div class='content'>
                                ...
                                <div>
                                    <asp:TextBox ID="txtSearch" runat="server" Width="340px" AutoComplete="off" MaxLength="100" placeholder="Search by Title,Talent,Star Cast,Genre,Director"></asp:TextBox>
