                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (Term == YearBased) {
                            ...
                            var EndDate = CalculateEndDate(rightSD, year, month, 0);
                ...
                if (TabType == "BO") {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $('#ddlPromoter_0,#ddlRemarks_0').SumoSelect();
                            $('#ddlPromoter_0')[0].sumo.reload();
...
function OnFocusLostDate() {
    ...
    if (txtRightStartDate.val() == "" && txtTermYear.val() == "0" && txtTermMonth.val() == "0")
        isRet = true;

    if (txtRightEndDate.val() == "" && txtTermYear.val() == "0" && txtTermMonth.val() == "0")
        isRet = true;
