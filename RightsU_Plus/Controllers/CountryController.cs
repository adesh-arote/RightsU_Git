...
namespace RightsU_Plus.Controllers
{
    public class CountryController : BaseController
    {
        ...
        public JsonResult SaveCountry(FormCollection objCollection)
        {
            ...
            IEqualityComparer<Country_Language> comparerChannel = new RightsU_Dapper.BLL.LambdaComparer<Country_Language>((x, y) => x.Language_Code == y.Language_Code);// && x.EntityState != State.Deleted);
