...
//        private List<RightsU_Dapper.Entity.USP_List_Country_Result> lstCountry
//        {
//            get
//            {
//                if (Session["lstCountry"] == null)
//                    Session["lstCountry"] = new List<RightsU_Dapper.Entity.USP_List_Country_Result>();
//                return (List<RightsU_Dapper.Entity.USP_List_Country_Result>)Session["lstCountry"];
//            }
//            set { Session["lstCountry"] = value; }
//        }
//        private List<RightsU_Dapper.Entity.USP_List_Country_Result> lstCountry_Searched
//        {
//            get
//            {
//                if (Session["lstCountry_Searched"] == null)
//                    Session["lstCountry_Searched"] = new List<RightsU_Dapper.Entity.USP_List_Country_Result>();
//                return (List<RightsU_Dapper.Entity.USP_List_Country_Result>)Session["lstCountry_Searched"];
//            }
//            set { Session["lstCountry_Searched"] = value; }
//        }
//        private RightsU_Dapper.Entity.Country objCountry
//        {
//            get
//            {
//                if (Session["objCountry"] == null)
//                    Session["objCountry"] = new RightsU_Dapper.Entity.Country();
//                return (RightsU_Dapper.Entity.Country)Session["objCountry"];
//            }
...
//                    Session["objCountry_Service"] = new Country_Service();
...
//        {
//            List<RightsU_Dapper.Entity.USP_List_Country_Result> lst = new List<RightsU_Dapper.Entity.USP_List_Country_Result>();
//            int RecordCount = 0;
...
//            lstlanguage = (List<RightsU_Dapper.Entity.Language>)objLanguageService.GetList();
...
//        {
//            string lstRights = objProcedureService.USP_MODULE_RIGHTS(Convert.ToInt32(GlobalParams.ModuleCodeForCountry), objLoginUser.Security_Group_Code, objLoginUser.Users_Code);
//            string rights = "";
//            if (lstRights != null)
//                rights = lstRights;
...
//            List<RightsU_Dapper.Entity.Language> lstLanguage = objLanguageService.SearchFor(w => w.Is_Active == "Y").OrderBy(o => o.Language_Name).ToList();
...
//            List<RightsU_Dapper.Entity.Country> lstBaseCountry = objCountryService.GetList().SearchFor(w => w.Is_Active == "Y" && w.Is_Domestic_Territory == "Y").OrderBy(o => o.Country_Name).ToList();
...
//           objCountry.Base_Country_Count = objCountryService.GetList().SearchFor(s => s.Is_Domestic_Territory == "Y").Count();
