...
namespace RightsU_Plus.Controllers
{
    ...
    public class DemoSetupController : BaseController
    {
        ...
        RightsU_Dapper.Entity.Master_Entities.Business_Unit objBusinessUnit = new RightsU_Dapper.Entity.Master_Entities.Business_Unit();
        ...
        public JsonResult Save(string searchBy, string businessName, string entityName)
        {
            ...
            //Entity_Service objEntityService = new Entity_Service(objLoginEntity.ConnectionStringName);
               ...
               // Users_Business_Unit_Service objUsersBusinessUnitService = new Users_Business_Unit_Service(objLoginEntity.ConnectionStringName);
                ...
                RightsU_Dapper.Entity.Master_Entities.Entity objEntity = objEntity_Service.GetByID(1);
              ...
              if (objBusiness_Unit_Service.GetAll().Where(x => x.Business_Unit_Name==businessName).Any())
                ...
                else
                {
                   ...
                   // objBusinessUnit.EntityState = State.Added;
                    ...
                    RightsU_Dapper.Entity.Master_Entities.Users_Business_Unit objUsersBusinessUnit = new RightsU_Dapper.Entity.Master_Entities.Users_Business_Unit();
                    RightsU_Dapper.Entity.Master_Entities.User objUser = objUser_Service.GetAll().Where(x => x.Login_Name == "Admin").Single();
