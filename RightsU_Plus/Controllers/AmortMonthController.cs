...
namespace RightsU_Plus.Controllers
{
    ...
    public class AmortMonthController : BaseController
    {
        ...
        public ActionResult AddAmort()
        {
            return View("~/Views/AmortMonth/AmortDetails.cshtml");
        }
        public PartialViewResult BindAmortMonthList(int pageNo, int recordPerPage)
        {
            ...
            return PartialView("~/Views/AmortMonth/_AmortMonthList.cshtml", lst);
        }
