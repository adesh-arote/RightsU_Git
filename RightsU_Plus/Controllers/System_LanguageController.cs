...
namespace RightsU_Plus.Controllers
{
    public class System_LanguageController : BaseController
    {
        ...
        #region Properties
        private List<RightsU_Dapper.Entity.Master_Entities.System_Language> lstSystem_Language
        {
            get
            {
                if (Session["lstSystem_Language"] == null)
                    Session["lstSystem_Language"] = new List<RightsU_Dapper.Entity.Master_Entities.System_Language>();
                return (List<RightsU_Dapper.Entity.Master_Entities.System_Language>)Session["lstSystem_Language"];
            }
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.System_Language> lst = new List<RightsU_Dapper.Entity.Master_Entities.System_Language>();
        ...
        public JsonResult SaveSystemLanguage(int SystemLanguageCode, string SystemLanguageName, string Direction, int Record_Code)
        {
            ...
            //System_Language_Service objService = new System_Language_Service(objLoginEntity.ConnectionStringName);
            RightsU_Dapper.Entity.Master_Entities.System_Language objSystemLanguage = null;

            objSystemLanguage = new RightsU_Dapper.Entity.Master_Entities.System_Language();
