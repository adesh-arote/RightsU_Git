...
namespace RightsU_Plus.Controllers
{
    public class AssignWorkflowController : BaseController
    {
        ...
        #region --- Properties ---
        private List<RightsU_Dapper.Entity.Master_Entities.Workflow> lstWorkflow
        {
            get
            {
                if (Session["lstWorkflow"] == null)
                    Session["lstWorkflow"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow>)Session["lstWorkflow"];
            }
            set { Session["lstWorkflow"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Workflow> lstWorkflow_Searched
        {
            get
            {
                if (Session["lstWorkflow_Searched"] == null)
                    Session["lstWorkflow_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow>)Session["lstWorkflow_Searched"];
            }
            set { Session["lstWorkflow_Searched"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.Business_Unit> lstBusiness_Unit
        {
            get
            {
                if (Session["lstBusiness_Unit"] == null)
                    Session["lstBusiness_Unit"] = new List<RightsU_Dapper.Entity.Master_Entities.Business_Unit>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Business_Unit>)Session["lstBusiness_Unit"];
            }
            set { Session["lstBusiness_Unit"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Business_Unit> lstBusiness_Unit_Searched
        {
            get
            {
                if (Session["lstBusiness_Unit_Searched"] == null)
                    Session["lstBusiness_Unit_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Business_Unit>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Business_Unit>)Session["lstBusiness_Unit_Searched"];
            }
            set { Session["lstBusiness_Unit_Searched"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role> lstWorkflow_Role
        {
            get
            {
                if (Session["lstWorkflow_Role"] == null)
                    Session["lstWorkflow_Role"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>)Session["lstWorkflow_Role"];
            }
            set { Session["lstWorkflow_Role"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role> lstWorkflow_Role_Searched
        {
            get
            {
                if (Session["lstWorkflow_Role_Searched"] == null)
                    Session["lstWorkflow_Role_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>)Session["lstWorkflow_Role_Searched"];
            }
        ...
        private List<RightsU_Dapper.Entity.System_Setting_Entities.System_Module> lstSystem_Module
        {
            get
            {
                if (Session["lstSystem_Module"] == null)
                    Session["lstSystem_Module"] = new List<RightsU_Dapper.Entity.System_Setting_Entities.System_Module>();
                return (List<RightsU_Dapper.Entity.System_Setting_Entities.System_Module>)Session["lstSystem_Module"];
            }
            set { Session["lstSystem_Module"] = value; }
        }
        private List<RightsU_Dapper.Entity.System_Setting_Entities.System_Module> lstSystem_Module_Searched
        {
            get
            {
                if (Session["lstSystem_Module_Searched"] == null)
                    Session["lstSystem_Module_Searched"] = new List<RightsU_Dapper.Entity.System_Setting_Entities.System_Module>();
                return (List<RightsU_Dapper.Entity.System_Setting_Entities.System_Module>)Session["lstSystem_Module_Searched"];
            }
        ...
        private List<RightsU_Dapper.Entity.Master_Entities.User> lstUser_Searched
        {
            get
            {
                if (Session["lstlstUser_Searched"] == null)
                    Session["lstlstUser_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.User>();
                return (List<RightsU_Dapper.Entity.Master_Entities.User>)Session["lstlstUser_Searched"];
            }
            set { Session["lstlstUser_Searched"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module> lstWorkflow_Module
        {
            get
            {
                if (Session["lstWorkflow_Module"] == null)
                    Session["lstWorkflow_Module"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module>)Session["lstWorkflow_Module"];
            }
            set { Session["lstWorkflow_Module"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module> lstWorkflow_Module_Searched
        {
            get
            {
                if (Session["lstWorkflow_Module_Searched"] == null)
                    Session["lstWorkflow_Module_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module>)Session["lstWorkflow_Module_Searched"];
            }
            set { Session["lstWorkflow_Module_Searched"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role> lstWorkflow_Module_Role
        {
            get
            {
                if (Session["lstWorkflow_Module_Role"] == null)
                    Session["lstWorkflow_Module_Role"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role>)Session["lstWorkflow_Module_Role"];
            }
            set { Session["lstWorkflow_Module_Role"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role> lstWorkflow_Module_Role_Searched
        {
            get
            {
                if (Session["lstWorkflow_Module_Role_Searched"] == null)
                    Session["lstWorkflow_Module_Role_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role>)Session["lstWorkflow_Module_Role_Searched"];
            }
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module> lst = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module>();
            int RecordCount = 0;
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role> lst = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>();
            int RecordCount = 0;
        ...
        public PartialViewResult BindPartialPages(string key, int WorkflowModuleCode)
        {
            ...
            else if (key == "VIEW")
            {
                ...
                if (WorkflowModuleCode > 0)
                {
                   ...
                   // Workflow_Module_Service objService = new Workflow_Module_Service(objLoginEntity.ConnectionStringName);
                    RightsU_Dapper.Entity.Master_Entities.Workflow_Module objWorkflow = objWorkflowModuleService.GetByID(WorkflowModuleCode);
            ...
            else if (key == "VIEWHistory")
            {
                ...
                if (WorkflowModuleCode > 0)
                {
                    ...
                    List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module> lstWorkflow_Module = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Module>();
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.Workflow> lst_New_WorkFlow = new List<RightsU_Dapper.Entity.Master_Entities.Workflow>();
            //Workflow_Module_Service objWorkflowService = new Workflow_Module_Service(objLoginEntity.ConnectionStringName);
            RightsU_Dapper.Entity.Master_Entities.Workflow_Module objWorkflowModule = new RightsU_Dapper.Entity.Master_Entities.Workflow_Module();
        ...
        public JsonResult SaveWorkflowModule(FormCollection objFormCollection)
        {
           ...
           // Workflow_Module_Service objWorkflowService = new Workflow_Module_Service(objLoginEntity.ConnectionStringName);
            ...
            if (WorkflowModuleCode > 0)
            {
                ...
                RightsU_Dapper.Entity.Master_Entities.Workflow_Module objWM_Update = new RightsU_Dapper.Entity.Master_Entities.Workflow_Module();
                ...
                List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role> temp_lstWorkflow_Role = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>();
                ...
                if (temp_lstWorkflow_Role.Count > 0)
                {
                    ...
                    {
                        RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role obj_WMR = new RightsU_Dapper.Entity.Master_Entities.Workflow_Module_Role();
