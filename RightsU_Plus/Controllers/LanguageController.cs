...
namespace RightsU_Plus.Controllers
{
    public class LanguageController : BaseController
    {
        ...
        private List<RightsU_Dapper.Entity.Master_Entities.Language> lstLanguage
        {
            get
            {
                if (Session["lstLanguage"] == null)
                    Session["lstLanguage"] = new List<RightsU_Dapper.Entity.Master_Entities.Language>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Language>)Session["lstLanguage"];
            }
            set { Session["lstLanguage"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.Language> lstLanguage_Searched
        {
            get
            {
                if (Session["lstLanguage_Searched"] == null)
                    Session["lstLanguage_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Language>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Language>)Session["lstLanguage_Searched"];
            }
        ...
        public PartialViewResult BindLanguageList(int pageNo, int recordPerPage, int Language_Code, string commandName, string sortType)
        {
            ...
            List<RightsU_Dapper.Entity.Master_Entities.Language> lst = new List<RightsU_Dapper.Entity.Master_Entities.Language>();
            int RecordCount = 0;
        ...
        public JsonResult EditLanguage(int Language_Code)
        {
            ...
            RightsU_Dapper.Entity.Master_Entities.Language objTalent = objLanguageService.GetByID(Language_Code);
        ...
        public JsonResult ActiveDeactiveLanguage(int Language_Code, string doActive)
        {
            ...
            {
                //Language_Service objService = new Language_Service(objLoginEntity.ConnectionStringName);
                RightsU_Dapper.Entity.Master_Entities.Language objLanguage = objLanguageService.GetByID(Language_Code);
        ...
        public JsonResult SaveLanguage(int Language_Code, string Language_Name, int Record_Code)
        {
            string status = "S", message = "Record {ACTION} successfully";
            // Language_Service objService = new Language_Service(objLoginEntity.ConnectionStringName);
            RightsU_Dapper.Entity.Master_Entities.Language objGenre = null;
            ...
            {
                objGenre = new RightsU_Dapper.Entity.Master_Entities.Language();
