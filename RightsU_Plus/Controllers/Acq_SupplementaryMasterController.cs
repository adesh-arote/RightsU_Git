...
namespace RightsU_Plus.Controllers
{
    public class Acq_SupplementaryMasterController : BaseController
    {
        ...
        public JsonResult SearchConfig(string searchText, string TabValue)
        {
            ...
            {
                FetchDataConfig();
                lstSupplementaryConfig_Searched = lstSupplementaryConfig_Searched.Where(w => w.Supplementary_Tab.Supplementary_Tab_Description.Contains(searchText.ToUpper())).ToList();
