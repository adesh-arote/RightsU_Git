...
namespace RightsU_Plus.Controllers
{
    public class SAP_WBSController : BaseController
    {
        ...
        #region --Properties--
        private List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS> lstSAP_WBS
        {
            get
            {
                if (Session["lstSAP_WBS"] == null)
                    Session["lstSAP_WBS"] = new List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS>();
                return (List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS>)Session["lstSAP_WBS"];
            }
            set { Session["lstSAP_WBS"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS> lstSAP_WBS_Searched
        {
            get
            {
                if (Session["lstSAP_WBS_Searched"] == null)
                    Session["lstSAP_WBS_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS>();
                return (List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS>)Session["lstSAP_WBS_Searched"];
            }
        ...
        public PartialViewResult BindSAP_WBSList(int pageNo, int recordPerPage, int sapWbsCode, string SortType = "")
        {
            ...
            List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS> lst = new List<RightsU_Dapper.Entity.Master_Entities.SAP_WBS>();
            int RecordCount = 0;
