...
namespace RightsU_Plus.Controllers
{
    public class BVExceptionController : BaseController
    {
        ...
        #region --- Properties ---
        private List<RightsU_Dapper.Entity.Master_Entities.BVException> lstBVException
        {
            get
            {
                if (Session["lstBVException"] == null)
                    Session["lstBVException"] = new List<RightsU_Dapper.Entity.Master_Entities.BVException>();
                return (List<RightsU_Dapper.Entity.Master_Entities.BVException>)Session["lstBVException"];
            }
            set { Session["lstBVException"] = value; }
        }

        private List<RightsU_Dapper.Entity.Master_Entities.BVException> lstBVException_Searched
        {
            get
            {
                if (Session["lstBVException_Searched"] == null)
                    Session["lstBVException_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.BVException>();
                return (List<RightsU_Dapper.Entity.Master_Entities.BVException>)Session["lstBVException_Searched"];
            }
            set { Session["lstBVException_Searched"] = value; }
        }

        private RightsU_Dapper.Entity.Master_Entities.BVException objBVException
        {
            get
            {
                if (Session["objBVException"] == null)
                    Session["objBVException"] = new RightsU_Dapper.Entity.Master_Entities.BVException();
                return (RightsU_Dapper.Entity.Master_Entities.BVException)Session["objBVException"];
            }
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.BVException> lst = new List<RightsU_Dapper.Entity.Master_Entities.BVException>();
            int RecordCount = 0;
        ...
        public JsonResult SearchBVException(string searchText)
        {
            ...
            {
                List<int?> lstChannelCode = objChannelService.GetAll().Where(x => x.Channel_Name.ToUpper().Contains(searchText.ToUpper())).Select(y => y.Channel_Code).ToList();
        ...
        public JsonResult DeleteBVException(int exceptionCode)
        {
            ...
            if (isLocked)
            {
                ...
                RightsU_Dapper.Entity.Master_Entities.BVException objBVException = objBVExceptionService.GetByID(exceptionCode,RelationList);
        ...
        public PartialViewResult AddEditBVException(int exceptionCode)
        {
            ...
            RightsU_Dapper.Entity.Master_Entities.BVException objBVException = null;
            if (exceptionCode > 0)
                objBVException = objBVExceptionService.GetByID(exceptionCode, RelationList);
            else
                objBVException = new RightsU_Dapper.Entity.Master_Entities.BVException();
            lstBVException = objBVExceptionService.GetAll(RelationList).ToList();

            List<RightsU_Dapper.Entity.Master_Entities.Channel> lstChaneels = objChannelService.GetAll().Where(w => w.Is_Active == "Y").OrderBy(o => o.Channel_Name).ToList();
            ...
            List<RightsU_Dapper.Entity.Master_Entities.User> lstUsers = objUserService.GetAll().Where(w => w.Is_Active == "Y").OrderBy(o => o.First_Name).ToList();
        ...
        [HttpPost]
        public ActionResult saveBVException(RightsU_Dapper.Entity.Master_Entities.BVException objBVException_MVC, FormCollection objFormCollection)
        {
            RightsU_Dapper.Entity.Master_Entities.BVException objB = new RightsU_Dapper.Entity.Master_Entities.BVException();
