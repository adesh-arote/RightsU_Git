...
namespace RightsU_Plus.Controllers
{
    public class Additional_ExpenseController : BaseController
    {
        ...
        #region --Properties--
        private List<RightsU_Dapper.Entity.Additional_Expense> lstAdditional_Expense
        {
            get
            {
                if (Session["lstAdditional_Expense"] == null)
                    Session["lstAdditional_Expense"] = new List<RightsU_Dapper.Entity.Additional_Expense>();
                return (List<RightsU_Dapper.Entity.Additional_Expense>)Session["lstAdditional_Expense"];
            }
            set { Session["lstAdditional_Expense"] = value; }
        }
        private List<RightsU_Dapper.Entity.Additional_Expense> lstAdditional_Expense_Searched
        {
            get
            {
                if (Session["lstAdditional_Expense_Searched"] == null)
                    Session["lstAdditional_Expense_Searched"] = new List<RightsU_Dapper.Entity.Additional_Expense>();
                return (List<RightsU_Dapper.Entity.Additional_Expense>)Session["lstAdditional_Expense_Searched"];
            }
        ...
        public PartialViewResult BindAdditional_ExpenseList(int pageNo, int recordPerPage, int additionalExpenseCode, string commandName, string sortType)
        {
            ...
            List<RightsU_Dapper.Entity.Additional_Expense> lst = new List<RightsU_Dapper.Entity.Additional_Expense>();
            int RecordCount = 0;
        ...
        public JsonResult ActiveDeactiveAdditional_Expense(int additionalExpenseCode, string doActive)
        {
            ...
            if (isLocked)
            {
                ...
                RightsU_Dapper.Entity.Additional_Expense objAdditionalExpense = objAdditionalExpenseService.GetByID(additionalExpenseCode);
        ...
        public JsonResult SaveAdditional_Expense(int additionalExpenseCode, string additionalExpenseName, string sapGLGroupCode, int Record_Code)
        {
            ...
            //Additional_Expense_Service objService = new Additional_Expense_Service(objLoginEntity.ConnectionStringName);
            RightsU_Dapper.Entity.Additional_Expense objAdditionalExpense = null;
            ...
            {
                objAdditionalExpense = new RightsU_Dapper.Entity.Additional_Expense();
