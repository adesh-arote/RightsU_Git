...
//{
//    public class ObjectionTypeController : BaseController
//    {
//        #region --Properties--
...
//            lstGenre_Searched = lstGenre = new Objection_Type_Service(objLoginEntity.ConnectionStringName).SearchFor(x => true).ToList();
...
//        {
//            Genre_Service objService = new Objection_Type_Service(objLoginEntity.ConnectionStringName);
...
//            RightsU_Entities.Objection_Type objObjectionGenre = null;
...
//            else
//            {
//                objObjectionGenre = new RightsU_Entities.Objection_Type();
//                objObjectionGenre.EntityState = State.Added;
...
//            objObjectionGenre.Is_Active = "Y";
//            objObjectionGenre.Objection_Type_Name = ObjectionTypeName;
//            dynamic resultSet;
//            bool isValid = objService.Save(objObjectionGenre, out resultSet);
