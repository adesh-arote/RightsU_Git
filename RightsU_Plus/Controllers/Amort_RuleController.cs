...
namespace RightsU_Plus.Controllers
{
    public class Amort_RuleController : BaseController
    {
        ...
        public RightsU_Dapper.Entity.Master_Entities.Amort_Rule objAmortRule
        {
            get
            {
                if (Session["Session_Amort_Rule"] == null)
                    Session["Session_Amort_Rule"] = new RightsU_Dapper.Entity.Master_Entities.Amort_Rule();
                return (RightsU_Dapper.Entity.Master_Entities.Amort_Rule)Session["Session_Amort_Rule"];
            }
