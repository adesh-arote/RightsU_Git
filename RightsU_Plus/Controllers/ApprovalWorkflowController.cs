...
namespace RightsU_Plus.Controllers
{
    public class ApprovalWorkflowController : BaseController
    {
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.Workflow> lst = new List<RightsU_Dapper.Entity.Master_Entities.Workflow>();
            int RecordCount = 0;
        ...
        public PartialViewResult BindPartialPages(string key, int WorkflowCode)
        {
            ...
            else if (key == "VIEW")
            {
                ...
                if (WorkflowCode > 0)
                {
                    ...
                    RightsU_Dapper.Entity.Master_Entities.Workflow objWorkflow = objWorkflowService.GetByID(WorkflowCode);
        ...
        public JsonResult SaveWorkflow(RightsU_Dapper.Entity.Master_Entities.Workflow objUser_MVC, FormCollection objFormCollection)
        {
           // Workflow_Service objWorkflowService = new Workflow_Service(objLoginEntity.ConnectionStringName);
            RightsU_Dapper.Entity.Master_Entities.Workflow objWorkflow = new RightsU_Dapper.Entity.Master_Entities.Workflow();
            ...
            if (WorkflowCode > 0)
            {
                ...
                {
                    foreach (RightsU_Dapper.Entity.Master_Entities.Workflow_Role item in temp_lstWorkflow_Role)
                    {
                        item.Workflow_Code = WorkflowCode;
                        objWorkflow.Workflow_Role.Add(item);
                    }
                }
                List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role> tempVendorContact = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>();
                ...
                List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role> Modified_VC = new List<RightsU_Dapper.Entity.Master_Entities.Workflow_Role>();
                ...
                {
                    int Counter = 0;
                    foreach (RightsU_Dapper.Entity.Master_Entities.Workflow_Role item in objWorkflow.Workflow_Role)
                    {
                        Counter = Counter + 1;
        ...
        public JsonResult SaveWorkflowSG(FormCollection objFormCollection)
        {
            ...
            RightsU_Dapper.Entity.Master_Entities.Workflow_Role objWorkflow_Role = new RightsU_Dapper.Entity.Master_Entities.Workflow_Role();
        ...
        public JsonResult UpdateWorkflowSG(FormCollection objFormCollection)
        {
            ...
            RightsU_Dapper.Entity.Master_Entities.Workflow_Role objWorkflow_Role = lstWorkflow_Role_Searched.Where(x => x._Dummy_Guid == str_DummyGuid).SingleOrDefault();
        ...
        {
            string status = "S", message = "Record {ACTION} successfully";
            RightsU_Dapper.Entity.Master_Entities.Workflow_Role objWorkflow_Role = lstWorkflow_Role_Searched.Where(x => x._Dummy_Guid == dummyGuid).SingleOrDefault();
