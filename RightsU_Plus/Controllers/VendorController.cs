...
namespace RightsU_Plus.Controllers
{
    public class VendorController : BaseController
    {
        ...
        #region --- Properties ---
        private List<RightsU_Dapper.Entity.Master_Entities.Vendor> lstVendor
        {
            get
            {
                if (Session["lstVendor"] == null)
                    Session["lstVendor"] = new List<RightsU_Dapper.Entity.Master_Entities.Vendor>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Vendor>)Session["lstVendor"];
            }
            set { Session["lstVendor"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Vendor> lstVendor_Searched
        {
            get
            {
                if (Session["lstVendor_Searched"] == null)
                    Session["lstVendor_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Vendor>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Vendor>)Session["lstVendor_Searched"];
            }
            set { Session["lstVendor_Searched"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts> lstVendorContact
        {
            get
            {
                if (Session["lstVendorContact"] == null)
                    Session["lstVendorContact"] = new List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>)Session["lstVendorContact"];
            }
            set { Session["lstVendorContact"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts> lstVendorContact_Searched
        {
            get
            {
                if (Session["lstVendorContact_Searched"] == null)
                    Session["lstVendorContact_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>)Session["lstVendorContact_Searched"];
            }
            set { Session["lstVendorContact_Searched"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Country> lstCountry
        {
            get
            {
                if (Session["lstCountry"] == null)
                    Session["lstCountry"] = new List<RightsU_Dapper.Entity.Master_Entities.Country>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Country>)Session["lstCountry"];
            }
            set { Session["lstCountry"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Country> lstCountry_Searched
        {
            get
            {
                if (Session["lstCountry_Searched"] == null)
                    Session["lstCountry_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Country>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Country>)Session["lstCountry_Searched"];
            }
            set { Session["lstCountry_Searched"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Role> lstRole
        {
            get
            {
                if (Session["lstRole"] == null)
                    Session["lstRole"] = new List<RightsU_Dapper.Entity.Master_Entities.Role>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Role>)Session["lstRole"];
            }
            set { Session["lstRole"] = value; }
        }
        private List<RightsU_Dapper.Entity.Master_Entities.Role> lstRole_Searched
        {
            get
            {
                if (Session["lstRole_Searched"] == null)
                    Session["lstRole_Searched"] = new List<RightsU_Dapper.Entity.Master_Entities.Role>();
                return (List<RightsU_Dapper.Entity.Master_Entities.Role>)Session["lstRole_Searched"];
            }
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.Vendor> lst = new List<RightsU_Dapper.Entity.Master_Entities.Vendor>();
            int RecordCount = 0;
            if (ModuleCode == "10")
        ...
        {
            List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts> lst = new List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>();
            int RecordCount = 0;
            ViewBag.Mode = Mode;
        ...
        public PartialViewResult BindPartialPages(string key, int VendorCode)
        {
            ...
            RightsU_Dapper.Entity.Master_Entities.Vendor objVendor = null;
            if (key == "LIST")
            {
                ...
                lstRole_Searched = lstRole_Searched = objRole_Service.GetAll().Where(x => x.Role_Type != null && x.Role_Type.Trim().Contains("V")).ToList();
                lstCountry_Searched = lstCountry = objCountry_Service.GetAll().Where(x => x.Is_Active == "Y").ToList();
                if (ModuleCode == "10")
                {
            ...
            else
            {
                ...
                if (VendorCode > 0 && key != "VIEW")
                {
                    ...
                    foreach (var country in strCode)
                    {
                        ...
                        RightsU_Dapper.Entity.Master_Entities.Country objCountry = lstCountry_Searched.Where(x => x.Country_Code == i).SingleOrDefault();
                    ...
                    List<RightsU_Dapper.Entity.Master_Entities.Country> temp_lstCountry = new List<RightsU_Dapper.Entity.Master_Entities.Country>();
                    ...
                    foreach (RightsU_Dapper.Entity.Master_Entities.Country city in temp_lstCountry)
                    {
                        SelectListItem selectList = new SelectListItem()
                        {
                    ...
                    List<RightsU_Dapper.Entity.Master_Entities.Country> temp_lstCountry_Theaterical = new List<RightsU_Dapper.Entity.Master_Entities.Country>();
                    ...
                    foreach (RightsU_Dapper.Entity.Master_Entities.Country city in temp_lstCountry_Theaterical)
                    {
                        SelectListItem selectList = new SelectListItem()
                        {
                            Text = city.Country_Name,
                    ...
                    #endregion
                    #region -----type-----
                    List<RightsU_Dapper.Entity.Master_Entities.Role> lstRole = objRole_Service.GetAll().Where(w => w.Role_Type != null && w.Role_Type.Contains("V")).OrderBy(o => o.Role_Name).ToList();
                    ...
                    #endregion
                    List<RightsU_Dapper.Entity.Master_Entities.Party_Category> lstPartyCategory = objParty_Category_Service.GetAll().Where(x => x.Is_Active == "Y").ToList();
                ...
                else
                {
                    ...
                    List<RightsU_Dapper.Entity.Master_Entities.Role> temp_lstRoles = lstRole_Searched.Where(x => x.Role_Type.Contains("V")).ToList();
                    foreach (RightsU_Dapper.Entity.Master_Entities.Role city in temp_lstRoles)
                    {
                        SelectListItem selectList = new SelectListItem()
                        {
                            Text = city.Role_Name,
                    ...
                    List<SelectListItem> listSelectListItems = new List<SelectListItem>();
                    List<RightsU_Dapper.Entity.Master_Entities.Country> temp_lstCountry = lstCountry_Searched.Where(x => x.Is_Theatrical_Territory == "N").ToList();
                    foreach (RightsU_Dapper.Entity.Master_Entities.Country city in temp_lstCountry)
                    {
                        SelectListItem selectList = new SelectListItem()
                        {
                    ...
                    TempData["Country"] = listSelectListItems;
                    List<SelectListItem> listSelectListItems_Theatrical = new List<SelectListItem>();
                    List<RightsU_Dapper.Entity.Master_Entities.Country> temp_lstTheatrical = lstCountry_Searched.Where(x => x.Is_Theatrical_Territory == "Y").ToList();
                    foreach (RightsU_Dapper.Entity.Master_Entities.Country city in temp_lstTheatrical)
                    {
                        SelectListItem selectList = new SelectListItem()
                        {
                            Text = city.Country_Name,
        ...
        public JsonResult Save_Party_Master(string Party_Master_Name)
        {
            ...
            RightsU_Dapper.Entity.Master_Entities.Party_Group objPartyGroup = new RightsU_Dapper.Entity.Master_Entities.Party_Group();
        ...
        public ActionResult AddEditVendorList(int VendorCode)
        {
            ...
            if (VendorCode > 0)
            {
                ViewData["Status"] = "U";
                //Vendor_Service objService = new Vendor_Service(objLoginEntity.ConnectionStringName);
                RightsU_Dapper.Entity.Master_Entities.Vendor objVendor = objVendorService.GetByID(VendorCode, RelationList);
                ViewData["MyVendor"] = objVendor;
                #region  --- Country ---
                List<SelectListItem> listSelectListItems = new List<SelectListItem>();
                List<Vendor_Country> strCode = objVendor.Vendor_Country.ToList().Where(x => x.Is_Theatrical == "N").ToList();
        ...
        public JsonResult SaveVendor(RightsU_Dapper.Entity.Master_Entities.Vendor objUser_MVC, FormCollection objFormCollection)
        {
            //Vendor_Service objVendorService = new Vendor_Service(objLoginEntity.ConnectionStringName);
            RightsU_Dapper.Entity.Master_Entities.Vendor objVendor = new RightsU_Dapper.Entity.Master_Entities.Vendor();
            ...
            if (VendorCode > 0)
            {
                ...
                if (objFormCollection["Country"] != null)
                {
                    foreach (var CountryCode in listSelectedCountry)
                    {
                        ...
                        RightsU_Dapper.Entity.Master_Entities.Vendor_Country objCountry = new RightsU_Dapper.Entity.Master_Entities.Vendor_Country();
                ...
                List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts> tempVendorContact = new List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>();
                ...
                List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts> Modified_VC = new List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>();
            ...
            else
            {
                ...
                List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts> temp_lstContact = new List<RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts>();
                temp_lstContact = lstVendorContact_Searched.Where(x => x.Vendor_Code == 0).ToList();
                if (temp_lstContact.Count > 0)
                {
                    foreach (RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts item in temp_lstContact)
                    {
        ...
        public JsonResult ActiveDeactiveVendor(int vendorCode, string doActive)
        {
            ...
            if (isLocked)
            {
                // string status = "S", message = "Record {ACTION} successfully";
                //Vendor_Service objService = new Vendor_Service(objLoginEntity.ConnectionStringName);
                RightsU_Dapper.Entity.Master_Entities.Vendor objVendor = objVendorService.GetByID(vendorCode);
        ...
        public JsonResult SaveVendorContact(FormCollection objFormCollection)
        {
            ...
            {
                RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts objVendorContacts = new RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts();
        ...
        public JsonResult AddEditVendorContact(string dummyGuid, string commandName)
        {
            ...
            {
                RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts objVendorContact = new RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts();
        ...
        public JsonResult UpdateVendorContact(FormCollection objFormCollection)
        {
            ...
            {
                RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts objVendorContacts = lstVendorContact_Searched.Where(x => x._Dummy_Guid == str_DummyGuid).SingleOrDefault();
                objVendorContacts.Department = str_Department;
                objVendorContacts.Email = str_Email;
                objVendorContacts.Phone_No = str_Phone_No;
                objVendorContacts.Contact_Name = str_Contact_Name;
        ...
        {
            string status = "S", message = "Record {ACTION} successfully";
            RightsU_Dapper.Entity.Master_Entities.Vendor_Contacts objVendorContacts = lstVendorContact_Searched.Where(x => x._Dummy_Guid == dummyGuid).SingleOrDefault();
