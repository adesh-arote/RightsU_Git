...
namespace RightsU_BookingSheet_Export
{
    public partial class RightsU_BookingSheet_Export : ServiceBase
    {
        public System.Timers.Timer timer = new System.Timers.Timer();
        public RightsU_BookingSheet_Export()
        {
            InitializeComponent();
        ...
        {
            Error.WriteLog_Conditional("STEP 1.1  : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started  generating data for pending booking sheet.");
        ...
        {
            Error.WriteLog_Conditional("STEP 2.1  : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Generating Excel Sheet for Pending Booking Sheet.");
            string ConnString1 = "";
            ...
            try
            {
                ...
                //string query = "SELECT * FROM AL_Booking_Sheet WHERE AL_Booking_Sheet_Code = 3158";
                ...
                for (int p = 0; p <= dt.Rows.Count - 1; p++)
                {
                    ...
                    for (int i = 0; i <= dt1.Rows.Count - 1; i++)
                    {
                        ...
                        Error.WriteLog_Conditional("STEP 2.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Getting Mandatory Field details.");
                    ...
                    Error.WriteLog_Conditional("STEP 2.5 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Getting revision history details.");
                    ...
                    Error.WriteLog_Conditional("STEP 2.6 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Convert export to excel.");
                    ExportToExcel(ds1, dsManFields, BookingSheetCode, out string BookingSheetName);
                    Error.WriteLog_Conditional("STEP 2.7 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Update booking sheet record.");
            ...
            finally
            {
                ...
                Error.WriteLog_Conditional("STEP 2.7 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
        ...
        {
            Error.WriteLog_Conditional("STEP 5.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Uploading booking sheet.");
            ...
            try
            {
                ...
                Error.WriteLog_Conditional("STEP 5.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Getting reords from database.");
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    string InputFile = "";
                    ...
                    try
                    {
                        ...
                        Error.WriteLog_Conditional("STEP 5.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started reading " + InputFile + "file.");
                        ...
                        for (int m = 0; m <= dt1.Rows.Count - 1; m++)
                        {
                            ...
                            da.Fill(ds);
                            Error.WriteLog_Conditional("STEP 5.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Filled data into dataset from " + sheetName);
                            if (ds.Tables.Count > 0)
                            {
                                if (ds.Tables[0].Rows.Count > 1)
                                {
                                    ...
                                    Error.WriteLog_Conditional("STEP 5.5 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Checking column datatype ");
                                    ...
                                    Error.WriteLog_Conditional("STEP 5.6 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Insert Booking Sheet UDT Data");
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 5.7 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        public static void ValidateAndUpdateBookingSheet()
        {
            Error.WriteLog_Conditional("STEP 9.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Validate And Update Booking Sheet.");
            string ConnString = "";
            ConnString = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            SqlConnection sqlConnection = new SqlConnection(ConnString);
            ...
            {
                sqlConnection.Open();
                Error.WriteLog_Conditional("STEP 9.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection established.");
                string query = "SELECT * FROM DM_Master_Import WHERE Status IN ('N','P') AND File_Type= 'B' AND Record_Code IS NOT NULL";
                SqlCommand cmd = new SqlCommand(query, sqlConnection);
                SqlDataReader dr = cmd.ExecuteReader();
                System.Data.DataTable dt = new System.Data.DataTable();
                ...
                if (!dr.IsClosed)
                {
                    dt.Load(dr);
                    dr.Close();
                    Error.WriteLog_Conditional("STEP 9.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : get data from DM_Master_Import.");
                }
                else
                {
                    dr.Close();
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 9.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        ...
        {
            Error.WriteLog_Conditional("STEP 3.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Export To Excel.");
            ...
            {                
                newFile.Delete();
                Error.WriteLog_Conditional("STEP 3.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Deleted existing booking sheet " + Name);
            }
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    for (int i = 0; i <= ds.Tables.Count - 1; i++)
                    {
                        if (i == 0)
                        {
                            ...
                            Error.WriteLog_Conditional("STEP 3.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Adding booking sheet for " + Convert.ToString(ds.Tables[i].TableName));
                            ...
                            {
                                Error.WriteLog_Conditional("STEP 3.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Adding blank booking sheet for " + Convert.ToString(ds.Tables[i].TableName));
                                sheet.Cells.LoadFromDataTable(ds.Tables[i], true);
                                for (int j = 1; j <= ds.Tables[i].Columns.Count; j++)
                                {
                                    sheet.DefaultColWidth = 40;
                        ...
                        else
                        {
                            ...
                            Error.WriteLog_Conditional("STEP 3.5 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Adding booking sheet for " + Convert.ToString(ds.Tables[i].TableName));
                            if (ds.Tables[i].Rows.Count > 0)
                            {
                                sheet.Cells.LoadFromDataTable(ds.Tables[i], true);
                                for (int j = 1; j <= ds.Tables[i].Columns.Count; j++)
                            ...
                            {
                                Error.WriteLog_Conditional("STEP 3.6 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Adding blank booking sheet for " + Convert.ToString(ds.Tables[i].TableName));
                                sheet.Cells.LoadFromDataTable(ds.Tables[i], true);
                                for (int j = 1; j <= ds.Tables[i].Columns.Count; j++)
                                {
                                    sheet.DefaultColWidth = 40;
                    ...
                    Error.WriteLog_Conditional("STEP 3.7 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Saved booking sheet : " + Bookingsheet_Name);
        ...
        {
            Error.WriteLog_Conditional("STEP 4.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Update Booking Sheet Record.");
            string ConnString = "";
            ConnString = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            SqlConnection sqlConnection = new SqlConnection(ConnString);
            sqlConnection.Open();
            ...
            {
                cmd.ExecuteNonQuery();
                Error.WriteLog_Conditional("STEP 4.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Booking Sheet Code : " + BookingSheetCode + " Record Updated.");
            }
            catch (Exception ex)
            {
                StringBuilder sb = new StringBuilder("Found Exception : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : " + ex.Message);
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 4.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        ...
        {
            Error.WriteLog_Conditional("STEP 6.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started inserting booking sheet.");
            string ConnString = "";
            ConnString = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            SqlConnection sqlConnection = new SqlConnection(ConnString);
            ...
            {
                sqlConnection.Open();
                Error.WriteLog_Conditional("STEP 6.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection established.");
                Error.WriteLog_Conditional("STEP 6.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Calling USPAL Booking Sheet Import Utility PI.");
                ...
                cmdSP.ExecuteReader();
                Error.WriteLog_Conditional("STEP 6.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Inserted data into DM_Booking_Sheet_Data.");
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 6.5 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        public static void ValidateAndUpdateBookingSheetMovie(int DM_Master_Import_Code)
        {
            Error.WriteLog_Conditional("STEP 10.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Validate And Update Booking Sheet Movie.");
            string ConnString = "";
            ConnString = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            SqlConnection sqlConnection = new SqlConnection(ConnString);
            ...
            {
                sqlConnection.Open();
                Error.WriteLog_Conditional("STEP 10.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection established.");
                SqlCommand cmdSP = new SqlCommand();
                ...
                cmdSP.Parameters.Add(param1);
                cmdSP.ExecuteReader();
                Error.WriteLog_Conditional("STEP 10.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Update booking sheet data into AL_Booking_Sheet_Details (If Success) otherwise update status in DM_Master_Import as E.");
            }
            catch (Exception ex)
            {
                UpdateDMBookingSheetRecord(DM_Master_Import_Code);
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 10.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        public static void ValidateAndUpdateBookingSheetShow(int DM_Master_Import_Code)
        {
            Error.WriteLog_Conditional("STEP 11.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Validate And Update Booking Sheet Show.");
            string ConnString = "";
            ConnString = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            SqlConnection sqlConnection = new SqlConnection(ConnString);
            ...
            {
                sqlConnection.Open();
                Error.WriteLog_Conditional("STEP 11.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection established.");
                SqlCommand cmdSP = new SqlCommand();
                ...
                cmdSP.Parameters.Add(param1);
                cmdSP.ExecuteReader();
                Error.WriteLog_Conditional("STEP 11.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Update booking sheet data into AL_Booking_Sheet_Details (If Success) otherwise update status in DM_Master_Import as E.");
            }
            catch (Exception ex)
            {
                UpdateDMBookingSheetRecord(DM_Master_Import_Code);
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 11.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        public static void UpdateDMBookingSheetRecord(int DM_Master_Import_Code)
        {
            Error.WriteLog_Conditional("STEP 7.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started updating booking sheet.");
            string ConnString = "";
            ConnString = ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;
            SqlConnection sqlConnection = new SqlConnection(ConnString);
            sqlConnection.Open();
            ...
            {
                cmd.ExecuteNonQuery();
                Error.WriteLog_Conditional("STEP 7.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Status updated in DM_Master_Import as E.");
            }
            catch (Exception ex)
            {
                StringBuilder sb = new StringBuilder("Found Exception : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : " + ex.Message);
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 7.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        }
        public static System.Data.DataTable GetRevisionHistoryDetails(int BookingSheetCode = 0)
        {
            Error.WriteLog_Conditional("STEP 8.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Get Revision History Details.");
            ...
            {
                sqlConnection.Open();
                Error.WriteLog_Conditional("STEP 8.2 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection established.");
                ...
                if (!dr.IsClosed)
                {
                    dtRevHist.Load(dr);
                    dr.Close();
                    Error.WriteLog_Conditional("STEP 8.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Get Revision History Details.");
                }
                else
                {
                    dr.Close();
            ...
            {
                sqlConnection.Close();
                Error.WriteLog_Conditional("STEP 8.4 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Database connection closed.");
            }
        ...
        {
            Error.WriteLog_Conditional("STEP 9.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Get Mandatory Field Names.");
            ...
            try
            {
                ...
                using (SqlDataAdapter da = new SqlDataAdapter())
                {
                    ...
                    da.Fill(dsMandatary);
                    Error.WriteLog_Conditional("STEP 9.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Filled Mandatory Dataset.");
                }
            }
            catch (Exception ex)
            {
        ...
        {
            Error.WriteLog_Conditional("STEP 10.1 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Started Get Bookingsheet Name.");
            ...
            try
            {
                ...
                if (!dr.IsClosed)
                {
                    dt.Load(dr);
                    dr.Close();
                    Error.WriteLog_Conditional("STEP 10.3 : " + DateTime.Now.ToString("dd-MMM-yyyy  HH:mm:ss") + " : Filled Bookinfsheet Datatable.");
                }
                else
                {
                    dr.Close();
