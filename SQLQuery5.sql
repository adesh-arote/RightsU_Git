ALTER PROCEDURE [dbo].[USP_Get_Version_History_Syn]  
 @Syn_Deal_Code int  
...
*/  
 ...
 BEGIN  
  ...
  (  
   ...
   Deal_Segment NVARCHAR(50)  
  )  
  
  INSERT INTO #TempDealHistory(AT_Syn_Deal_Code,Syn_Deal_Code,Agreement_No,Version,VersionOld,Deal_Description,Deal_Type_Name,[Entity_Name],Exchange_Rate,Category_Name,Vendor_Name, Contact_Name,Currency_Name,[Index],ChangedColumnIndex,Inserted_By,Deal_Segment )  
 ...
 cast(AAD.Version as decimal),'',USR.Login_Name, DS.Deal_Segment_Name  
  ...
  INNER JOIN Deal_Segment DS ON AAD.Deal_Segment_Code = DS.Deal_Segment_Code
  ...
  INSERT INTO #TempDealHistory(AT_Syn_Deal_Code,Syn_Deal_Code,Agreement_No,Version, VersionOld,Deal_Description,Deal_Type_Name,[Entity_Name],Exchange_Rate,Category_Name,Vendor_Name, Contact_Name,Currency_Name, [Index],ChangedColumnIndex,Inserted_By,Deal_Segment )  
  SELECT 0,Syn_Deal_Code,Agreement_No,Version,RIGHT('000' + cast( (cast(Version as decimal) +1) as varchar(50)),4),Deal_Description,DT.Deal_Type_Name,E.[Entity_Name],Exchange_Rate,C.Category_Name,V.Vendor_Name, VC.Contact_Name,CR.Currency_Name, cast(AAD.Version as decimal),'',USR.Login_Name, DS.Deal_Segment_Name  
  FROM Syn_Deal AAD  
  INNER JOIN Deal_Type DT ON AAD.Deal_Type_Code = DT.Deal_Type_Code  
  INNER JOIN Entity E ON AAD.Entity_Code = E.Entity_Code  
  INNER JOIN Category C ON AAD.Category_Code = C.Category_Code  
...
--SELECT * FROM Acq_deal where Agreement_No = 'S-2020-00034'
