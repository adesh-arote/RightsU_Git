...
namespace RightsU_DAL
{
    ...
    public partial class RightsU_NeoEntities : DbContext
    {
        ...
        public RightsU_NeoEntities(string connectionStr)
            : base(connectionStr)
        {
            //new DbContext(
            this.Configuration.LazyLoadingEnabled = true;
            //this.Configuration.AutoDetectChangesEnabled = false;
            this.Database.CommandTimeout = Convert.ToInt32(ConfigurationManager.AppSettings["EF_TimeOut"].ToString());
        }

        //private static string GetConnectionString()
        //{

        //    return "name=RightsU_NeoEntities";
        //}
        ...
        public DbSet<RightsU_Entities.Version> Versions { get; set; }
        ...
        public DbSet<Email_Config_Keys> Email_Config_Keys { get; set; }
        ...
        public virtual ObjectResult<USP_List_Rights_Result> USP_List_Rights(string right_Type, string view_Type, Nullable<int> deal_Code, string deal_Movie_Codes, string region_Code, string platform_Code, string IsExclusive, ObjectParameter pageNo, Nullable<int> pageSize, ObjectParameter totalRecord, string searchText)
        {
            ...
            var region_CodeParameter = region_Code != null ?
              new ObjectParameter("RegionCodes", region_Code) :
              new ObjectParameter("RegionCodes", typeof(string));

            var platform_CodeParameter = platform_Code != null ?
              new ObjectParameter("PlatformCodes", platform_Code) :
              new ObjectParameter("PlatformCodes", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_List_Rights_Result>("USP_List_Rights", right_TypeParameter, view_TypeParameter, deal_CodeParameter, deal_Movie_CodesParameter, region_CodeParameter, platform_CodeParameter, ISExclusiveParameter, pageNo, pageSizeParameter, totalRecord, searchTextParameter);
        }
           ...
           List<Deal_Ancillary_Platform_Medium_UDT> lstAncillary_Platform_Medium, int Ancillary_Type_code, string Catch_Up_From, int Acq_Deal_Ancillary_Code, int Acq_Deal_Code)
        {
            ...
            proc.Acq_Deal_Ancillary_Code = Acq_Deal_Ancillary_Code;
        ...
        {
            var proc = new USP_Validate_Title_Talent_UDT();
            proc.Title_Talent_Role = lst_Title_Talent_Role;
            proc.CallFrom = CallFrom;
            return this.Database.ExecuteStoredProcedure<USP_Validate_Title_Talent_UDT>(proc);
        }
        ...
        {
            var proc = new USP_Validate_Rights_Duplication_UDT();
        ...
        {
            var proc = new USP_Get_Data_Restriction_Remark_UDT();
            proc.Deal_Rights = LstDeal_Rights_UDT;
            proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
            proc.Deal_Rights_Platform = LstDeal_Rights_Platform_UDT;
            proc.Deal_Rights_Territory = LstDeal_Rights_Territory_UDT;
            ...
            proc.Deal_Rights_Dubbing = LstDeal_Rights_Dubbing_UDT;
            proc.Debug = "N";
            return this.Database.ExecuteStoredProcedure<USP_Get_Data_Restriction_Remark_UDT>(proc);
        }
        ...
        {
            var proc = new USP_Validate_Show_Episode_UDT();
            proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
            return this.Database.ExecuteStoredProcedure<USP_Validate_Show_Episode_UDT>(proc);
        }
        ...
        public virtual int USP_AT_Acq_Deal(Nullable<int> acq_Deal_Code, ObjectParameter is_Error)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_AT_Acq_Deal", acq_Deal_CodeParameter, is_Error);
        }
        ...
        public virtual ObjectResult<int> USP_Get_Creator_Group_Code_AfterReject(Nullable<int> module_Code, Nullable<int> record_Code)
        {
            var module_CodeParameter = module_Code.HasValue ?
                new ObjectParameter("Module_Code", module_Code) :
                new ObjectParameter("Module_Code", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<int>("USP_Get_Creator_Group_Code_AfterReject", module_CodeParameter, record_CodeParameter);
        }
        ...
        public virtual ObjectResult<USP_RollBack_Acq_Deal_Result> USP_RollBack_Acq_Deal(Nullable<int> acq_Deal_Code, Nullable<int> user_Code)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_RollBack_Acq_Deal_Result>("USP_RollBack_Acq_Deal", acq_Deal_CodeParameter, user_CodeParameter);
        }
        ...
        {
            var proc = new USP_Validate_Platform_Run_UDT();
            proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
            proc.Deal_Rights_Platform = LstDeal_Rights_Platform_UDT;
            proc.Deal_Rights_Code = Deal_Rights_Code;
            proc.Deal_Code = Deal_Code;
            proc.CallFrom = CallFrom;
            proc.Debug = "N";
            return this.Database.ExecuteStoredProcedure<string>(proc);
        }
        ...
        //   )
        //{
        //    var proc = new USP_Syn_Acq_Mapping_UDT();
        //    proc.Deal_Rights = LstDeal_Rights_UDT;
        //    proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
        //    proc.Deal_Rights_Platform = LstDeal_Rights_Platform_UDT;
        //    proc.Deal_Rights_Territory = LstDeal_Rights_Territory_UDT;
        ...
        {
            var proc = new USP_Acq_Deal_Clone_UDT();
            proc.New_Acq_Deal_Code = New_Acq_Deal_Code;
            proc.Previous_Acq_Deal_Code = Previous_Acq_Deal_Code;
            proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
        ...
        {
            var proc = new USP_Syn_Deal_Clone_UDT();
            proc.New_Syn_Deal_Code = New_Syn_Deal_Code;
            proc.Previous_Syn_Deal_Code = Previous_Syn_Deal_Code;
            proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
            proc.User_Code = User_Code;
            return this.Database.ExecuteStoredProcedure<string>(proc);
        }
        ...
        {
            //string Sql = "DELETE FROM Syn_Acq_Mapping WHERE Syn_Deal_Rights_Code = " + Syn_Rights_Code;
            return Database.ExecuteSqlCommand(Sql);
        }
        public int Get_Select_CountSql_EF(string sql)
        {
            //IEnumerable<int> Count = Database.SqlQuery<int>(sql, "");
            List<int> lst_Count = new List<int>();
            lst_Count.AddRange(Database.SqlQuery<int>(sql, ""));
            if (lst_Count.Count > 0 && lst_Count[0] > 0)
                return 1;
            return 0;
        }
        ...
        public virtual ObjectResult<USP_Uploaded_File_Error_List_Result> USP_Uploaded_File_Error_List(Nullable<int> file_Code)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Uploaded_File_Error_List_Result>("USP_Uploaded_File_Error_List", file_CodeParameter);
        }
        ...
        public virtual int usp_GetUserEMail_Body(string user_Name, string first_Name, string last_Name, string pass_Word, string isLDAP_Required, string site_Address, string system_Name, string status, string cur_email_id)
        {
            ...
            var system_NameP = system_Name != null ?
        ...
        {
            var dealTypeCodeParameter = dealTypeCode.HasValue ?
              new ObjectParameter("Deal_Type_code", dealTypeCode) :
              new ObjectParameter("Deal_Type_code", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Title_List_Result>("USP_Title_List", dealTypeCodeParameter, titleNameParameter, originalTitleNameParameter, bUCodeParameter, pageNoParameter, recordCount, isPagingParameter, pageSizeParameter, advanceSearchParameter, ExactMatchParameter);
        }
        ...
        {
            var proc = new USP_Validate_Run_UDT();
            proc.Deal_Run_Title = LstDeal_Run_Title_UDT;
            proc.Deal_Run_Yearwise_Run = LstDeal_Run_Yearwise_Run_UDT;
            proc.Deal_Run_Channel = LstDeal_Run_Channel_UDT;
            proc.Acq_Deal_Code = acq_Deal_Code;
            return this.Database.ExecuteStoredProcedure<USP_Validate_Run_UDT>(proc);
        }
        ...
        public virtual ObjectResult<USP_List_BV_WBS_Result> USP_List_BV_WBS(string is_Process, string wBS_Code, Nullable<long> file_Code)
        {
            ...
            var file_CodeParameter = file_Code.HasValue ?
                new ObjectParameter("File_Code", file_Code) :
                new ObjectParameter("File_Code", typeof(long));
        ...
        public virtual ObjectResult<USP_Uploaded_File_Detail_Result> USP_Uploaded_File_Detail(Nullable<int> file_Code)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Uploaded_File_Detail_Result>("USP_Uploaded_File_Detail", file_CodeParameter);
        }
        ...
        {
            var proc = new USP_Insert_Title_Import_UDT();
            proc.Title_Import = LstTitle_Import_UDT;
            proc.User_Code = User_Code;
            return this.Database.ExecuteStoredProcedure<USP_Insert_Title_Import_UDT>(proc);
        }
        public IEnumerable<USP_DM_Title_PI> USP_DM_Title_PI(
       List<Title_Import_UDT> LstTitle_Import_UDT, int User_Code
         )
        {
            var proc = new USP_DM_Title_PI();
            proc.Title_Import = LstTitle_Import_UDT;
            proc.User_Code = User_Code;
      ...
      List<Title_Import_Utility_UDT> LstTitle_Import_Utility_UDT, string CallFor, int User_Code, int DM_Master_Import_Code, string TitleType
        ...
        public IEnumerable<USP_Bulk_Update> USP_Bulk_Update(List<Rights_Bulk_Update_UDT> LstRights_Bulk_Update_UDT, int Login_User_Code)
        {
            ...
            proc.Rights_Bulk_Update_UDT = LstRights_Bulk_Update_UDT;
            proc.Login_User_Code = Login_User_Code;
            return this.Database.ExecuteStoredProcedure<USP_Bulk_Update>(proc);
        }
        ...
        {
            var proc = new USP_Acq_Bulk_Update();
            proc.Rights_Bulk_Update_UDT = LstRights_Bulk_Update_UDT;
            proc.Login_User_Code = Login_User_Code;
            return this.Database.ExecuteStoredProcedure<USP_Acq_Bulk_Update>(proc);
        }
        ...
        {
            var proc = new USP_Acq_Bulk_Update_Validation();
            proc.Rights_Bulk_Update_UDT = LstRights_Bulk_Update_UDT;
            return this.Database.ExecuteStoredProcedure<USP_Acq_Bulk_Update_Validation>(proc);
        }
        ...
        {
            var proc = new USP_Acq_Termination_UDT();
            proc.Termination_Deals = lstTermination_Deals_UDT;
            proc.Login_User_Code = loginUserCode;
            proc.Syn_Error_Body = syn_Error_Body;
            proc.Is_Validate_Error = isValidateError;
            return this.Database.ExecuteStoredProcedure<USP_Acq_Termination_UDT>(proc);
        }
        ...
        {
            var proc = new USP_Syn_Termination_UDT();
            proc.Termination_Deals = lstTermination_Deals_UDT;
            proc.Login_User_Code = loginUserCode;
            return this.Database.ExecuteStoredProcedure<USP_Syn_Termination_UDT>(proc);
        }
        ...
        {
            var proc = new USP_DM_Music_Title_PI();
            proc.Music_Title_Import = lstMusic_Title_Import_UDT;
            proc.User_Code = User_Code;
            return this.Database.ExecuteStoredProcedure<USP_DM_Music_Title_PI>(proc);
        }
        ...
        {
            var proc = new USP_Title_Content_Version_PI();
            proc.Title_Content_Version_UDT = lstMusic_Title_Content_Import_UDT;
            proc.UserCode = User_Code;
            return this.Database.ExecuteStoredProcedure<USP_Title_Content_Version_PI>(proc);
        }
        ...
        {
            var proc = new USP_Validate_And_Save_Assigned_Music_UDT();
            proc.Deal_Type_Code = dealTypeCode;
            proc.Login_User_Code = loginUserCode;
            proc.Link_Show = linkShow;
            proc.Action = action;
            proc.AssignMusic = lstAssign_Music_UDT;
            return this.Database.ExecuteStoredProcedure<USP_Validate_And_Save_Assigned_Music_UDT>(proc);
        }
        ...
        {
            var proc = new USP_Import_Title_Content_UDT();
            proc.Deal_Code = Deal_Code;
            proc.Title_Content_UDT = lstTitle_Content_UDT;
            return this.Database.ExecuteStoredProcedure<USP_Import_Title_Content_UDT>(proc);
        }
        ...
        {
            var proc = new USP_CheckHoldbackForSyn_UDT();
            proc.Deal_Rights = LstDeal_Rights_UDT;
            proc.Deal_Rights_Title = LstDeal_Rights_Title_UDT;
            proc.Deal_Rights_Platform = LstDeal_Rights_Platform_UDT;
            proc.Deal_Rights_Territory = LstDeal_Rights_Territory_UDT;
            proc.Deal_Rights_Subtitling = LstDeal_Rights_Subtitling_UDT;
            proc.Deal_Rights_Dubbing = LstDeal_Rights_Dubbing_UDT;
            return this.Database.ExecuteStoredProcedure<USP_CheckHoldbackForSyn_UDT>(proc);
        }
        ...
        {
            var proc = new USP_Content_Music_Link_Bulk_Insert_UDT();
            proc.Content_Music_Link_UDT = LstContent_Music_Link_UDT;
            proc.User_Code = UserCode;
            return this.Database.ExecuteStoredProcedure<USP_Content_Music_Link_Bulk_Insert_UDT>(proc);
        }
        public virtual ObjectResult<USP_Get_Music_Reports_PreReq_Result> USP_Get_Music_Reports_PreReq()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Get_Music_Reports_PreReq_Result>("USP_Get_Music_Reports_PreReq");
        }
        ...
        {
            var proc = new USP_DM_Music_Title_PII();
            proc.DM_Import_UDT = lstDM_Import_UDT;
            proc.DM_Master_Import_Code = DM_Master_Import_Code;
            proc.Users_Code = Users_Code;
            return this.Database.ExecuteStoredProcedure<USP_DM_Music_Title_PII>(proc);
        }
        public IEnumerable<USP_DM_Music_Title_PIII> USP_DM_Music_Title_PIII(
         int? DM_Master_Import_Code
           )
        {
            var proc = new USP_DM_Music_Title_PIII();
            proc.DM_Master_Import_Code = DM_Master_Import_Code;
            return this.Database.ExecuteStoredProcedure<USP_DM_Music_Title_PIII>(proc);
        }
        ...
        {
            var proc = new USP_DM_Title_PIII();
            proc.DM_Master_Import_Code = DM_Master_Import_Code;
            return this.Database.ExecuteStoredProcedure<USP_DM_Title_PIII>(proc);
        }
        ...
        {
            var Music_Title_CodeParameter = Music_Title_Code.HasValue ?
                new ObjectParameter("MusicTitleCode", Music_Title_Code) :
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Music_Title_Contents_Result>("USP_Music_Title_Contents", Music_Title_CodeParameter, GenericSearchParameter, RecordCount, IsPagingParameter, PageSizeParameter, PageNoParameter);
        }
        ...
        public virtual int USP_UpdateContentHouseID(Nullable<int> BV_HouseId_Data_Code, Nullable<int> MappedDealTitleCode)
        {
            ...
            var MappedDealTitleCodeParameter = MappedDealTitleCode != null ?
        ...
        {
            var proc = new USP_Multi_Music_Schedule_Process();
            proc.Music_Content_Assignment_UDT = LstMusic_Content_Assignment_UDT;
        ...
        public virtual ObjectResult<USP_Music_Deal_Schedule_Validation_Result> USP_Music_Deal_Schedule_Validation(Nullable<int> Music_Deal_Code, string Channel_Codes, string Start_Date, string End_Date, string Title_Codes, string LinkshowType)
        {
            var Music_Deal_CodeParameter = Music_Deal_Code.HasValue ?
             new ObjectParameter("Music_Deal_Code", Music_Deal_Code) :
             new ObjectParameter("Music_Deal_Code", typeof(int));

            var Channel_CodeParameter = Channel_Codes != null ?
             new ObjectParameter("Channel_Codes", Channel_Codes) :
             new ObjectParameter("Channel_Codes", typeof(string));
            ...
            var Title_CodesParameter = Title_Codes != null ?
             new ObjectParameter("LinkedTitleCode", Title_Codes) :
             new ObjectParameter("LinkedTitleCode", typeof(string));

            var LinkshowTypeParameter = LinkshowType != null ?
             new ObjectParameter("LinkedShowType", LinkshowType) :
             new ObjectParameter("LinkedShowType", typeof(string));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Music_Deal_Schedule_Validation_Result>("USP_Music_Deal_Schedule_Validation", Music_Deal_CodeParameter, Channel_CodeParameter, Start_DateParameter, End_DateParameter, Title_CodesParameter, LinkshowTypeParameter);
        }
        ...
        public virtual ObjectResult<USP_Get_Provisional_Deal_Title_Result> USP_Get_Provisional_Deal_Title(Nullable<int> Deal_Type_Code, string SearchString)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_Get_Provisional_Deal_Title_Result>("USP_Get_Provisional_Deal_Title", Deal_Type_CodeParameter, SearchStringParameter);
        }
        ...
        {
            var proc = new USP_INSERT_SAP_WBS_UDT();
            proc.SAP_WBS_DATA_UDT = lst_SAP_WBS_DATA_UDT;
            proc.Upload_File_Data_UDT = lst_Upload_File_Data_UDT;
            proc.Is_ERROR = Is_ERROR;
            this.Database.ExecuteStoredProcedure<USP_INSERT_SAP_WBS_UDT>(proc);
        }
        ...
        {
            var proc = new USP_Content_Music_PI();
            proc.Content_Music_Link_UDT = lstContent_Music_Link_UDT;
            proc.UserCode = User_Code;
            return this.Database.ExecuteStoredProcedure<USP_Content_Music_PI>(proc);
        }
        public IEnumerable<USP_Content_Music_PII> USP_Content_Music_PII(
         List<DM_Import_UDT> lstDM_Import_UDT, int? DM_Master_Import_Code, int? Users_Code
           )
        {
            var proc = new USP_Content_Music_PII();
            proc.DM_Import_UDT = lstDM_Import_UDT;
            proc.DM_Master_Import_Code = DM_Master_Import_Code;
            proc.Users_Code = Users_Code;
            return this.Database.ExecuteStoredProcedure<USP_Content_Music_PII>(proc);
        }
        public IEnumerable<USP_Content_Music_PIII> USP_Content_Music_PIII(
         int? DM_Master_Import_Code
           )
        {
            var proc = new USP_Content_Music_PIII();
            proc.DM_Master_Import_Code = DM_Master_Import_Code;
            return this.Database.ExecuteStoredProcedure<USP_Content_Music_PIII>(proc);
        }
        ...
        {
            var proc = new USP_Get_Title_Avail_Language_Data();
            proc.Avail_Report_Schedule_Data = lstAvail_Report_Schedule_UDT;
            proc.UserCode = UserCode;
            proc.Mode = Mode;
            proc.StrCriteria = StrCriteria;
            proc.PageNo = PageNo;
            proc.OrderByCndition = OrderByCndition;
            proc.IsPaging = IsPaging;
            proc.PageSize = PageSize;
            return this.Database.ExecuteStoredProcedure<USP_Get_Title_Avail_Language_Data>(proc);
        }
        public IEnumerable<USP_Get_Title_Avail_Language_Data_Show> USP_Get_Title_Avail_Language_Data_Show(
      List<Avail_Report_Schedule_UDT> lstAvail_Report_Schedule_UDT, int UserCode, string Mode, string StrCriteria, int PageNo, string OrderByCndition, string IsPaging, int PageSize
        )
        {
            var proc = new USP_Get_Title_Avail_Language_Data_Show();
            proc.Avail_Report_Schedule_Data = lstAvail_Report_Schedule_UDT;
            proc.UserCode = UserCode;
            proc.Mode = Mode;
            proc.StrCriteria = StrCriteria;
            ...
            proc.IsPaging = IsPaging;
            proc.PageSize = PageSize;
            return this.Database.ExecuteStoredProcedure<USP_Get_Title_Avail_Language_Data_Show>(proc);
        }
        ...
        {
            var proc = new USPSaveSLAMatrixUDT();
            proc.TATSLAUDT = lst_TATSLAUDT;
            proc.UserCode = UserCode;
            this.Database.ExecuteStoredProcedure<USPSaveSLAMatrixUDT>(proc);
        }
