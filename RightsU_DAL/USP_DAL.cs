...
namespace RightsU_DAL
{
    ...
    public class USP_DAL
    {
        ...
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USP_Schedule_AsRun_Report(title, episodeFrom, episodeTo, isShowAll, startDate, endDate, channel, excludeExpiredDeal, runType, contentType);
        }
        ...
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USP_List_Music_Title(musicTitleName, sysLanguageCode, pageNo, recordCount, isPaging, pageSize, starCastCode, languageCode, albumCode, genresCode, musicLabelCode, yearOfRelease, singerCode, composerCode, lyricistCode, musicNameText, themeCode, musicTag, publicDomain, ExactMatch,movieAlbumType);
        }
      ...
      List<Music_Content_Assignment_UDT> LstMusic_Content_Assignment_UDT
       ...
       List<Avail_Report_Schedule_UDT> lstAvail_Report_Schedule_UDT, int UserCode, string Mode, string StrCriteria, int PageNo, string OrderByCndition, string IsPaging, int PageSize
        ...
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USP_Get_Acq_Deal_Supplementary_Edit(Acq_Deal_Supplementary_Code, Row_Num, shortName);
        }
        ...
        public virtual ObjectResult<USP_BuyBackRights_List_Result> USP_BuyBackRights_List_Rights(string right_Type, string view_Type, Nullable<int> deal_Code, string deal_Movie_Codes, string region_Code, string platform_Code, string IsExclusive, ObjectParameter pageNo, Nullable<int> pageSize, ObjectParameter totalRecord, string searchText, string titleCodes, Nullable<int> licensorCode)
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USP_BuyBackRights_List(right_Type, view_Type, deal_Code, deal_Movie_Codes, region_Code, platform_Code, IsExclusive, pageNo, pageSize, totalRecord, searchText,1, titleCodes, licensorCode);
        }
        ...
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USP_Get_Mapping_SubTitling_Dubbing_Languages_Buyback(acq_Deal_Rights_Codes, selected_SubTitling_Language_Codes, selected_Dubbing_Language_Codes);
        }
        ...
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USPAL_GetPurchaseOrderList(usersCode);
        }
        ...
        {
            RightsU_NeoEntities objContext = new RightsU_NeoEntities(conStr);
            return objContext.USPAL_GetRevisionHistoryForModule(record_Code, module_Code);
        }
