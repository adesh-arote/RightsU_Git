...
namespace RightsU_Dapper.BLL.Services
{
    ...
    public class Entity_Service
    {
        ...
        public RightsU_Dapper.Entity.Master_Entities.Entity GetByID(int? ID, Type[] RelationList = null)
        {
            return objEntity_Repository.Get(ID, RelationList);
        }
        public IEnumerable<RightsU_Dapper.Entity.Master_Entities.Entity> GetAll(Type[] additionalTypes = null)
        {
            return objEntity_Repository.GetAll();
        }
        public void AddEntity(RightsU_Dapper.Entity.Master_Entities.Entity obj)
        {
            objEntity_Repository.Add(obj);
        }
        public void UpdateEntity(RightsU_Dapper.Entity.Master_Entities.Entity obj)
        {
            objEntity_Repository.Update(obj);
        }
        public void DeleteEntity(RightsU_Dapper.Entity.Master_Entities.Entity obj)
        {
