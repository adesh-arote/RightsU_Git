...
namespace RightsU_Dapper.Entity.System_Setting_Entities
{
    ...
    public partial class System_Module
    {
        public System_Module()
        {
            ...
            this.Workflow_Module = new HashSet<Master_Entities.Workflow_Module>();
            this.System_Module_Message = new HashSet<Master_Entities.System_Module_Message>();
        ...
        [OneToMany]
        public virtual ICollection<Master_Entities.Workflow_Module> Workflow_Module { get; set; }
        [OneToMany]
        public virtual ICollection<Master_Entities.System_Module_Message> System_Module_Message { get; set; }
        [OneToMany]
