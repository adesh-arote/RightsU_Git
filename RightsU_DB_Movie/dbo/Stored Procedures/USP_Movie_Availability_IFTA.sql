ALTER PROCEDURE [dbo].[USP_Movie_Availability_IFTA]
(
--declare
...
BEGIN 
	...
	--select * from title where title_Name like '%Test avail%'
	--select 	@title_code='27782', 
	--@is_original_language='true', 
	--@title_language_code='',
	--@date_type ='FL',
	--@startdate ='20-Sep-2018',
	--@enddate ='20-Sep-2020',
	--@platform_code='', 
	--@platform_exactmatch='', 
	--@musthave_platform='', 
 ...
 --   ',@Country_Code='+@Country_Code+ 
   ...
   END		
	...
	print 'ad'
		...
		UNION 
		SELECT Title_Name COLLATE SQL_Latin1_General_CP1_CI_AS,Deal_Type_Name COLLATE SQL_Latin1_General_CP1_CI_AS , Platform_Name COLLATE SQL_Latin1_General_CP1_CI_AS, 
		...
		Reverse_Holdback AS Reverse_Holdback, Ancillary_Rights AS Ancillary_Rights
