...
CREATE PROCEDURE [dbo].[USP_Availability_Report_V3]
(
...
--)
 ...
 --   ',@Country_Code='+@Country_Code+ 
	...
	--',@Restriction_Remarks='+@Restriction_Remarks+
	--',@Others_Remarks='+@Others_Remarks+
	--',@Platform_ExactMatch='+@Platform_ExactMatch+
	--',@Platform_MustHave='+@Platform_MustHave+
	...
	--',@BU_Code='+@BU_Code+
	--',@Show_EpisodeWise='+@Show_EpisodeWise
	...
	DECLARE @strSQLNEO AS NVARCHAR(MAX)
	...
	(
		...
		Cluster_Names NVarchar(2000),
		Country_Names NVarchar(Max),
		Region_Type Varchar(2000),
		Platform_Str NVarchar(2000),
		Title_Language_Names NVarchar(2000),
		Sub_Language_Names NVarchar(4000),
		Dub_Language_Names NVarchar(4000)
	)
   ...
   END		
	...
	(
		...
		Platform_Name NVARCHAR(2000), 
		Country_Name NVARCHAR(1000) COLLATE SQL_Latin1_General_CP1_CI_AS , 
		Cluster_Names NVARCHAR(1000),
		Right_Start_Date DATETIME, 
		Rights_End_Date DATETIME,
		Title_Language_Names  NVARCHAR(4000), 
		Sub_Language_Names NVARCHAR(4000), 
		Dub_Language_Names NVARCHAR(4000), 
		...
		Restriction_Remark NVARCHAR(4000), 
		Sub_Deal_Restriction_Remark NVARCHAR(MAX),
		Remarks NVARCHAR(4000), 
		Rights_Remarks NVARCHAR(4000), 
	...
	------------------ Final Output
	print 'STEP-13 Final query ' + convert(varchar(30),getdate() ,109)	
	IF(@Restriction_Remarks = 'Y' OR @Others_Remarks = 'Y' )
	BEGIN
	...
	SET @strSQL =
		'SELECT DISTINCT
			...
			Sub_Language_Names, Dub_Language_Names, trt.Genres_Name, trt.Star_Cast, trt.Director, trt.Duration_In_Min, trt.Year_Of_Production,
	...
	BEGIN
		...
		EXEC (@strSQL + ' UNION SELECT Title_Name, Platform_Name, Country_Name, Cluster_Names, Right_Start_Date, Rights_End_Date, Title_Language_Names, 
...
/*
	...
	@Date_Type ='FL',
	@Start_Date ='23-Sep-2015',
	@End_Date ='23-Sep-2020',
	@Restriction_Remarks ='false',
	@Others_Remarks ='false',--D
