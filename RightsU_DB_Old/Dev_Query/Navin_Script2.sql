  ...
  -- CREATE TABLE Title_Content_Version_Details
  -- (
		--Title_Content_Version_Details_Code INT IDENTITY (1,1),
		--Title_Content_Version_Code INT,
		--House_Id VARCHAR(500)
  -- )

  -- ALTER TABLE Title_Content_Version_Details  
  -- ADD PRIMARY KEY (Title_Content_Version_Details_Code);

  -- ALTER TABLE Title_Content_Version_Details  
  -- ADD FOREIGN KEY (Title_Content_Version_Code) REFERENCES Title_Content_Version(Title_Content_Version_Code);

  --SP_Help Title_Content_Version_Details
