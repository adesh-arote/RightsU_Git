ALTER PROCEDURE [dbo].[USP_Movie_Availability]
(
 ...
 --   ',@Country_Code='+@Country_Code+ 
	...
	BEGIN
		...
		Begin
			...
			Insert InTo #Temp_Right_Remarks(Acq_Deal_Rights_Code, Restriction_Remarks, Remarks, Rights_Remarks, Sub_Deal_Restriction_Remark, Sub_License_Name, Category_Name)
   ...
   END		
	...
	print 'ad'
		...
		'' COLLATE SQL_Latin1_General_CP1_CI_AS AS Reverse_Holdback, Category_Name
