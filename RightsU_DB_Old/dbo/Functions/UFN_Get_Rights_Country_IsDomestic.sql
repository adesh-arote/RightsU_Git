CREATE Function [dbo].[UFN_Get_Rights_Country_IsDomestic](@Rights_Code Int, @Deal_Type Char(1), @IncludeDomestic Char(1))
...
Begin
	...
	Begin
		...
		AND ISNULL(c.Is_Theatrical_Territory, 'N') = @IncludeDomestic
