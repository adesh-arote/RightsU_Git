...
CREATE FUNCTION [dbo].[UFN_Get_Acq_Run_Based_Info]  
(  
...
BEGIN   
  ...
  INNER JOIN Acq_Deal_Rights ADR on ADR.Milestone_Type_Code = MT.Milestone_Type_Code
  WHERE ADR.Acq_Deal_Rights_Code = @Acq_Deal_Code
