CREATE TABLE [dbo].[Title_Content_Mapping] (
	...
	CONSTRAINT [FK_Title_Content_Mapping_Provisional_Deal_Title] FOREIGN KEY ([Provisional_Deal_Title_Code]) 
		REFERENCES [dbo].[Provisional_Deal_Title] ([Provisional_Deal_Title_Code])
);