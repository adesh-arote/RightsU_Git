CREATE TABLE [dbo].[Acq_Deal_Run] (
    [Acq_Deal_Run_Code]                    INT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [FK_Acq_Deal_Run_Right_Rule] FOREIGN KEY ([Right_Rule_Code]) REFERENCES [dbo].[Right_Rule] ([Right_Rule_Code])
);
