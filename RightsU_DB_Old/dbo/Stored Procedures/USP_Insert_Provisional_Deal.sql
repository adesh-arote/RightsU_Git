CREATE PROC [USP_Insert_Provisional_Deal]              
(              
...
BEGIN              
 ...
 BEGIN TRY                
  ...
  SELECT Provisional_Deal_Code, Agreement_No FROM Provisional_Deal WHERE Provisional_Deal_Code = @Provisional_Deal_Code 
