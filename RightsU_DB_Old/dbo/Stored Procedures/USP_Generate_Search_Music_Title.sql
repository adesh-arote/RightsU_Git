...
-- =============================================      
 ...
 MT.Music_title_Name +' '+  
  ...
  INNER JOIN Music_Title_Theme MTT on MT.Music_Title_Code= MTT.Music_Title_Code    
   ...
   (      
    ...
    FROM Music_Title_Label tl      
    INNER JOIN Music_Label ml on ml.Music_Label_Code = tl.Music_Label_Code      
  ...
  --INNER JOIN Music_Album MA ON MA.Music_Album_Code = MT.Music_Album_Code  
   ...
   Select Record_Code From Process_Search Where Module_Name = 'MT' and DATEADD(SECOND, 3, Created_On) <= GETDATE()      
  )      
 ) AS a      
