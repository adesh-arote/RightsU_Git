...
BEGIN
	DECLARE
		...
		SELECT @StatusFlag = Deal_Workflow_Status FROM RightsU_Plus.dbo.Acq_Deal Where Acq_Deal_Code =  @NewAcqDealCode_S
	    SELECT @IsAutoPush = Is_Auto_Push FROM RightsU_Plus.dbo.Acq_Deal Where Acq_Deal_Code =  @NewAcqDealCode_S
