...
BEGIN  
	...
	Inner Join Acq_Deal_Movie dm on dm.Acq_Deal_Movie_Code = bst.Deal_Movie_Code And dm.Title_Code = bst.Title_Code
	Inner Join Acq_Deal_Rights dmr on dmr.Acq_Deal_Code = dm.Acq_Deal_Code
	Inner Join Acq_Deal_Rights_Title dmrt on dmrt.Acq_Deal_Rights_Code = dmr.Acq_Deal_Rights_Code And dm.Title_Code = dmrt.Title_Code
	...
	dm.Acq_Deal_Movie_Code in (select number from fn_Split_withdelemiter(@DMCode,',')) 
	...
	Available_Channels_Code = (Select dbo.UFN_Get_DataFor_RightsUsageReport_New (a.deal_movie_code, 'CC',@StartDate,@EndDate,@Channel,@RunType)),
	Available_Channels = (Select dbo.UFN_Get_DataFor_RightsUsageReport_New (a.deal_movie_code, 'CH',@StartDate,@EndDate,@Channel,@RunType))
...
---EXEC [dbo].[USP_Schedule_ShowDetails_Sche_Report]   '650','','','',true,''  

--ALTER PROCEDURE [dbo].[USP_Schedule_ShowDetails_Sche_Report]   
--(  
--	 --@DMCode varchar(MAX),
--	 @Title_Code INT,
--	 @Deal_Code INT,
