...
BEGIN
	...
	BEGIN TRANSACTION;
		...
		(
			SELECT Acq_Deal_Rights_Holdback_Code FROM Acq_Deal_Rights_Holdback 
		...
		(
			SELECT Acq_Deal_Rights_Blackout_Code FROM Acq_Deal_Rights_Blackout 
		WHERE Acq_Deal_Rights_Code IN
			(
				SELECT Acq_Deal_Rights_Code FROM Acq_Deal_Rights 
				WHERE Acq_Deal_Code =@Acq_Deal_Code
		...
		(
			SELECT Acq_Deal_Rights_Promoter_Code FROM Acq_Deal_Rights_Promoter 
		WHERE Acq_Deal_Rights_Code IN
			(
				SELECT Acq_Deal_Rights_Code FROM Acq_Deal_Rights 
				WHERE Acq_Deal_Code =@Acq_Deal_Code
		...
		(
			SELECT Acq_Deal_Run_Yearwise_Run_Code From Acq_Deal_Run_Yearwise_Run WHERE Acq_Deal_Run_Code IN
			(
		...
		(	
			SELECT Acq_Deal_Cost_Code From Acq_Deal_Cost WHERE Acq_Deal_Code = @Acq_Deal_Code
		) 
		...
		(	
			SELECT Acq_Deal_Cost_Costtype_Code From Acq_Deal_Cost_Costtype WHERE Acq_Deal_Cost_Code IN
			(	
				SELECT Acq_Deal_Cost_Code From Acq_Deal_Cost WHERE Acq_Deal_Code = @Acq_Deal_Code
			)
		) 
		...
		(	
			SELECT Acq_Deal_Sport_Code FROM Acq_Deal_Sport WHERE Acq_Deal_Code = @Acq_Deal_Code
		) 
		...
		(	
			SELECT Acq_Deal_Sport_Ancillary_Code FROM Acq_Deal_Sport_Ancillary WHERE Acq_Deal_Code = @Acq_Deal_Code
		) 
		...
		(	
			SELECT Acq_Deal_Sport_Monetisation_Ancillary_Code FROM Acq_Deal_Sport_Monetisation_Ancillary WHERE Acq_Deal_Code = @Acq_Deal_Code
		)  
		...
		(	
			SELECT Acq_Deal_Sport_Sales_Ancillary_Code FROM Acq_Deal_Sport_Sales_Ancillary WHERE Acq_Deal_Code = @Acq_Deal_Code
		) 
		...
		(
			Select Acq_Deal_Movie_Code from Acq_Deal_Movie Where Acq_Deal_Code = @Acq_Deal_Code
		)
