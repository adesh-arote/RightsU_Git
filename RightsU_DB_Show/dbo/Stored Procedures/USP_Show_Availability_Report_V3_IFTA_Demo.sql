CREATE PROCEDURE [dbo].[USP_Show_Availability_Report_V3_IFTA_Demo]
(
   ...
   END		
	...
	--SET @strSQL =
		SELECT DISTINCT 
			...
			trr.Sub_License_Name AS Sub_License, 'Yes' Platform_Avail,'' AS Ancillary_Rights
		FROM 
			#Temp_Main_Ctr tm
		...
		Sub_Deal_Restriction_Remark, Remarks, Rights_Remarks, Exclusive, 'No' AS Sub_License, Platform_Avail, '' AS Ancillary_Rights
